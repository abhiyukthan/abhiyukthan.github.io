...
$this->_funcHooks['hook_who_read_topic_new'] = array('toptopicstarters_hook');
...
$this->_funcHooks['post'] = array('sDeleted','isSolvedCss','postQueued','noRep','posRep','negRep','repIgnored','userIgnoredLang','userIgnoredLangTwo','userIgnored','isNotIgnoring','postMid','hasPages','postModSelected','postModCheckbox','postOnline','postMember','accessModCP','postAdmin','postIp','isSolvedSausage','repHighlight','postEditByReason','postEditBy','postSignature','canDelete','approveUnapprove','canEdit','controlsForUnapprovedPost','hideNormalControlsForUnapprovedPost','repButtonsLike','multiquote','replyButton','replyButtonWarn','canDelete','canHide','canEdit','postIsReported','canReportPost','reportedPostData','sDeletedNot','initIgnoredPost','adCodeCheck','sDeletedNotMQ');
...
{
$count_c7711becec35cd7f885530e1744a6940 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_c7711becec35cd7f885530e1744a6940]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_c7711becec35cd7f885530e1744a6940]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_c7711becec35cd7f885530e1744a6940]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_c7711becec35cd7f885530e1744a6940]['sharelinks'] = $sharelinks;
}
...
{
$count_00ab4f36ec03fd27b520e15b28fe9179 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_00ab4f36ec03fd27b520e15b28fe9179]['announce'] = $announce;
$this->functionData['announcement_show'][$count_00ab4f36ec03fd27b520e15b28fe9179]['author'] = $author;
}
...
{
$count_f5b614e338fafeb3770dd9c735703cac = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_f5b614e338fafeb3770dd9c735703cac]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_f5b614e338fafeb3770dd9c735703cac]['forum'] = $forum;
}
...
/* -- hook_who_read_topic --*/
function hook_who_read_topic($mem, $count) {
$IPBHTML = "";
$IPBHTML .= "<br/><br/><b><span class='statistics_head'>{$this->lang->words['who_read_topic']}</span></b> <i>({$this->lang->words['who_read_topic_total']} {$count['total']})</i>

" . ((is_array( $mem ) && count( $mem )) ? ("".$this->__f__430ba70a63e84a250ffba63336d07000($mem,$count)."") : ("")) . "
</if><br />";
return $IPBHTML;
}


function __f__430ba70a63e84a250ffba63336d07000($mem, $count)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mem as $p => $r )
...
/* -- hook_who_read_topic_new --*/
function hook_who_read_topic_new($mem,$count) {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_topic', $this->_funcHooks['hook_who_read_topic_new'] ) )
{
$count_2d81478c76cbf9a43927c809d0b4d38d = is_array($this->functionData['hook_who_read_topic_new']) ? count($this->functionData['hook_who_read_topic_new']) : 0;
$this->functionData['hook_who_read_topic_new'][$count_2d81478c76cbf9a43927c809d0b4d38d]['mem'] = $mem;
$this->functionData['hook_who_read_topic_new'][$count_2d81478c76cbf9a43927c809d0b4d38d]['count'] = $count;
}
$IPBHTML .= "<div>

<br /><br />
" . (($count['total'] == 1) ? ("
<a href='#' id='modal2' title='{$count['total']} view'>{$this->lang->words['who_read_topic']}</a>
") : ("
<a href='#' id='modal2' title='{$count['total']} views'>{$this->lang->words['who_read_topic']}</a>
")) . "
<div id='mymodalcontent' style='display:none;'>
  <h3>{$this->lang->words['who_read_topic_total']} ({$count['total']})</h3>
...
<div class='general_box clearfix'>
	...
	<ul class='ipsList_withminiphoto'>
		...
		".$this->__f__4a8ab3701a70d7638f5a9723cc437816($mem,$count)."</ul>
...
function __f__4a8ab3701a70d7638f5a9723cc437816($mem,$count)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mem as $tts )
	{
		...
		<li class='clearfix'>
			...
			" . (($tts['member_id']) ? ("
				<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$tts['member_id']}", "public",'' ), "{$tts['members_seo_name']}", "showuser" ) . "' title='{$this->lang->words['view_profile']}' class='ipsUserPhotoLink'>
			") : ("")) . "
			<img src='{$tts['pp_mini_photo']}' alt=\"" . sprintf($this->lang->words['users_photo'],$tts['members_display_name']) . "\" class='ipsUserPhoto ipsUserPhoto_mini left'/>
			" . (($tts['member_id']) ? ("
				</a>
			") : ("")) . "
<div class='list_content'>
				<p class='desc ipsType_smaller'>
					" . (($tts['members_display_name']) ? ("" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($tts) : '' ) . "") : ("{$this->settings['guest_name_pre']}{$tts['starter_name']}{$this->settings['guest_name_suf']}")) . "

</p>
</div>
<div class='list_content'><p class='desc ipsType_smaller'>{$this->lang->words['who_read_topic_last_viewed']} {$this->lang->getDate( $tts['read_date'], 'LONG' )}</div>
		</li>
...
{
$count_f9af4697d08d86143999a860e55d4b8b = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_d1181840c3ad759cf01c86c1ea511ebc = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_d1181840c3ad759cf01c86c1ea511ebc]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_d1181840c3ad759cf01c86c1ea511ebc]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_d1181840c3ad759cf01c86c1ea511ebc]['opts'] = $opts;
}
...
/* -- mentionsLink --*/
function mentionsLink($author) {
$IPBHTML = "";

$name = str_replace( "&#39;", "\'", $author['members_display_name'] );
$mention = sprintf( $this->lang->words['mention_link'], $this->settings['p32mentions_character']);
$IPBHTML .= "<ul class=\"custom_fields\"><li><a href=\"#\" onClick=\"ipb.textEditor.getEditor( ipb.textEditor.getCurrentEditorId() ).insert( '{$this->settings['p32mentions_character']}{$name}' ); return false;\" title=\"{$this->settings['p32mentions_character']}{$name}\">{$mention}</a>
</li></ul>";
return $IPBHTML;
}
...
{
$count_1ca5935aee94bd922ef83976d13f163e = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_1ca5935aee94bd922ef83976d13f163e]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_1ca5935aee94bd922ef83976d13f163e]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_1ca5935aee94bd922ef83976d13f163e]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_1ca5935aee94bd922ef83976d13f163e]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_1ca5935aee94bd922ef83976d13f163e]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_1ca5935aee94bd922ef83976d13f163e]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__3f33b42a6b4ff11e43ce3c3a5602a123($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__1615e8254a51c81004f6884b39875d25($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ca47a12cd37a78c0f327bb720856e742($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__1615e8254a51c81004f6884b39875d25($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__3f33b42a6b4ff11e43ce3c3a5602a123($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__ca47a12cd37a78c0f327bb720856e742($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_2eff6968013fa49a3172254e4826b12d = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_2eff6968013fa49a3172254e4826b12d]['post'] = $post;
$this->functionData['post'][$count_2eff6968013fa49a3172254e4826b12d]['displayData'] = $displayData;
$this->functionData['post'][$count_2eff6968013fa49a3172254e4826b12d]['topic'] = $topic;
$this->functionData['post'][$count_2eff6968013fa49a3172254e4826b12d]['forum'] = $forum;
}
		...
		<div class='post_wrap' " . (($post['post']['_ignored'] == 1 || $post['post']['_repignored'] == 1) ? ("style='display: none'") : ("")) . ">
			...
			")) . "
				...
				" . (($post['author']['member_id']) ? ("" . (($post['author']['_online']) ? ("
								<img src=\"{style_images_url}/user_online.png\" data-tooltip=\"{$this->lang->words['online_online']}\" alt=\"{$this->lang->words['online_online']}\" class=\"postbit_online\" />
							") : ("
								<img src=\"{style_images_url}/user_offline.png\" data-tooltip=\"{$this->lang->words['online_offline']}\" alt=\"{$this->lang->words['online_offline']}\" class=\"postbit_offline\" />
							")) . "
...
" . (($post['post']['queued']==1) ? ("{$this->lang->words['post_approve']}") : ("{$this->lang->words['post_unapprove']}")) . "</span></a>
				...
				") : ("")) . "
					...
					" . ((!$this->memberData['unacknowledged_warnings'] && !$this->memberData['restrict_post']) ? ("" . (($post['post']['_canReply']) ? ("<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=post&amp;section=post&amp;do=reply_post&amp;f={$this->request['f']}&amp;t={$this->request['t']}&amp;qpid={$post['post']['pid']}", "publicWithApp",'' ), "", "" ) . "\"  class='_ips_trigger_quote ipsButton_secondary' pid=\"{$post['post']['pid']}\" title=\"{$this->lang->words['tt_reply_to_post']}\"><i class=\"icon-comments\"></i> {$this->lang->words['post_reply']}</a></li>
							...
							")) . "
								<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=post&amp;section=post&amp;do=reply_post&amp;f={$this->request['f']}&amp;t={$this->request['t']}&amp;qpid={$post['post']['pid']}", "publicWithApp",'' ), "", "" ) . "\" title=\"{$this->lang->words['quote_with_mq']}\" class='ipsButton_secondary'>
								<i class=\"icon-plus-sign\"></i> {$this->lang->words['mq']}</a>
							</li>") : ("")) . "") : ("")) . "
					" . (($post['post']['_can_delete'] === TRUE && ! $topic['_isArchived']) ? ("
						<li id='del_post_{$post['post']['pid']}' class='post_del'>
							<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=moderate&amp;section=moderate&amp;do=postchoice&amp;tact=deletedo&amp;f={$topic['forum_id']}&amp;t={$topic['tid']}&amp;selectedpids[]={$post['post']['pid']}&amp;page={$this->request['page']}&amp;auth_key={$this->member->form_hash}", "publicWithApp",'' ), "", "" ) . "' title='{$this->lang->words['post_delete_title']}' class='delete_post' onclick='return false;' ><i class=\"icon-trash\"></i> {$this->lang->words['post_delete']}</a>
						</li>
					") : ("")) . "
					" . (($post['post']['_softDelete'] && ! $topic['_isArchived']) ? ("
						<li id='hide_post_{$post['post']['pid']}'>
							<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=moderate&amp;section=moderate&amp;do=postchoice&amp;tact=delete&amp;f={$topic['forum_id']}&amp;t={$topic['tid']}&amp;selectedpids[]={$post['post']['pid']}&amp;page={$this->request['page']}&amp;auth_key={$this->member->form_hash}", "publicWithApp",'' ), "", "" ) . "' class='hide_post'><i class=\"icon-minus-sign\"></i> {$this->lang->words['post_hide']}</a>
						</li>
					") : ("")) . "
					" . (($post['post']['_can_edit'] === TRUE) ? ("
						<li class='post_edit'><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=post&amp;section=post&amp;do=edit_post&amp;f={$topic['forum_id']}&amp;t={$topic['tid']}&amp;p={$post['post']['pid']}&amp;page={$this->request['page']}", "publicWithApp",'' ), "", "" ) . "' title='{$this->lang->words['post_edit_title']}' class='edit_post' id='edit_post_{$post['post']['pid']}'><i class=\"icon-pencil\"></i> {$this->lang->words['post_edit']}</a></li>
					") : ("")) . "
					" . (($topic['_canReport'] and ! $topic['_isArchived']) ? ("<li class='report'>
							<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=reports&amp;rcom=post&amp;tid={$this->request['t']}&amp;pid={$post['post']['pid']}&amp;page={$this->request['page']}", "public",'' ), "", "" ) . "'><i class=\"icon-warning-sign\"></i> {$this->lang->words['report']}</a>
						</li>
						" . (($this->memberData['_cache']['report_temp']['post_marker']['post'][ $post['post']['pid'] ]['gfx'] > 0) ? ("<li class='report'>
								<a href=\"{$this->settings['base_url']}app=core&amp;module=reports&amp;section=reports&amp;do=show_report&amp;rid={$this->memberData['_cache']['report_temp']['post_marker']['post'][$post['post']['pid']]['info']['id']}\" id='post-report-{$post['post']['pid']}' class='ipbmenu'> <span id=\"rstat-{$this->memberData['_cache']['report_temp']['post_marker']['post'][ $post['post']['pid'] ]['info']['id']}\">
" . (($this->memberData['_cache']['report_temp']['post_marker']['post'][$post['post']['pid']]['gfx'] == 1) ? ("
<i class=\"icon-warning-sign\"></i>
") : ("")) . "
" . (($this->memberData['_cache']['report_temp']['post_marker']['post'][$post['post']['pid']]['gfx'] == 2) ? ("
<i class=\"icon-exclamation-sign\"></i>
") : ("")) . "
" . (($this->memberData['_cache']['report_temp']['post_marker']['post'][$post['post']['pid']]['gfx'] == 3) ? ("
...
") : ("")) . "
				...
				" . ((! $topic['_isArchived'] AND $this->memberData['_cache']['report_temp']['post_marker']['post'][ $post['post']['pid'] ]['gfx'] > 0) ? ("
					<ul id='post-report-{$post['post']['pid']}_menucontent' class='ipbmenu_content report_menu'>
						<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=reports&amp;do=show_report&amp;rid={$this->memberData['_cache']['report_temp']['post_marker']['post'][ $post['post']['pid'] ]['info']['id']}", "public",'' ), "", "" ) . "\" id='report_mark_{$post['post']['pid']}'><i class=\"icon-ok-sign\"></i>  {$this->lang->words['report_menu_mark_complete']}</a></li>
						<li><a href=\"{$this->settings['base_url']}app=core&amp;module=reports&amp;section=reports&amp;do=show_report&amp;rid={$this->memberData['_cache']['report_temp']['post_marker']['post'][$post['post']['pid']]['info']['id']}\"><i class=\"icon-exclamation-sign\"></i> {$this->lang->words['report_menu_view_report']}</a></li>
					</ul>
					<script type=\"text/javascript\">
...
{
$count_30d9f1606d06104dbf6bd1ca3549c059 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_30d9f1606d06104dbf6bd1ca3549c059]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_088a06df05c88e8b7a2b18cfb4f71cb8 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_088a06df05c88e8b7a2b18cfb4f71cb8]['title'] = $title;
$this->functionData['show_attachment_title'][$count_088a06df05c88e8b7a2b18cfb4f71cb8]['data'] = $data;
$this->functionData['show_attachment_title'][$count_088a06df05c88e8b7a2b18cfb4f71cb8]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__3c1f477d25776f20d510c76dfc54fd2c($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__3c1f477d25776f20d510c76dfc54fd2c($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_47b4b49ff874e76b0e5f148c984421b1 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_47b4b49ff874e76b0e5f148c984421b1]['data'] = $data;
}
...
{
$count_9fb1607185614f838c2247a1b209ed3f = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_9fb1607185614f838c2247a1b209ed3f]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_9fb1607185614f838c2247a1b209ed3f]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_9fb1607185614f838c2247a1b209ed3f]['topic'] = $topic;
}
...
/* -- tbHiddenContentDisableAjax --*/
function tbHiddenContentDisableAjax() {
$IPBHTML = "";
$IPBHTML .= "<script type=\"text/javascript\">
document.observe(\"dom:loaded\", function(){
	if ( $('submit_post') )
	{
		$('submit_post').stopObserving();
	}
});
</script>";
return $IPBHTML;
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__7705f7a25083df83ea5be3210ba74cb1($topic,$posts)."<br class='clear' />
...
function __f__7705f7a25083df83ea5be3210ba74cb1($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3a5d6ccc19640ec8d3cc048e61e763ac = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_3a5d6ccc19640ec8d3cc048e61e763ac]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_3a5d6ccc19640ec8d3cc048e61e763ac]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_3a5d6ccc19640ec8d3cc048e61e763ac]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_3a5d6ccc19640ec8d3cc048e61e763ac]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__8fd4d38b2ace9e5d300f03b54f4ba5e3($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__3ef86badf204c05d9837a2ddc033d88d($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
	document.observe(\"dom:loaded\", function()
	{
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__cb98808aca309a7fe23ace712d0d06b4($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__5e7672003d38d977f88ef1dfb6240870($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__9fe68851e521ab4216e76271fd30f4b3($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__8fd4d38b2ace9e5d300f03b54f4ba5e3($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3ef86badf204c05d9837a2ddc033d88d($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cb98808aca309a7fe23ace712d0d06b4($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5e7672003d38d977f88ef1dfb6240870($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9fe68851e521ab4216e76271fd30f4b3($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
