...
{
$count_00dce4ad8fe615446ddfdee8a3071e0f = is_array($this->functionData['fields']) ? count($this->functionData['fields']) : 0;
$this->functionData['fields'][$count_00dce4ad8fe615446ddfdee8a3071e0f]['dep'] = $dep;
$this->functionData['fields'][$count_00dce4ad8fe615446ddfdee8a3071e0f]['regra'] = $regra;
$this->functionData['fields'][$count_00dce4ad8fe615446ddfdee8a3071e0f]['pergunta'] = $pergunta;
$this->functionData['fields'][$count_00dce4ad8fe615446ddfdee8a3071e0f]['customfields'] = $customfields;
$this->functionData['fields'][$count_00dce4ad8fe615446ddfdee8a3071e0f]['captchaHTML'] = $captchaHTML;
$this->functionData['fields'][$count_00dce4ad8fe615446ddfdee8a3071e0f]['firstid'] = $firstid;
}
...
<ul class=\"ipsPad\">
				...
				" . ((is_array($customfields) and count($customfields)) ? ("".$this->__f__4cb6c262064b88d83d9dd0e1b30fb2f8($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."				") : ("")) . "" . (($pergunta[question] != '') ? ("
					<li class='ipsField'>
...
function __f__4cb6c262064b88d83d9dd0e1b30fb2f8($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_32cb1528c844e1a5a45c59909e947679 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_32cb1528c844e1a5a45c59909e947679]['dep'] = $dep;
$this->functionData['form'][$count_32cb1528c844e1a5a45c59909e947679]['regra'] = $regra;
$this->functionData['form'][$count_32cb1528c844e1a5a45c59909e947679]['pergunta'] = $pergunta;
$this->functionData['form'][$count_32cb1528c844e1a5a45c59909e947679]['customfields'] = $customfields;
$this->functionData['form'][$count_32cb1528c844e1a5a45c59909e947679]['captchaHTML'] = $captchaHTML;
$this->functionData['form'][$count_32cb1528c844e1a5a45c59909e947679]['firstid'] = $firstid;
}
$IPBHTML .= "{$regra}
...
<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>		
			...
			<ul>
				".$this->__f__639126dba0fa90208be769ea24382ac0($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."						
			</ul>
		</div>
...
function __f__639126dba0fa90208be769ea24382ac0($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $dep as $r )
