...
class skin_subscriptions_4 extends skinMaster{
...
$IPBHTML = "";
$IPBHTML .= "<select name=\"currency\">".$this->__f__ac6fd309953650d3132ab11933cd9142($options)."</select>";
return $IPBHTML;
}


function __f__ac6fd309953650d3132ab11933cd9142($options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c69b8002ce2a9ae4fd796373b91b2d64 = is_array($this->functionData['indexScreen']) ? count($this->functionData['indexScreen']) : 0;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['deadRows'] = $deadRows;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['currRows'] = $currRows;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['upgradeRows'] = $upgradeRows;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['newRows'] = $newRows;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['cur_id'] = $cur_id;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['currency'] = $currency;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['currencyOptions'] = $currencyOptions;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['currencyUrl'] = $currencyUrl;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['hasRecurringPayments'] = $hasRecurringPayments;
$this->functionData['indexScreen'][$count_c69b8002ce2a9ae4fd796373b91b2d64]['canRenew'] = $canRenew;
}
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $currRows ) && count( $currRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__8a5c77b693519d51541d9fc195c757fa($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
		") : ("
		...
		<div class=\"ipsBox\">
			<div class=\"ipsBox_container\">
				<table class=\"ipb_table\">
					...
					".$this->__f__46b63467ef718814a39657f0c70c8585($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."				</table>
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $newRows ) && count( $newRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__28717106352befeba5a12d815b6bad42($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
			<fieldset class=\"submit\">
				<input type=\"submit\" class=\"input_submit\" value=\"{$this->lang->words['s_continue_button']}\" />
			</fieldset>
		") : ("
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $deadRows ) && count( $deadRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__36a4d7a39c1569292b0221e2f78edba9($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
		") : ("
...
function __f__8a5c77b693519d51541d9fc195c757fa($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__46b63467ef718814a39657f0c70c8585($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__28717106352befeba5a12d815b6bad42($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__36a4d7a39c1569292b0221e2f78edba9($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<table class='ipb_table'>
		...
		<tr class='header'>
			...
			<th scope='col'>{$this->lang->words['sc_method']}</th>
				...
				".$this->__f__eee49d4454987ba35e72c94b2d64decb($sub_chosen,$upgrade,$curid,$currency,$rows)."	</table>
	<div class='moderation_bar rounded  clear'>
...
function __f__eee49d4454987ba35e72c94b2d64decb($sub_chosen, $upgrade, $curid, $currency, $rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
<li class=\"ipsField clear\">
	...
	<p class=\"ipsField_content\">
		...
		") : ("")) . "".$this->__f__1f68c82aeae7c112b57ffc1e91e119ce($currency,$packages)."	</p>
</li>";
return $IPBHTML;
}


function __f__1f68c82aeae7c112b57ffc1e91e119ce($currency, $packages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<ul class=\"ipsForm ipsForm_horizontal\">
		<li class=\"ipsField\">
			...
			<p class=\"ipsField_content\">
				...
				") : ("")) . "".$this->__f__9f034a75e7d47520814a4c3c0e6f0d16($currency,$packages)."			</p>
		</li>
	</ul>
</fieldset>";
return $IPBHTML;
...
function __f__9f034a75e7d47520814a4c3c0e6f0d16($currency, $packages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $packages as $package )
...
<br />
<form action=\"{$this->request['responderurl']}\" method=\"POST\">".$this->__f__8327fdb7d5fb3db74dcbed733eab94fd($accept)."<table class='ipb_table'>
	<caption class='maintitle'>Data passed</caption>
	".$this->__f__302441f18dd27f23a17a69c66615bbfe($accept)."</table>
<div class='moderation_bar rounded  clear'>
...
function __f__8327fdb7d5fb3db74dcbed733eab94fd($accept)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__302441f18dd27f23a17a69c66615bbfe($accept)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $accept as $field )
