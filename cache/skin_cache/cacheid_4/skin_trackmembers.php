...
class skin_trackmembers_4 extends skinMaster{
...
{
$count_36432ea997d889273b630926579ddea7 = is_array($this->functionData['showSetupPopup']) ? count($this->functionData['showSetupPopup']) : 0;
$this->functionData['showSetupPopup'][$count_36432ea997d889273b630926579ddea7]['memberData'] = $memberData;
$this->functionData['showSetupPopup'][$count_36432ea997d889273b630926579ddea7]['formElements'] = $formElements;
$this->functionData['showSetupPopup'][$count_36432ea997d889273b630926579ddea7]['formData'] = $formData;
}
...
<div class='fixed_inner ipsBox'>
	...
	") : ("")) . "
		...
		<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=trackmembers&module=ajax&section=setup&mid={$memberData['member_id']}&do=save", "public",'' ), "", "" ) . "\" method='post' id='trackMembersSetupForm'>
			".$this->__f__e89db8dadb028aa875d9ecd4dc3ba0ff($memberData,$formElements,$formData)."			<fieldset class='submit clear'>
...
function __f__bc5c3cf3e5eaf8830b8b3e9e6bb39dd4($memberData, $formElements, $formData,$title='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e89db8dadb028aa875d9ecd4dc3ba0ff($memberData, $formElements, $formData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $formElements as $title => $data )
	{
		...
		$_ips___x_retval .= "
				<fieldset class=\"row1\">
					...
					<ul class='ipsPad'>
						".$this->__f__bc5c3cf3e5eaf8830b8b3e9e6bb39dd4($memberData,$formElements,$formData,$title,$data)."					</ul>
				</fieldset>
...
{
$count_0d04328c6964ef075dd705d06713df68 = is_array($this->functionData['trackMemberLogs']) ? count($this->functionData['trackMemberLogs']) : 0;
$this->functionData['trackMemberLogs'][$count_0d04328c6964ef075dd705d06713df68]['logs'] = $logs;
$this->functionData['trackMemberLogs'][$count_0d04328c6964ef075dd705d06713df68]['member'] = $member;
$this->functionData['trackMemberLogs'][$count_0d04328c6964ef075dd705d06713df68]['status'] = $status;
$this->functionData['trackMemberLogs'][$count_0d04328c6964ef075dd705d06713df68]['pages'] = $pages;
$this->functionData['trackMemberLogs'][$count_0d04328c6964ef075dd705d06713df68]['footer_filter'] = $footer_filter;
}
			...
			<div class='ipsPad'>
				<div id='profile_content_main'>
					...
					<div id='user_info_cell' style='padding-left: 10px;'>
						...
						" . ((!empty( $warns )) ? ("
							".$this->__f__5250d38e3b697d12bdfd404a4dcbdda7($logs,$member,$status,$pages,$footer_filter)."						") : ("")) . "
						" . (($member['_online']) ? ("
			...
			<div class='ipsPad'>
				...
				<table class='ipb_table'>
					...
					" . ((is_array( $logs ) AND count( $logs )) ? ("
												".$this->__f__d8f7d57d5d49ca31d9060a33b9dc67ac($logs,$member,$status,$pages,$footer_filter)."					") : ("
						<tr>
...
function __f__5250d38e3b697d12bdfd404a4dcbdda7($logs, $member, $status, $pages, $footer_filter)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d8f7d57d5d49ca31d9060a33b9dc67ac($logs, $member, $status, $pages, $footer_filter)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
