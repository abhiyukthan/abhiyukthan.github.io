...
$this->_funcHooks['globalTemplate'] = array('showingapp','applications','didfirstappnow','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','isCoreRC','hideRcForPerms','fbcenabled','isLargeTouch','isSmallTouch','accessreports','showacplink','rclink','accessreports','brandingBar','showhomeurl','applicationsloop','hasCustomPrimaryNavigation','notifications','messengerlink','notifications','showInboxNotify','authenticating','updateTwitter','updateFacebook','update','canUpdateStatus','userLikeLink','nobbyNoMates','bloglink','pmLink','gallerylink','nexuslink','limFacebook','limTwitter','limWindows','memberbox','canSearch','showQuickNav','viewnewcontentapp','didfirstnav','switchnavigation','hasHeaderAd','mainpageContent','hasFooterAd','isTouchDevice','skinchangerInner','uagentlocked','skinchangerOuter','langchooser','markRead','privvy','ruleslink','siterulestitle','privvyMiddot','siteruleslink','lastvisit','isfloat','sqldebuglink','closesqldebuglink','showdebuglevel','includeLightboxDoReal');
...
$this->_funcHooks['quickSearch'] = array('inThisApp','inThisApp','appLoop','hasSearchApp','hasSearchApp','inTopic','inForum','appContextSearch','lookElsewhere','inThisApp','inThisApp','inThisApp');
...
/* -- aud_announcements --*/
function aud_announcements() {
$IPBHTML = "";

/**** GLOBAL MESSAGE #1 ****/
$this->show_message_1 = "yes"; //show message
$this->message_1_color = "green"; //message color
$this->message_1_title = "Green message"; //message title (leave "" for no title)
$this->message_1_text = "This can be used for important positive announcements."; //message text

/**** GLOBAL MESSAGE #2 ****/
$this->show_message_2 = "yes"; //show message
$this->message_2_color = "red"; //message color
$this->message_2_title = "Red message"; //message title (leave "" for no title)
$this->message_2_text = "This can be used for a global error message or important announcements."; //message text

/**** GLOBAL MESSAGE #3 ****/
$this->show_message_3 = "yes"; //show message 2?
$this->message_3_color = "gray"; //message color
$this->message_3_title = "Gray message"; //message title (leave "" for no title)
$this->message_3_text = "This can be used as a generic announcement."; //message text


/* no need to touch the code below */
$IPBHTML .= "<div class=\"aud_announcements\">
" . (($this->show_message_1 == yes) ? ("<div class=\"message " . (($this->message_1_color == red) ? ("error") : ("")) . "" . (($this->message_1_color == gray) ? ("unspecific") : ("")) . "\">
	" . (($this->message_1_title) ? ("<b>{$this->message_1_title}</b><br />") : ("")) . "
	{$this->message_1_text}
	</div><br />") : ("")) . "" . (($this->show_message_2 == yes) ? ("<div class=\"message " . (($this->message_2_color == red) ? ("error") : ("")) . "" . (($this->message_2_color == gray) ? ("unspecific") : ("")) . "\">
	" . (($this->message_2_title) ? ("<b>{$this->message_2_title}</b><br />") : ("")) . "
	{$this->message_2_text}
	</div><br />") : ("")) . "" . (($this->show_message_3 == yes) ? ("<div class=\"message " . (($this->message_3_color == red) ? ("error") : ("")) . "" . (($this->message_3_color == gray) ? ("unspecific") : ("")) . "\">
	" . (($this->message_3_title) ? ("<b>{$this->message_3_title}</b><br />") : ("")) . "
	{$this->message_3_text}
	</div><br />") : ("")) . "
</div>";
return $IPBHTML;
...
/* Logo text - leave blank to use image (public/style_images/cubic/logo.png) */
$this->logo_text = "";

/* Site width - 940px for fixed, 98% for fluid are the recommended settings */
$this->site_width = "1220px";

/* Show user online/offline status */
$this->show_user_status = yes;

/* Show global messages */
$this->show_global_messages = "no"; 

/* Sticky admin bar */
$this->sticky_admin_bar = yes; //change value to make the admin bar static

/* Enable or disable ADstyler for all users */
$this->enable_adstyler = no;

/* Enable or disable ADstyler for all users */
$this->adstyler_settings_file = "settings.js";

//SOCIAL NETWORK LINKS AND RSS FEED
//to disable a link, change value to ""

$this->facebook_url = "https://www.facebook.com/crackingportal"; //URL of your facebook page
$this->twitter_name = ""; //Your twitter username
$this->youtube_url = ""; //your youtube channel URL
$this->dribbble_url = ""; //Your dribbble URL
$this->vimeo_url = ""; //Your vimeo channel URL
$this->linkedin_url = ""; //Your linkedin URL
$this->pinterest_url = ""; //Your linkedin URL

//social link titles
$this->twitter_title = "Follow us on Twitter";
$this->facebook_title = "Become our fan on Facebook";
$this->youtube_title = "Subscribe to us on YouTube";
$this->dribbble_title = "Follow us on Dribbble";
$this->vimeo_title = "Subscribe to us on Vimeo";
$this->linkedin_title = "Connect with us on LinkedIn";
$this->pinterest = "Follow us on Pinterest";

/**************************/
/***Custom Default style***/
/**************************/

//define the default global look here
//get color codes from http://www.colorpicker.com/

$this->default_main_color = '#c11111'; //default main color
$this->default_background_color = '#f8f8f8'; //default background color
$this->default_background_pattern = 'noise_1'; //default background pattern (check public/style_images/cubic/assets/ad_styler/imgs/bgs for all available patterns)
$this->default_link_color = '#ed2323'; //default link color 
$this->default_link_hover_color = '#c11111'; //default link hover color
$IPBHTML .= "";
return $IPBHTML;
}
...
$IPBHTML .= "<style type=\"text/css\">
	...
	" . (($this->sticky_admin_bar != yes) ? ("
		#admin_bar_wrapper {position:absolute !important;}
	") : ("")) . "" . (($this->enable_adstyler == yes) ? ("") : ("")) . "" . (($this->show_user_status != yes) ? ("
		.postbit_online,.postbit_offline {display:none}
	") : ("")) . "
		.mcolor {background-color:{$this->default_main_color}}

		/* html dynamic css */
		html {background:{$this->default_background_color} url({style_images_url}/assets/ad_styler/imgs/bgs/{$this->default_background_pattern}.png);height: 100%;}

		/* set the width */
		.main_width {width: {$this->site_width};}

		/* apply select linkcolor */
		a {color:{$this->default_link_color};}

		/* apply selected main color to some elements */
		a:hover, .post_body a {color:{$this->default_link_hover_color};}

		/* apply the selected main color to elements */
		#board_stats .value, .post_controls > li > a,.post_controls .ipsLikeButton, #community_app_menu > li.active > a, .topic_buttons li a:hover, .ipsButton:hover, .maintitle, .cke_dialog_title,#community_app_menu > li > a.menu_active {
			background-color:{$this->default_main_color};
		}
		.ipsLikeBar_info a:hover {background: transparent !important;}
</style>";
return $IPBHTML;
}
...
$IPBHTML = "";
$IPBHTML .= "<a href='{$this->settings['board_url']}' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'>
" . (($this->logo_text) ? ("<h1>$this->logo_text</h1>") : ("<img src='" . $this->registry->getClass('output')->getReplacement("logo_img") . "' alt='{$this->lang->words['logo']}' />")) . "
</a>";
return $IPBHTML;
}
...
{
$count_bffbbc0a0bfcc1d3cba3972cc8dc1910 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['html'] = $html;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['css'] = $css;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['items'] = $items;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_bffbbc0a0bfcc1d3cba3972cc8dc1910]['stats'] = $stats;
}
...
$IPBHTML .= "<!DOCTYPE html>
	...
	<head>
		...
		<!-- ADD EXTRA PADDING TO BODY IF ADMIN BAR IS SHOWN-->
		<!--hook.if.skin_global.globalTemplate.accessreports.pre.startif-->" . (($this->memberData['is_mod'] OR !empty($this->memberData['access_report_center']) || ($this->memberData['g_access_cp'] AND !$this->settings['security_remove_acp_link'])) ? ("
		<style type=\"text/css\">
		#aud_wrapper {margin-top: 40px}
		</style>
		") : ("")) . "
<!-- Ckeditor Dark textarea -->
<script>
jQuery.noConflict();
jQuery(document).ready(function(){
var interval = setInterval(function(){
    var ckframe = jQuery('.cke_editor iframe')
    if (ckframe.length){
        ckframe.contents().find('body').css({
'background':'#111',
'color':'white'});
...
<p id='content_jump' class='hide'><a id='top'></a><a href='#j_content' title='{$this->lang->words['jump_to_content']}' accesskey='m'>{$this->lang->words['jump_to_content']}</a></p>
		<div id='ipbwrapper'>
			<!-- ADMIN BAR -->
				<!--hook.if.skin_global.globalTemplate.accessreports.pre.startif-->" . (($this->memberData['is_mod'] OR !empty($this->memberData['access_report_center']) || ($this->memberData['g_access_cp'] AND !$this->settings['security_remove_acp_link'])) ? ("<div id=\"admin_bar_wrapper\">
						<ul id='admin_bar' class='ipsList_inline main_width'>
			...
			<div id=\"aud_wrapper\" class='main_width'>
						...
						<div id='primary_nav' class='clearfix right'>
							<ul class='ipsList_inline' id='community_app_menu'>
								...
								") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
										".$this->__f__58e816cfa1d45ac22e9d2e5ffefb10b8($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									") : ("")) . "")) . "
				...
				<div id='header_bar' class='clearfix'>
					" . (($this->memberData['member_id']) ? ("<div id='user_navigation' class='logged_in'>
							<ul class='ipsList_inline left'>
								...
								<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$this->memberData['member_id']}", "public",'' ), "{$this->memberData['members_seo_name']}", "showuser" ) . "\" data-tooltip='{$this->lang->words['your_profile']}' class='aud_userPhotoLink'>
						...
						<div id='user_link_menucontent' class='ipsHeaderMenu clearfix boxShadow' style='display: none'>
							...
							<ul class='ipsList_inline cubic_list left'>
								<li>
									...
									<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=login", "public",'' ), "", "" ) . "' title='{$this->lang->words['sign_in']}' id='sign_in'>
					...
					<!-- new content and navigation link -->
				...
				<div id='content' class='clearfix'>
					...
					" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
							<ol class='breadcrumb top ipsList_inline left'>
									...
									" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
								".$this->__f__467d05dcc07dc406a0579e9742e9b98c($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ol>
								...
								" . ((count($footer_items['skin_chooser']) > 1) ? ("
									<li>
										...
										<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
											".$this->__f__9c73c69e46a3d7a2ca3085faf9c0236b($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."										</ul>
									</li>
								") : ("")) . "")) . "") : ("")) . "
						...
						" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
							<li>
								...
								<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
									".$this->__f__2d2e1d8de982fd633a67fc590a30b49d($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</ul>
							</li>
						...
						" . ((! $this->member->is_not_human) ? ("
							<li>
								...
								<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
									".$this->__f__01dc109a1f010bb7356985d6fd088ff1($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									<li>
				...
				<ul class=\"aud_list right\">
					...
					<li class=\"social\">
						<a href=\"#\" class=\"social-rss\" data-tooltip=\"Subscribe to our RSS feed\" id='rss_feed' class='clickable'></a>
					</li>
					" . (($this->facebook_url) ? ("
						<li class=\"social\">
							<a href=\"{$this->facebook_url}\" class=\"social-facebook\" data-tooltip=\"{$this->facebook_title}\" target=\"_blank\"></a>
						</li>
					") : ("")) . "" . (($this->twitter_name) ? ("
						<li class=\"social\">
						<a href=\"http://twitter.com/{$this->twitter_name}\" class=\"social-twitter\" data-tooltip=\"{$this->twitter_title}\" target=\"_blank\"></a>
						</li>
					") : ("")) . "" . (($this->youtube_url) ? ("
						<li class=\"social\">
						<a href=\"{$this->youtube_url}\" class=\"social-youtube\" data-tooltip=\"{$this->youtube_title}\" target=\"_blank\"></a>
						</li>
					") : ("")) . "" . (($this->dribbble_url) ? ("
						<li class=\"social\">
						<a href=\"{$this->dribbble_url}\" class=\"social-dribbble\" data-tooltip=\"{$this->dribbble_title}\" target=\"_blank\"></a>
						</li>
					") : ("")) . "" . (($this->vimeo_url) ? ("
						<li class=\"social\">
						<a href=\"{$this->vimeo_url}\" class=\"social-vimeo\" data-tooltip=\"{$this->vimeo_title}\" target=\"_blank\"></a>
						</li>
					") : ("")) . "" . (($this->linkedin_url) ? ("
						<li class=\"social\">
						<a href=\"{$this->linkedin_url}\" class=\"social-linkedin\" data-tooltip=\"{$this->linkedin_title}\" target=\"_blank\"></a>
						</li>
					") : ("")) . "" . (($this->pinterest_url) ? ("
						<li class=\"social\">
						<a href=\"{$this->pinterest_url}\" class=\"social-pinterest\" data-tooltip=\"{$this->pinterest_title}\" target=\"_blank\"></a>
						</li>
					") : ("")) . "
				</ul>
					<div class=\"footer_copyright\">
<span class=\"copyright_row\">
Skin Crafted by <a href=\"http://www.audentio.com\" title=\"High quality IPB skins\" data-tooltip=\"High quality IPB skins\">Audentio Design.</a>
</span>
...
function __f__58e816cfa1d45ac22e9d2e5ffefb10b8($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__467d05dcc07dc406a0579e9742e9b98c($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9c73c69e46a3d7a2ca3085faf9c0236b($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2d2e1d8de982fd633a67fc590a30b49d($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__01dc109a1f010bb7356985d6fd088ff1($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ecc780b0355c7835d40bd0efd6b9341b = is_array($this->functionData['guestMessage']) ? count($this->functionData['guestMessage']) : 0;
}
...
{
$count_a8c81f210af75ad5d1ec304e1c410331 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_a8c81f210af75ad5d1ec304e1c410331]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'audentio_config' ) ? $this->registry->getClass('output')->getTemplate('global')->audentio_config() : '' ) . "
<!-- Include Open sans font -->
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700' rel='stylesheet' type='text/css'>

<!-- Include iconic font -->
<link href='{style_images_url}/assets/icons.css' rel='stylesheet' type='text/css'>

" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__a27b620c965c3398db03952a2c287d10($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__7e969f6f9a1c8abe0d83069286fe9600($css)."") : ("")) . "
<!--[if lte IE 7]>
...
<!-- Include user selected CSS -->
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'custom_style' ) ? $this->registry->getClass('output')->getTemplate('global')->custom_style() : '' ) . "" . (($this->enable_adstyler == yes) ? ("
<!-- ADstyler css START -->

<link rel=\"stylesheet\" id=\"sbcss\" href=\"{style_images_url}/assets/ad_styler/styles/cubic/css.php\">
<link href='{style_images_url}/assets/ad_styler/css/styleBar.css' rel='stylesheet' type='text/css'>
...
function __f__a27b620c965c3398db03952a2c287d10($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7e969f6f9a1c8abe0d83069286fe9600($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c97b1771fcac2b2deebf364cb43ca273 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_c97b1771fcac2b2deebf364cb43ca273]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__b1af1304ee4b3c1f21003e56781b6fd2($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__f36ce1fda026024f7f6f2f9e474b3ac5($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b1af1304ee4b3c1f21003e56781b6fd2($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__f36ce1fda026024f7f6f2f9e474b3ac5($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_f108106d79efd83bcdfe6dfc765abd5a = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_f108106d79efd83bcdfe6dfc765abd5a]['jsModules'] = $jsModules;
}
$IPBHTML .= "<!-- Include jQuery -->
<script src=\"//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js\"></script>
<script type=\"text/javascript\" src=\"{style_images_url}/assets/js/cubic.js\"></script>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'audentio_config' ) ? $this->registry->getClass('output')->getTemplate('global')->audentio_config() : '' ) . "
" . (($this->enable_adstyler == yes) ? ("<!-- AD styler js START -->
<script type=\"text/javascript\" src=\"{style_images_url}/assets/ad_styler/styles/cubic/" . (($this->adstyler_settings_file) ? ("{$this->adstyler_settings_file}") : ("settings.js")) . "\"></script>
<script type=\"text/javascript\" src=\"{style_images_url}/assets/ad_styler/jquery.styleBar.min.js\"></script>
<script>
...
" . (($this->settings['use_minify']) ? ("" . (($this->settings['remote_load_js']) ? ("<script type='text/javascript' src='" . (($this->registry->output->isHTTPS) ? ("https") : ("http")) . "://ajax.googleapis.com/ajax/libs/prototype/1.7.1.0/prototype.js'></script>
	...
	")) . "
	<script type=\"text/javascript\" src='{$this->settings['cache_dir']}lang_cache/{$this->lang->lang_id}/ipb.lang.js' charset='{$this->settings['gb_char_set']}'></script>")) . "<!--hook.if.skin_global.includeJS.minifyjs.post.endif-->
...
{
$count_cba22e1b42a0dff4b94a48d05d9da890 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_cba22e1b42a0dff4b94a48d05d9da890]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__74a6d645eb0a4783d5261cfa61fae38d($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__d0dc01949e70875ff2e7f25055e5d914($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__74a6d645eb0a4783d5261cfa61fae38d($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__d0dc01949e70875ff2e7f25055e5d914($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_3ca2e4ada0ce1669dac6c812a9a5e947 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__f168f77d8e42924f31b4f5b2c2f9388c()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__f168f77d8e42924f31b4f5b2c2f9388c()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4ac7a99688ceaa6ce229430cef9b4c7b = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_4ac7a99688ceaa6ce229430cef9b4c7b]['header_items'] = $header_items;
}
...
{
$count_e78eea386de6ce2af95f1a71970611e8 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
				...
				" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>
						<ul class='ipsList_inline'>
							...
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__d5124dbad9d08c2224c3d1260e5e1051()."							") : ("")) . "
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__d5124dbad9d08c2224c3d1260e5e1051()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_64b94dfefc083ed92fc3d0039bcd8eee = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
/* -- loginCaptchaInlineLoadJs --*/
function loginCaptchaInlineLoadJs() {
$IPBHTML = "";
$IPBHTML .= "<script type='text/javascript' src='" . (($this->settings['logins_over_https']) ? ("https://") : ("http://")) . "www.google.com/recaptcha/api/js/recaptcha_ajax.js'></script>";
return $IPBHTML;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__b45998b8d997ec5dae4e95eb9e5716c9($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__b45998b8d997ec5dae4e95eb9e5716c9($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_29f7b46c1625dd730d08242a3aa0d90d = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_29f7b46c1625dd730d08242a3aa0d90d]['data'] = $data;
}
...
{
$count_f6c59ed3bb8b7987d51b57e7bfc20b3d = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_f6c59ed3bb8b7987d51b57e7bfc20b3d]['work'] = $work;
$this->functionData['paginationTemplate'][$count_f6c59ed3bb8b7987d51b57e7bfc20b3d]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__b62fa2b342558edc2872f656993b8cfc($work,$data)."			") : ("")) . "
		</ul>
...
function __f__b62fa2b342558edc2872f656993b8cfc($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_71b2672dcbae82ea4f709f9a75a32336 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
$IPBHTML .= "<li class=\"right\">
<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=search&amp;search_in=" . ((isset($this->request['search_app']) AND $this->request['search_app']) ? ("{$this->request['search_app']}") : ("{$this->registry->getCurrentApplication()}")) . "", "public",'' ), "", "" ) . "\" class='aud_search' data-tooltip=\"{$this->lang->words['sj_search']}\"></a>
<div id='search' class='aud_search_box right'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=search&amp;do=search&amp;fromMainBar=1", "public",'' ), "", "" ) . "\" method=\"post\" id='search-box' >
		<fieldset>
			...
			<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=search&amp;search_in=" . ((isset($this->request['search_app']) AND $this->request['search_app']) ? ("{$this->request['search_app']}") : ("{$this->registry->getCurrentApplication()}")) . "", "public",'' ), "", "" ) . "' data-tooltip='{$this->lang->words['advanced_search']}' accesskey='4' rel=\"search\" id='adv_search' class='right'></a>
			<span id='aud_search_wrap' class='right'>
...
function __f__afdf3cb90a488633dc570e9cc5c32c5e()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e217458a9f466554ffc95043e2e04726 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_e217458a9f466554ffc95043e2e04726]['links'] = $links;
$this->functionData['shareLinks'][$count_e217458a9f466554ffc95043e2e04726]['title'] = $title;
$this->functionData['shareLinks'][$count_e217458a9f466554ffc95043e2e04726]['url'] = $url;
$this->functionData['shareLinks'][$count_e217458a9f466554ffc95043e2e04726]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__b6d5376aa694ebec599effcd5363174b($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__b6d5376aa694ebec599effcd5363174b($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b7b9e0dbd6ec780d093a0728916f92ee = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_b7b9e0dbd6ec780d093a0728916f92ee]['sig'] = $sig;
$this->functionData['signature_separator'][$count_b7b9e0dbd6ec780d093a0728916f92ee]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_b7b9e0dbd6ec780d093a0728916f92ee]['can_ignore'] = $can_ignore;
}
...
{
$count_2894504281be1a977f1cced41a85a1a2 = is_array($this->functionData['tbSruiHook']) ? count($this->functionData['tbSruiHook']) : 0;
$this->functionData['tbSruiHook'][$count_2894504281be1a977f1cced41a85a1a2]['author'] = $author;
}
...
{
$count_88134dbab14b7e8682d9ea5b13f310ff = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_88134dbab14b7e8682d9ea5b13f310ff]['member'] = $member;
}
...
{
$count_e40772963f0a2107c47f1d00b3bea149 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_e40772963f0a2107c47f1d00b3bea149]['author'] = $author;
$this->functionData['userInfoPane'][$count_e40772963f0a2107c47f1d00b3bea149]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_e40772963f0a2107c47f1d00b3bea149]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__f9773d26a2949b62299a04d20ba7e261($author,$contentid,$options)."		</ul>
...
function __f__2ddba8924cf7e0fe212dd62cbb6fb779($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f9773d26a2949b62299a04d20ba7e261($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__2ddba8924cf7e0fe212dd62cbb6fb779($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_dd441c0a634b4b7308519becf00e9582 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_dd441c0a634b4b7308519becf00e9582]['member'] = $member;
}
...
{
$count_6474deea88722b17570abde4baa7f43c = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_6474deea88722b17570abde4baa7f43c]['warning'] = $warning;
$this->functionData['warnDetails'][$count_6474deea88722b17570abde4baa7f43c]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__239f43df1fe3c4132923bdabfa0203e8($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__239f43df1fe3c4132923bdabfa0203e8($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
