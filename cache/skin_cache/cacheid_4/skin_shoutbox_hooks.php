...
class skin_shoutbox_hooks_4 extends skinMaster{
...
{
$count_6c9e01137a4e8df823d22bf61f8696a7 = is_array($this->functionData['hookActiveUsers']) ? count($this->functionData['hookActiveUsers']) : 0;
$this->functionData['hookActiveUsers'][$count_6c9e01137a4e8df823d22bf61f8696a7]['stats'] = $stats;
}
...
{
$count_d7a099d49a83788860020bddda8c86ea = is_array($this->functionData['hookActiveUsersSidebar']) ? count($this->functionData['hookActiveUsersSidebar']) : 0;
$this->functionData['hookActiveUsersSidebar'][$count_d7a099d49a83788860020bddda8c86ea]['stats'] = $stats;
}
...
{
$count_1e91ace4f7ce16255de6ca54ffa4bc34 = is_array($this->functionData['hookGlobalShoutbox']) ? count($this->functionData['hookGlobalShoutbox']) : 0;
$this->functionData['hookGlobalShoutbox'][$count_1e91ace4f7ce16255de6ca54ffa4bc34]['d'] = $d;
}
...
{
$count_3fbc1427c30b0c18c2b08818fce731e2 = is_array($this->functionData['hookGlobalShoutboxEmoticons']) ? count($this->functionData['hookGlobalShoutboxEmoticons']) : 0;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3fbc1427c30b0c18c2b08818fce731e2]['emoticons'] = $emoticons;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3fbc1427c30b0c18c2b08818fce731e2]['total'] = $total;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3fbc1427c30b0c18c2b08818fce731e2]['prev'] = $prev;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_3fbc1427c30b0c18c2b08818fce731e2]['next'] = $next;
}
...
<table class=\"ipb_table\">
			".$this->__f__c276d6792b177d0271cd5c4a30381ef2($emoticons,$total,$prev,$next)."	" . ((count($emoticons)%$this->settings['shoutbox_emos_perrow']>0) ? ("
				{$extra}
		</tr>
	") : ("")) . "
</table>";
...
function __f__c276d6792b177d0271cd5c4a30381ef2($emoticons=array(), $total=0, $prev=0, $next=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e709bf234459a2361a174452c22e5067 = is_array($this->functionData['hookGlobalShoutboxSidebar']) ? count($this->functionData['hookGlobalShoutboxSidebar']) : 0;
$this->functionData['hookGlobalShoutboxSidebar'][$count_e709bf234459a2361a174452c22e5067]['d'] = $d;
}
$IPBHTML .= "<!--- ShoutBoxJsLoader --->
<script type='text/javascript'>
/* Setup some value */
...
{
$count_573d3e82aa7c0f7a2e45cc19590134b5 = is_array($this->functionData['hookOnlineTab']) ? count($this->functionData['hookOnlineTab']) : 0;
$this->functionData['hookOnlineTab'][$count_573d3e82aa7c0f7a2e45cc19590134b5]['count'] = $count;
}
$IPBHTML .= "" . (($count > 0) ? ("
...
{
$count_39460dac3c23a20e60945bdc11ba615c = is_array($this->functionData['hookVCard']) ? count($this->functionData['hookVCard']) : 0;
$this->functionData['hookVCard'][$count_39460dac3c23a20e60945bdc11ba615c]['member'] = $member;
}
...
{
$count_d0e1d4172972caf6326b669e1497d7e2 = is_array($this->functionData['shoutboxJavascript']) ? count($this->functionData['shoutboxJavascript']) : 0;
}
