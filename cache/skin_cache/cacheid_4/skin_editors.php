...
{
$count_b9960516fc9d2bf25be9596c80049cba = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_b9960516fc9d2bf25be9596c80049cba]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_b9960516fc9d2bf25be9596c80049cba]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_b9960516fc9d2bf25be9596c80049cba]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_b9960516fc9d2bf25be9596c80049cba]['extraData'] = $extraData;
}
...
{
$count_971af3f128f037c68dc9fc45d6068219 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['formField'] = $formField;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['content'] = $content;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['options'] = $options;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_971af3f128f037c68dc9fc45d6068219]['showEditor'] = $showEditor;
}
...
{
$count_f589be6a61f1891f3f4e5a5db9ff85a9 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_f589be6a61f1891f3f4e5a5db9ff85a9]['options'] = $options;
$this->functionData['editorLoadJs'][$count_f589be6a61f1891f3f4e5a5db9ff85a9]['inlineLoad'] = $inlineLoad;
}
...
{
$count_237a1446ee53858054559298ec58e631 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_237a1446ee53858054559298ec58e631]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_237a1446ee53858054559298ec58e631]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_237a1446ee53858054559298ec58e631]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_237a1446ee53858054559298ec58e631]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__4c7851779d079f2f0248ee8a293bfbff($rows,$pages,$app,$plugin)."		") : ("
...
function __f__4c7851779d079f2f0248ee8a293bfbff($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_1bb10c30a81913e2c6a9a4559a043df7 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_1bb10c30a81913e2c6a9a4559a043df7]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__947a6d666f8f51f2e49b3f5b5da5a48b($tabs)."			</ul>
		</div>
...
function __f__947a6d666f8f51f2e49b3f5b5da5a48b($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
