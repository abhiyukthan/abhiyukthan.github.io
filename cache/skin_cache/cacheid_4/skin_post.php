...
{
$count_eeadcf332870bfcab8e6fb83af8bf2ea = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_eeadcf332870bfcab8e6fb83af8bf2ea]['data'] = $data;
}
...
{
$count_02e50f0451584669a922b23a1b0619d6 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_02e50f0451584669a922b23a1b0619d6]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_02e50f0451584669a922b23a1b0619d6]['form'] = $form;
}
...
{
$count_d5148682e7b2e528cb7fd61a27d19270 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_d5148682e7b2e528cb7fd61a27d19270]['data'] = $data;
}
...
{
$count_8d31acedfe9e7afe086a839ea6407f51 = is_array($this->functionData['tbHiddenContent']) ? count($this->functionData['tbHiddenContent']) : 0;
}
...
{
$count_34fadde0d93af23d61b4acf5174052cb = is_array($this->functionData['tbUnhiddenContent']) ? count($this->functionData['tbUnhiddenContent']) : 0;
$this->functionData['tbUnhiddenContent'][$count_34fadde0d93af23d61b4acf5174052cb]['content'] = $content;
}
...
{
$count_294fecf9a9830ad06f84e49e6042c52e = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_294fecf9a9830ad06f84e49e6042c52e]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__64947fe192526ca0c0d725fd993ca55e($posts)."") : ("")) . "
<p class='submit'>
...
function __f__64947fe192526ca0c0d725fd993ca55e($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_dfa021858f9e01f0ead5b023b404209d = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_dfa021858f9e01f0ead5b023b404209d]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_dfa021858f9e01f0ead5b023b404209d]['type'] = $type;
$this->functionData['uploadForm'][$count_dfa021858f9e01f0ead5b023b404209d]['stats'] = $stats;
$this->functionData['uploadForm'][$count_dfa021858f9e01f0ead5b023b404209d]['id'] = $id;
$this->functionData['uploadForm'][$count_dfa021858f9e01f0ead5b023b404209d]['forum_id'] = $forum_id;
}
