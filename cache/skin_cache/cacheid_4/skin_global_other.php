...
$this->_funcHooks['banReason'] = array('haserrorcode','savedpost');
...
{
$count_5e706513487144565f162ef002371963 = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_5e706513487144565f162ef002371963]['msg'] = $msg;
}
...
/* -- banReason --*/
function banReason($message,$code,$ad_email_one,$ad_email_two, $title, $banreason) {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_global_other', $this->_funcHooks['banReason'] ) )
{
$count_1be11b2814a944980951e5dfbb271874 = is_array($this->functionData['banReason']) ? count($this->functionData['banReason']) : 0;
$this->functionData['banReason'][$count_1be11b2814a944980951e5dfbb271874]['message'] = $message;
$this->functionData['banReason'][$count_1be11b2814a944980951e5dfbb271874]['code'] = $code;
$this->functionData['banReason'][$count_1be11b2814a944980951e5dfbb271874]['ad_email_one'] = $ad_email_one;
$this->functionData['banReason'][$count_1be11b2814a944980951e5dfbb271874]['ad_email_two'] = $ad_email_two;
$this->functionData['banReason'][$count_1be11b2814a944980951e5dfbb271874]['title'] = $title;
$this->functionData['banReason'][$count_1be11b2814a944980951e5dfbb271874]['banreason'] = $banreason;
}
...
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		...
		<p class='ipsType_sectiontitle'>
			{$message}<br /><br />
			<span style=\"color: red;\"><b>{$this->lang->words['banned_reason']}: {$banreason}</b></span>
		</p>
		<br />
...
{
$count_fe12cc15ca62addf8986481bd1adf5c3 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_fe12cc15ca62addf8986481bd1adf5c3]['message'] = $message;
}
...
{
$count_36a1d9efbbbbf4c29df7a7923f85f87c = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_36a1d9efbbbbf4c29df7a7923f85f87c]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_36a1d9efbbbbf4c29df7a7923f85f87c]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_36a1d9efbbbbf4c29df7a7923f85f87c]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_36a1d9efbbbbf4c29df7a7923f85f87c]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_36a1d9efbbbbf4c29df7a7923f85f87c]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\">
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__f0e46a2f5ae25aa29e9e1c871127af73($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__043760b975e7041ee8f14fd1a1ad2870($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__69e8c3ca964f967d21d9e9a5f9c62597($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<script type='text/javascript'>
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__b2cd57aea7e8aadc285f61fd68121aba($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__f0e46a2f5ae25aa29e9e1c871127af73($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__043760b975e7041ee8f14fd1a1ad2870($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__69e8c3ca964f967d21d9e9a5f9c62597($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ca234cd3a1c01e5714597491c272b9fb($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b2cd57aea7e8aadc285f61fd68121aba($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__ca234cd3a1c01e5714597491c272b9fb($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_f8dd545c784c9d992a6859e057d43858 = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_f8dd545c784c9d992a6859e057d43858]['message'] = $message;
$this->functionData['Error'][$count_f8dd545c784c9d992a6859e057d43858]['code'] = $code;
$this->functionData['Error'][$count_f8dd545c784c9d992a6859e057d43858]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_f8dd545c784c9d992a6859e057d43858]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_f8dd545c784c9d992a6859e057d43858]['title'] = $title;
}
...
{
$count_a8f4ebec6087556ab357d9b56611a438 = is_array($this->functionData['facebookPop']) ? count($this->functionData['facebookPop']) : 0;
$this->functionData['facebookPop'][$count
['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_7bd28f24866e7938d134dfece82a25b2]['text'] = $text;
$this->functionData['redirectTemplate'][$count_7bd28f24866e7938d134dfece82a25b2]['url'] = $url;
$this->functionData['redirectTemplate'][$count_7bd28f24866e7938d134dfece82a25b2]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\">
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__a05ed49cf89e33b7742975b11842712a($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__278e6693fd840abb3a23159472124742($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__9bb5a905799b2d3545ea2e9954c18ed7($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__a05ed49cf89e33b7742975b11842712a($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__278e6693fd840abb3a23159472124742($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__89268f0d68afb0446c60b5935c6dd247($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__9bb5a905799b2d3545ea2e9954c18ed7($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__89268f0d68afb0446c60b5935c6dd247($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_80b4c046b2176c8d8bee9b72e7677dce = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_80b4c046b2176c8d8bee9b72e7677dce]['member'] = $member;
$this->functionData['repButtons'][$count_80b4c046b2176c8d8bee9b72e7677dce]['data'] = $data;
}
...
$IPBHTML .= "" . (($this->settings['reputation_enabled']) ? ("<li class=\"left aud_LikeBox\">
	" . ((!( $this->settings['reputation_protected_groups'] && in_array( $member['member_group_id'], explode( ',', $this->settings['reputation_protected_groups'] ) ) ) and $this->memberData['member_id']) ? ("" . (($this->settings['reputation_point_types'] == 'like') ? ("<div class='ipsLikeBar' id='{$data['domCountId']}'>
...
<div class='likepop fixed_inner'>
	<ul class='ipsList_withminiphoto'>
		".$this->__f__911d2cd5efb7949d2986e807ef947ac2($data,$relId)."	</ul>
</div>";
return $IPBHTML;
}


function __f__911d2cd5efb7949d2986e807ef947ac2($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $mid => $data )
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__4ed206f37744d398d99a676e33af856e($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__4ed206f37744d398d99a676e33af856e($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_8514f0d42cab120136074d8703297298 = is_array($this->functionData['socialSharePostStrip']) ? count($this->functionData['socialSharePostStrip']) : 0;
$this->functionData['socialSharePostStrip'][$count_8514f0d42cab120136074d8703297298]['id'] = $id;
}
...
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("facebook", "0" ) . "" . (($this->settings['sm_autoshare'] && IPSMember::canSocialShare()) ? ("<div class='ipsBox_container ipsMargin_top ipsPad_top'>
	<ul class='ipsPad ipsForm_vertical ipsList_inline ipsType_small clearfix'>
		".$this->__f__e2c1bf455c9d2b4ba2b61f2ea268bf51($id)."		" . ((! $id) ? ("
...
function __f__e2c1bf455c9d2b4ba2b61f2ea268bf51($id=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3c2e98c697529758308e10352be54101 = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_3c2e98c697529758308e10352be54101]['tags'] = $tags;
}
$IPBHTML .= "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__377ba813b802803a0cc662a514723e28($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__377ba813b802803a0cc662a514723e28($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5f0a13a76ea725a7d58b5dcad0a6ff17 = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_5f0a13a76ea725a7d58b5dcad0a6ff17]['tag'] = $tag;
$this->functionData['tagEntry'][$count_5f0a13a76ea725a7d58b5dcad0a6ff17]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_5f0a13a76ea725a7d58b5dcad0a6ff17]['app'] = $app;
$this->functionData['tagEntry'][$count_5f0a13a76ea725a7d58b5dcad0a6ff17]['section'] = $section;
}
...
{
$count_1abd445940dc8dd478c1c080e5ece733 = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_1abd445940dc8dd478c1c080e5ece733]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_1abd445940dc8dd478c1c080e5ece733]['app'] = $app;
$this->functionData['tagPrefix'][$count_1abd445940dc8dd478c1c080e5ece733]['section'] = $section;
}
...
{
$count_30b2c6ce2f7f48d67e3c56bb8ff13c3d = is_array($this->functionData['tagTextEntryBox']) ? count($this->functionData['tagTextEntryBox']) : 0;
$this->functionData['tagTextEntryBox'][$count_30b2c6ce2f7f48d67e3c56bb8ff13c3d]['tags'] = $tags;
$this->functionData['tagTextEntryBox'][$count_30b2c6ce2f7f48d67e3c56bb8ff13c3d]['options'] = $options;
$this->functionData['tagTextEntryBox'][$count_30b2c6ce2f7f48d67e3c56bb8ff13c3d]['where'] = $where;
}
