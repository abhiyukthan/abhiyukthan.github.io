...
class skin_donate_4 extends skinMaster{
...
{
$count_b980f7cb4dc720d8b65a1b418de58119 = is_array($this->functionData['donateSetup']) ? count($this->functionData['donateSetup']) : 0;
$this->functionData['donateSetup'][$count_b980f7cb4dc720d8b65a1b418de58119]['donation'] = $donation;
$this->functionData['donateSetup'][$count_b980f7cb4dc720d8b65a1b418de58119]['goals'] = $goals;
$this->functionData['donateSetup'][$count_b980f7cb4dc720d8b65a1b418de58119]['currencies'] = $currencies;
$this->functionData['donateSetup'][$count_b980f7cb4dc720d8b65a1b418de58119]['gateways'] = $gateways;
}
...
<li class='field'>
	...
	".$this->__f__478b0c549cdf50b9b0b00ac59c9d8518($donation,$goals,$currencies,$gateways)."        </select>
</li>
...
<li class='field'>
	...
	".$this->__f__85b6a8a734e22c5cc5dee34292e4c331($donation,$goals,$currencies,$gateways)."        </select>
...
<li class='field'>
	...
	".$this->__f__cb2efefccf5d3c19c8a224903e0802b5($donation,$goals,$currencies,$gateways)."        </select>
...
function __f__478b0c549cdf50b9b0b00ac59c9d8518($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__85b6a8a734e22c5cc5dee34292e4c331($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cb2efefccf5d3c19c8a224903e0802b5($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c3c187621d28e8090e1c07c8c86d8611 = is_array($this->functionData['donateSetupSend']) ? count($this->functionData['donateSetupSend']) : 0;
$this->functionData['donateSetupSend'][$count_c3c187621d28e8090e1c07c8c86d8611]['donation'] = $donation;
$this->functionData['donateSetupSend'][$count_c3c187621d28e8090e1c07c8c86d8611]['gateway'] = $gateway;
}
$IPBHTML .= "<div class='ipsSteps clearfix'>
<ul>		
	<li>
...
{
$count_5f89b742aee0b9f1f68582e0380d08bb = is_array($this->functionData['splashPage']) ? count($this->functionData['splashPage']) : 0;
$this->functionData['splashPage'][$count_5f89b742aee0b9f1f68582e0380d08bb]['goals'] = $goals;
$this->functionData['splashPage'][$count_5f89b742aee0b9f1f68582e0380d08bb]['donations'] = $donations;
}
...
</tr>".$this->__f__993027566fa8399d301da9dbfd7d7046($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
</tr>".$this->__f__e8a7eef9f7921ae08e6a6be24f968898($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
function __f__993027566fa8399d301da9dbfd7d7046($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__e8a7eef9f7921ae08e6a6be24f968898($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1d1b0d341ed9e3500b43dbe6107bb663 = is_array($this->functionData['statsBox']) ? count($this->functionData['statsBox']) : 0;
$this->functionData['statsBox'][$count_1d1b0d341ed9e3500b43dbe6107bb663]['topDonors'] = $topDonors;
$this->functionData['statsBox'][$count_1d1b0d341ed9e3500b43dbe6107bb663]['stats'] = $stats;
$this->functionData['statsBox'][$count_1d1b0d341ed9e3500b43dbe6107bb663]['active'] = $active;
}
...
{
$count_db7641aa413d1b67b78f119f2c73d43f = is_array($this->functionData['topMenu']) ? count($this->functionData['topMenu']) : 0;
}
...
") : ("" . (($this->settings['dt_amounts']) ? ("
    ...
    ".$this->__f__b1f36d9f82c236c0d16b4e95be895158()."    </select>
    ") : ("
...
function __f__b1f36d9f82c236c0d16b4e95be895158()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ab99ff046666f3dd09864223bca42ce7 = is_array($this->functionData['viewAllDonations']) ? count($this->functionData['viewAllDonations']) : 0;
$this->functionData['viewAllDonations'][$count_ab99ff046666f3dd09864223bca42ce7]['donations'] = $donations;
$this->functionData['viewAllDonations'][$count_ab99ff046666f3dd09864223bca42ce7]['pages'] = $pages;
}
...
<th scope='col' >{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__c76c4062125fcb21035da42287f0cb37($donations,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__741afffede70c6a3d7b46cbc850c13d1($donations,$pages)."</select>
...
function __f__c76c4062125fcb21035da42287f0cb37($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
...
function __f__741afffede70c6a3d7b46cbc850c13d1($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0950fcfb2831bde60f1865076db575bd = is_array($this->functionData['viewAllGoals']) ? count($this->functionData['viewAllGoals']) : 0;
$this->functionData['viewAllGoals'][$count_0950fcfb2831bde60f1865076db575bd]['goals'] = $goals;
$this->functionData['viewAllGoals'][$count_0950fcfb2831bde60f1865076db575bd]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col' class='col_c_stats stats'>{$this->lang->words['status']}</th>
<th scope='col' class='col_c_stats stats'>{$this->lang->words['stats']}</th>
</tr>".$this->__f__a6f445a39a3b087f5df59faa43a2f71d($goals,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__3039f456665133c738fdcafee22a5585($goals,$pages)."</select>
...
function __f__a6f445a39a3b087f5df59faa43a2f71d($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__3039f456665133c738fdcafee22a5585($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode(",", "5,10,25,50" ) as $value )
...
{
$count_b2b4b3048458047757955fe303547663 = is_array($this->functionData['viewAllTopDonors']) ? count($this->functionData['viewAllTopDonors']) : 0;
$this->functionData['viewAllTopDonors'][$count_b2b4b3048458047757955fe303547663]['donors'] = $donors;
$this->functionData['viewAllTopDonors'][$count_b2b4b3048458047757955fe303547663]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
</tr>".$this->__f__76aec76ad15df7ad3d098094fb0ba336($donors,$pages)."</tr>
</table>
</div>
</div>
</div>
...
function __f__76aec76ad15df7ad3d098094fb0ba336($donors=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donors as $r )
...
{
$count_7a1e0e1b9205ac5de54d62220712a885 = is_array($this->functionData['viewGoal']) ? count($this->functionData['viewGoal']) : 0;
$this->functionData['viewGoal'][$count_7a1e0e1b9205ac5de54d62220712a885]['goal'] = $goal;
$this->functionData['viewGoal'][$count_7a1e0e1b9205ac5de54d62220712a885]['donations'] = $donations;
$this->functionData['viewGoal'][$count_7a1e0e1b9205ac5de54d62220712a885]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col'>{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__4b9b5febce1c9b4b04d7037df6004f4f($goal,$donations,$pages)."</tr>
</table>
</div>
</div>
...
function __f__4b9b5febce1c9b4b04d7037df6004f4f($goal=array(), $donations=array(), $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
