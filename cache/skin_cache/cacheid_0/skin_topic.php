...
class skin_topic_0 extends skinMaster{
...
{
$count_80d7373a8bbcdf1dc39b719c3ecdc5a4 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_80d7373a8bbcdf1dc39b719c3ecdc5a4]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_80d7373a8bbcdf1dc39b719c3ecdc5a4]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_80d7373a8bbcdf1dc39b719c3ecdc5a4]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_80d7373a8bbcdf1dc39b719c3ecdc5a4]['sharelinks'] = $sharelinks;
}
...
{
$count_369b62bbe49a3351edfdf7bea536ff50 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_369b62bbe49a3351edfdf7bea536ff50]['announce'] = $announce;
$this->functionData['announcement_show'][$count_369b62bbe49a3351edfdf7bea536ff50]['author'] = $author;
}
...
{
$count_eec9b5abe785c81534c31d3601fe058f = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_eec9b5abe785c81534c31d3601fe058f]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_eec9b5abe785c81534c31d3601fe058f]['forum'] = $forum;
}
...
" . ((is_array( $mem ) && count( $mem )) ? ("".$this->__f__03d1ebc771d781ccb5cc502c07ece725($mem,$count)."") : ("")) . "
</if><br />";
return $IPBHTML;
}


function __f__03d1ebc771d781ccb5cc502c07ece725($mem, $count)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mem as $p => $r )
...
{
$count_29960a2987825f5569c4a116aa5e27fb = is_array($this->functionData['hook_who_read_topic_new']) ? count($this->functionData['hook_who_read_topic_new']) : 0;
$this->functionData['hook_who_read_topic_new'][$count_29960a2987825f5569c4a116aa5e27fb]['mem'] = $mem;
$this->functionData['hook_who_read_topic_new'][$count_29960a2987825f5569c4a116aa5e27fb]['count'] = $count;
}
$IPBHTML .= "<div>
...
<div class='general_box clearfix'>
	...
	<ul class='ipsList_withminiphoto'>
		...
		".$this->__f__18c86e9bc48393280e9f37b55a955be0($mem,$count)."</ul>
...
function __f__18c86e9bc48393280e9f37b55a955be0($mem,$count)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mem as $tts )
...
{
$count_e3c498f2702570c61f65a1945c92fd15 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_4345aa91d636c5ff7e08d526857ddc08 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_4345aa91d636c5ff7e08d526857ddc08]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_4345aa91d636c5ff7e08d526857ddc08]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_4345aa91d636c5ff7e08d526857ddc08]['opts'] = $opts;
}
...
{
$count_377a4a6409bc4df09a9f8cb31dd673e7 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_377a4a6409bc4df09a9f8cb31dd673e7]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_377a4a6409bc4df09a9f8cb31dd673e7]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_377a4a6409bc4df09a9f8cb31dd673e7]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_377a4a6409bc4df09a9f8cb31dd673e7]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_377a4a6409bc4df09a9f8cb31dd673e7]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_377a4a6409bc4df09a9f8cb31dd673e7]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__ef33a6f4c0c0a887e178e886e47cb292($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__349d351d467ae9417a833bf2fc7be017($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fa24d598ea90365a580e2a02426416cb($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__349d351d467ae9417a833bf2fc7be017($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__ef33a6f4c0c0a887e178e886e47cb292($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__fa24d598ea90365a580e2a02426416cb($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_bb4e2d12e3816452534a87590f0d38da = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_bb4e2d12e3816452534a87590f0d38da]['post'] = $post;
$this->functionData['post'][$count_bb4e2d12e3816452534a87590f0d38da]['displayData'] = $displayData;
$this->functionData['post'][$count_bb4e2d12e3816452534a87590f0d38da]['topic'] = $topic;
$this->functionData['post'][$count_bb4e2d12e3816452534a87590f0d38da]['forum'] = $forum;
}
...
{
$count_0e9001c850114b7c0fab74830a44b658 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_0e9001c850114b7c0fab74830a44b658]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_1f3b20eac3be783760469e0d4dac46f2 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_1f3b20eac3be783760469e0d4dac46f2]['title'] = $title;
$this->functionData['show_attachment_title'][$count_1f3b20eac3be783760469e0d4dac46f2]['data'] = $data;
$this->functionData['show_attachment_title'][$count_1f3b20eac3be783760469e0d4dac46f2]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__a5fed3efea8a3a3f7b68ffbc2287842f($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__a5fed3efea8a3a3f7b68ffbc2287842f($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d6c899c5193a820bc0b51aa19d125e78 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_d6c899c5193a820bc0b51aa19d125e78]['data'] = $data;
}
...
{
$count_83f8212b7576b1c96d09eb87aad7c3f5 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_83f8212b7576b1c96d09eb87aad7c3f5]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_83f8212b7576b1c96d09eb87aad7c3f5]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_83f8212b7576b1c96d09eb87aad7c3f5]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__6b6a6697f8648bea147ce946ae80e8de($topic,$posts)."<br class='clear' />
...
function __f__6b6a6697f8648bea147ce946ae80e8de($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_268f54802c96acc13dac9df9225f9dba = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_268f54802c96acc13dac9df9225f9dba]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_268f54802c96acc13dac9df9225f9dba]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_268f54802c96acc13dac9df9225f9dba]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_268f54802c96acc13dac9df9225f9dba]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__21f21e57836a54dd916b973d1cc6f317($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__c3919bcf1dc3b6fc2cee43947bd9054b($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
	document.observe(\"dom:loaded\", function()
	{
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__649b984021987da36bd40962766f2887($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__25bc4792fe4feff027236537db0bf919($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__65073d4833cbaced816e177a6a2c4ba6($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__21f21e57836a54dd916b973d1cc6f317($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c3919bcf1dc3b6fc2cee43947bd9054b($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__649b984021987da36bd40962766f2887($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__25bc4792fe4feff027236537db0bf919($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__65073d4833cbaced816e177a6a2c4ba6($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
