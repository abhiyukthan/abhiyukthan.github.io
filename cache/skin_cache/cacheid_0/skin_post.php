...
class skin_post_0 extends skinMaster{
...
{
$count_c21db4d16cf79babd75a8003caa47ee3 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_c21db4d16cf79babd75a8003caa47ee3]['data'] = $data;
}
...
{
$count_2ad20d2db38a2e0dd60f3b72b666b68f = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_2ad20d2db38a2e0dd60f3b72b666b68f]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_2ad20d2db38a2e0dd60f3b72b666b68f]['form'] = $form;
}
...
{
$count_c66760a87cf8c3bc1f179dd1ee638355 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_c66760a87cf8c3bc1f179dd1ee638355]['data'] = $data;
}
...
{
$count_35188899b65fa39990cb8c4fa72da0b5 = is_array($this->functionData['tbHiddenContent']) ? count($this->functionData['tbHiddenContent']) : 0;
}
...
{
$count_2a834d2441d449641f0710af6363f5d1 = is_array($this->functionData['tbUnhiddenContent']) ? count($this->functionData['tbUnhiddenContent']) : 0;
$this->functionData['tbUnhiddenContent'][$count_2a834d2441d449641f0710af6363f5d1]['content'] = $content;
}
...
{
$count_ecc3b057abcea54b3d0eb1fa7c09ef02 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_ecc3b057abcea54b3d0eb1fa7c09ef02]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__082724973c0ee52a27267bb4cf9c9d03($posts)."") : ("")) . "
<p class='submit'>
...
function __f__082724973c0ee52a27267bb4cf9c9d03($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_16c1e51f701f0801d581c273a1854836 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_16c1e51f701f0801d581c273a1854836]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_16c1e51f701f0801d581c273a1854836]['type'] = $type;
$this->functionData['uploadForm'][$count_16c1e51f701f0801d581c273a1854836]['stats'] = $stats;
$this->functionData['uploadForm'][$count_16c1e51f701f0801d581c273a1854836]['id'] = $id;
$this->functionData['uploadForm'][$count_16c1e51f701f0801d581c273a1854836]['forum_id'] = $forum_id;
}
