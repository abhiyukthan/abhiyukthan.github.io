...
class skin_profile_0 extends skinMaster{
...
{
$count_97cd25b1792cbbfc3a89262829668989 = is_array($this->functionData['acknowledgeWarning']) ? count($this->functionData['acknowledgeWarning']) : 0;
$this->functionData['acknowledgeWarning'][$count_97cd25b1792cbbfc3a89262829668989]['warning'] = $warning;
}
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container ipsPad'>
			...
			") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
					...
					")) . "") : ("")) . "
				".$this->__f__bf6a528a196c5394a27a9e60a4fadc86($warning)."")) . "
		</div>
	</div>
...
function __f__bf6a528a196c5394a27a9e60a4fadc86($warning)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_de7adceca3a6ea1f63f10d054d10c0aa = is_array($this->functionData['addWarning']) ? count($this->functionData['addWarning']) : 0;
$this->functionData['addWarning'][$count_de7adceca3a6ea1f63f10d054d10c0aa]['member'] = $member;
$this->functionData['addWarning'][$count_de7adceca3a6ea1f63f10d054d10c0aa]['reasons'] = $reasons;
$this->functionData['addWarning'][$count_de7adceca3a6ea1f63f10d054d10c0aa]['errors'] = $errors;
$this->functionData['addWarning'][$count_de7adceca3a6ea1f63f10d054d10c0aa]['editor'] = $editor;
$this->functionData['addWarning'][$count_de7adceca3a6ea1f63f10d054d10c0aa]['currentPunishments'] = $currentPunishments;
}
			...
			<ul class='ipsForm ipsForm_vertical'>
				<li class='ipsField ipsField_select'>
					...
					<div class='ipsField_content'>
						<select name='reason' id='reason-select'>
							...
							".$this->__f__3c01b1264c8b366b1533963ce261abe6($member,$reasons,$errors,$editor,$currentPunishments)."							" . (($this->settings['warnings_enable_other'] or $this->memberData['g_access_cp']) ? ("
				...
				<li class='ipsField' style='display:none' id='suspend_li'>
					...
					<div class='ipsField_content'>
						...
						".$this->__f__c029e52db61ddb4f56b6b8ddf5d90390($member,$reasons,$errors,$editor,$currentPunishments)."						</select>
					</div>
				</li>
...
function __f__3c01b1264c8b366b1533963ce261abe6($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c029e52db61ddb4f56b6b8ddf5d90390($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_288ec03d6ea647113bfc1b28482674fc = is_array($this->functionData['customField__gender']) ? count($this->functionData['customField__gender']) : 0;
$this->functionData['customField__gender'][$count_288ec03d6ea647113bfc1b28482674fc]['f'] = $f;
}
...
{
$count_5ef16f3fe9e28bf9b8f1b1a39a93ae17 = is_array($this->functionData['customField__generic']) ? count($this->functionData['customField__generic']) : 0;
$this->functionData['customField__generic'][$count_5ef16f3fe9e28bf9b8f1b1a39a93ae17]['f'] = $f;
}
...
{
$count_bef833227771ab93bc622c3841d88a59 = is_array($this->functionData['customFieldGroup__contact']) ? count($this->functionData['customFieldGroup__contact']) : 0;
$this->functionData['customFieldGroup__contact'][$count_bef833227771ab93bc622c3841d88a59]['f'] = $f;
}
$IPBHTML .= "" . (($f->parsed) ? ("<li>
	...
	<span class='row_data'>
		...
		" . ((is_array( $f->parsed )) ? ("
			".$this->__f__d86f8f437141d80361dca6413d85c74b($f)."		") : ("" . (($f->raw_data['pf_key'] == 'aim') ? ("
...
function __f__d86f8f437141d80361dca6413d85c74b($f)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8f35af9dbf968be9b641cee8030bfa35 = is_array($this->functionData['customizeProfile']) ? count($this->functionData['customizeProfile']) : 0;
$this->functionData['customizeProfile'][$count_8f35af9dbf968be9b641cee8030bfa35]['member'] = $member;
}
...
{
$count_ca43fd96c8fa09676d8ba7bf9c6b38a1 = is_array($this->functionData['dnameWrapper']) ? count($this->functionData['dnameWrapper']) : 0;
$this->functionData['dnameWrapper'][$count_ca43fd96c8fa09676d8ba7bf9c6b38a1]['member_name'] = $member_name;
$this->functionData['dnameWrapper'][$count_ca43fd96c8fa09676d8ba7bf9c6b38a1]['records'] = $records;
}
...
<table class='ipb_table'>
	...
	" . ((is_array($records) AND count($records)) ? ("
		    	".$this->__f__e05a4b387481aa8805d70ac2108725c1($member_name,$records)."	") : ("
		<tr>
...
function __f__e05a4b387481aa8805d70ac2108725c1($member_name="",$records=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cf22863ca33974e1b7cc9a719caeb91a = is_array($this->functionData['explainPoints']) ? count($this->functionData['explainPoints']) : 0;
$this->functionData['explainPoints'][$count_cf22863ca33974e1b7cc9a719caeb91a]['reasons'] = $reasons;
$this->functionData['explainPoints'][$count_cf22863ca33974e1b7cc9a719caeb91a]['actions'] = $actions;
}
...
<table class='ipb_table'>
	...
	".$this->__f__2f4177a08f669ae6693569f25caaac83($reasons,$actions)."</table>
" . ((!empty( $actions )) ? ("
	<div class='ipsPad'>
	...
	<table class='ipb_table'>
		...
		".$this->__f__abb0c50f455850a9bb0246c743d22b04($reasons,$actions)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__2f4177a08f669ae6693569f25caaac83($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reasons as $r )
...
function __f__1cdc1cbd09da43454f10941756103552($reasons, $actions,$a='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array( 'mq', 'rpa', 'suspend' ) as $k )
...
function __f__abb0c50f455850a9bb0246c743d22b04($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $actions as $a )
	{
		...
		$_ips___x_retval .= "
			<tr>
				<td>{$a['wa_points']}</td>
				<td>
					".$this->__f__1cdc1cbd09da43454f10941756103552($reasons,$actions,$a)."				</td>
			</tr>
...
{
$count_458bcb3da142c752e857f5ff643bb797 = is_array($this->functionData['friendsList']) ? count($this->functionData['friendsList']) : 0;
$this->functionData['friendsList'][$count_458bcb3da142c752e857f5ff643bb797]['friends'] = $friends;
$this->functionData['friendsList'][$count_458bcb3da142c752e857f5ff643bb797]['pages'] = $pages;
}
...
" . ((is_array($friends) and count($friends) && $this->settings['friends_enabled']) ? ("
		...
		".$this->__f__a48f98312e9ee5588fa5f90bd3c2f2af($friends,$pages)."	</ul>
") : ("<p class='no_messages'>
		" . (($this->request['tab'] == 'pending') ? ("
...
function __f__a48f98312e9ee5588fa5f90bd3c2f2af($friends, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4d9aae8164b2a843dc308a71f6deada1 = is_array($this->functionData['listWarnings']) ? count($this->functionData['listWarnings']) : 0;
$this->functionData['listWarnings'][$count_4d9aae8164b2a843dc308a71f6deada1]['member'] = $member;
$this->functionData['listWarnings'][$count_4d9aae8164b2a843dc308a71f6deada1]['warnings'] = $warnings;
$this->functionData['listWarnings'][$count_4d9aae8164b2a843dc308a71f6deada1]['pagination'] = $pagination;
$this->functionData['listWarnings'][$count_4d9aae8164b2a843dc308a71f6deada1]['reasons'] = $reasons;
$this->functionData['listWarnings'][$count_4d9aae8164b2a843dc308a71f6deada1]['canWarn'] = $canWarn;
}
	...
	<div class='ipsBox'>
		<div class='ipsBox_container'>
			<table class='ipb_table'>
				...
				<tbody>
					".$this->__f__daa8754e892f7874a41841ff4dd906ae($member,$warnings,$pagination,$reasons,$canWarn)."				</tbody>
			</table>
		</div>
	</div>
")) . "
...
function __f__daa8754e892f7874a41841ff4dd906ae($member, $warnings, $pagination, $reasons, $canWarn)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
/* -- ocb_button --*/
function ocb_button($member) {
$IPBHTML = "";
$IPBHTML .= "" . (($member['member_banned']) ? ("
<ul class='topic_buttons'>
	       <li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=moderate&amp;section=ocbm&amp;do=ocubm&amp;member_id=" . intval($this->request['showuser']) . "&amp;auth_key={$this->member->form_hash}", "public",'' ), "", "" ) . "' base='publicWithApp' class='ipbmenu' title='{$this->lang->words['ocb_unban']}'>" . $this->registry->getClass('output')->getReplacement("user_icon") . " {$this->lang->words['ocb_unban']}</a></li>
</ul>
") : ("
<ul class='topic_buttons'>
	       <li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=moderate&amp;section=ocbm&amp;do=ocbm&amp;member_id=" . intval($this->request['showuser']) . "&amp;auth_key={$this->member->form_hash}", "public",'' ), "", "" ) . "' base='publicWithApp' class='ipbmenu' title='{$this->lang->words['ocb_ban']}'>" . $this->registry->getClass('output')->getReplacement("user_icon") . " {$this->lang->words['ocb_ban']}</a></li>
</ul>
")) . "";
return $IPBHTML;
}
...
{
$count_7646a48ce0c30f2c74f8451604342a60 = is_array($this->functionData['photoEditor']) ? count($this->functionData['photoEditor']) : 0;
$this->functionData['photoEditor'][$count_7646a48ce0c30f2c74f8451604342a60]['data'] = $data;
$this->functionData['photoEditor'][$count_7646a48ce0c30f2c74f8451604342a60]['member'] = $member;
}
...
{
$count_ae84f53fcf6af5eda26a0978d0319cc9 = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['member'] = $member;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['friends'] = $friends;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['status'] = $status;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['warns'] = $warns;
$this->functionData['profileModern'][$count_ae84f53fcf6af5eda26a0978d0319cc9]['show_contact'] = $show_contact;
}
...
" . ((($this->memberData['member_id'] && $member['member_id'] == $this->memberData['member_id']) || $this->memberData['g_is_supmod'] == 1 || ($this->memberData['member_id'] && $member['member_id'] != $this->memberData['member_id'])) ? ("<ul class='topic_buttons'>
		...
		") : ("")) . "
		<!--hook.if.skin_profile.profileModern.weAreOwner.pre.startif-->" . (($this->memberData['member_id'] && $member['member_id'] == $this->memberData['member_id']) ? ("
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='profile_tabs'>
			...
			<ul class='clear'>
				...
				".$this->__f__172ce445e71f7473c3e9e27143401f11($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."			</ul>
		</div>
			...
			<div class='ipsPad'>
				<div id='profile_content_main'>
					<div id='user_info_cell'>
						...
						" . ((!empty( $warns )) ? ("
							".$this->__f__b65a8f7c3394abd3385a4fa1dd21122f($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."						") : ("")) . "
					...
					<ul class='ipsList_inline' id='user_utility_links'>
						<!--hook.if.skin_profile.profileModern.noFriendYourself.pre.startif-->" . (($this->memberData['member_id'] AND $this->memberData['member_id'] != $member['member_id'] && $this->settings['friends_enabled'] AND $this->memberData['g_can_add_friends']) ? ("<li id='friend_toggle' class='ipsButton_secondary'>
				...
				<div id='profile_panes_wrap' class='clearfix'>
					...
					<div id='pane_core:info' class='ipsLayout ipsLayout_withright ipsLayout_largeright clearfix' " . (($default_tab != 'core:info') ? ("style='display: none'") : ("")) . ">
							...
							<div class='general_box clearfix'>
								...
								<ul class='ipsList_data clearfix'>
									...
									" . (($member['custom_fields']['profile_info'] != "") ? ("
										".$this->__f__a8e54b6fe4385d0a752bc9200c6598a0($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."									") : ("")) . "
								</ul>
								<br />
							</div>
							
							" . (($member['custom_fields']) ? ("
								".$this->__f__661681879fc839b8af1657bcd93d8c38($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."							") : ("")) . "
								...
								") : ("")) . "
									<ul class='ipsList_data clearfix'>
										...
										" . ((is_array( $member['custom_fields']['contact'])) ? ("
											".$this->__f__8ab56bd8c25aff2d7ee4ffd14b56a9fb($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										") : ("")) . "
									</ul>
								</div>") : ("")) . "
						</div>
						...
						<div class='ipsLayout_right'>
							...
							<!--hook.if.skin_profile.profileModern.checkModTools.pre.startif-->" . ((($member['spamStatus'] !== NULL && $member['member_id'] != $this->memberData['member_id']) || ($this->memberData['g_mem_info'] && $this->settings['auth_allow_dnames']) || (($member['member_id'] != $this->memberData['member_id'] AND $this->memberData['g_is_supmod'] ) AND $member['customization']['type'])) ? ("<div class='general_box clearfix'>
							...
							" . (($member['pp_setting_count_friends'] and $this->settings['friends_enabled']) ? ("<div class='general_box clearfix' id='friends_overview'>
									...
									<div class='ipsPad'>
										" . ((count($friends) AND is_array($friends)) ? ("
											".$this->__f__c2eca40e580280a8bd99831e8b68f1e1($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										") : ("
											<p class='desc'>
							...
							" . (($member['pp_setting_count_visitors']) ? ("<div class='general_box clearfix'>
									...
									" . ((is_array( $visitors ) && count( $visitors )) ? ("
										<ul class='ipsList_withminiphoto ipsPad'>
											".$this->__f__4cb6ec7e5379aa915c5b463e4a0d0759($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										</ul>
									") : ("
...
function __f__172ce445e71f7473c3e9e27143401f11($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
...
function __f__b65a8f7c3394abd3385a4fa1dd21122f($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a8e54b6fe4385d0a752bc9200c6598a0($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fd3c9d53d3fc9ab92b15fbdbf0d5f179($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='',$group='',$mdata='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__661681879fc839b8af1657bcd93d8c38($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
									" . (($group != 'profile_info' AND $group != 'contact') ? ("" . ((is_array( $member['custom_fields'][ $group ] ) AND count( $member['custom_fields'][ $group ] )) ? ("
											<div class='general_box clearfix' id='custom_fields_{$group}'>
												...
												<br />
												<ul class='ipsList_data clearfix'>
													".$this->__f__fd3c9d53d3fc9ab92b15fbdbf0d5f179($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact,$group,$mdata)."												</ul>
												<br />
											</div>
										") : ("")) . "") : ("")) . "
...
function __f__8ab56bd8c25aff2d7ee4ffd14b56a9fb($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c2eca40e580280a8bd99831e8b68f1e1($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
function __f__4cb6ec7e5379aa915c5b463e4a0d0759($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fa271d10cc77e2a8e77a31690e6a0093 = is_array($this->functionData['reputationPage']) ? count($this->functionData['reputationPage']) : 0;
$this->functionData['reputationPage'][$count_fa271d10cc77e2a8e77a31690e6a0093]['langBit'] = $langBit;
$this->functionData['reputationPage'][$count_fa271d10cc77e2a8e77a31690e6a0093]['currentApp'] = $currentApp;
$this->functionData['reputationPage'][$count_fa271d10cc77e2a8e77a31690e6a0093]['supportedApps'] = $supportedApps;
$this->functionData['reputationPage'][$count_fa271d10cc77e2a8e77a31690e6a0093]['processedResults'] = $processedResults;
}
	...
	" . ((count( $supportedApps ) > 1) ? ("
		<div class='maintitle ipsFilterbar clearfix'>
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__20ea3518732b456bc1549c0a51b58045($langBit,$currentApp,$supportedApps,$processedResults)."			</ul>
		</div>
	") : ("")) . "
	" . (($processedResults) ? ("
		{$processedResults}
...
function __f__20ea3518732b456bc1549c0a51b58045($langBit, $currentApp='', $supportedApps=array(), $processedResults='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_69b5a8abaf2699c1dd4c7d24f84adaa9 = is_array($this->functionData['showCard']) ? count($this->functionData['showCard']) : 0;
$this->functionData['showCard'][$count_69b5a8abaf2699c1dd4c7d24f84adaa9]['member'] = $member;
$this->functionData['showCard'][$count_69b5a8abaf2699c1dd4c7d24f84adaa9]['download'] = $download;
}
...
{
$count_00987b6b00f36b742cc60a643f369102 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_00987b6b00f36b742cc60a643f369102]['replies'] = $replies;
$this->functionData['statusReplies'][$count_00987b6b00f36b742cc60a643f369102]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "" . ((!$no_wrapper) ? ("
	<ul class='ipsList_withtinyphoto clear'>
") : ("")) . "".$this->__f__ac900b107acf516e9db671a56e99184d($replies,$no_wrapper)."" . ((!$no_wrapper) ? ("
	</ul>
") : ("")) . "";
return $IPBHTML;
}
...
function __f__ac900b107acf516e9db671a56e99184d($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1c5a6512d7f7f665380c0120d3457c1a = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_1c5a6512d7f7f665380c0120d3457c1a]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_1c5a6512d7f7f665380c0120d3457c1a]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_1c5a6512d7f7f665380c0120d3457c1a]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "".$this->__f__cb12b561cafb94e09f83f86adaf06d28($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__cb12b561cafb94e09f83f86adaf06d28($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_185907c0b85d35d5f7d0e800893e4ee5 = is_array($this->functionData['statusUpdatesPage']) ? count($this->functionData['statusUpdatesPage']) : 0;
$this->functionData['statusUpdatesPage'][$count_185907c0b85d35d5f7d0e800893e4ee5]['updates'] = $updates;
$this->functionData['statusUpdatesPage'][$count_185907c0b85d35d5f7d0e800893e4ee5]['pages'] = $pages;
}
...
{
$count_e961d8ef29cca308979632db72c93755 = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_e961d8ef29cca308979632db72c93755]['friends'] = $friends;
$this->functionData['tabFriends'][$count_e961d8ef29cca308979632db72c93755]['member'] = $member;
$this->functionData['tabFriends'][$count_e961d8ef29cca308979632db72c93755]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	" . (($this->settings['friends_enabled'] AND $this->memberData['g_can_add_friends'] AND $member['pp_setting_count_friends']) ? ("<div class='friend_list clear' id='friend_list'>
			...
			" . ((is_array($friends) and count($friends)) ? ("
				<ul class='clearfix'>
				".$this->__f__f07805ad4dc111f4c9f9ad47f25aeae4($friends,$member,$pagination)."				</ul>
			") : ("
				<p>
...
function __f__f07805ad4dc111f4c9f9ad47f25aeae4($friends=array(), $member=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
{
$count_e4ba6e3420f25940f5c88e120bff7a4d = is_array($this->functionData['tabReputation']) ? count($this->functionData['tabReputation']) : 0;
$this->functionData['tabReputation'][$count_e4ba6e3420f25940f5c88e120bff7a4d]['member'] = $member;
$this->functionData['tabReputation'][$count_e4ba6e3420f25940f5c88e120bff7a4d]['currentApp'] = $currentApp;
$this->functionData['tabReputation'][$count_e4ba6e3420f25940f5c88e120bff7a4d]['type'] = $type;
$this->functionData['tabReputation'][$count_e4ba6e3420f25940f5c88e120bff7a4d]['supportedApps'] = $supportedApps;
$this->functionData['tabReputation'][$count_e4ba6e3420f25940f5c88e120bff7a4d]['processedResults'] = $processedResults;
$this->functionData['tabReputation'][$count_e4ba6e3420f25940f5c88e120bff7a4d]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	<div class='maintitle ipsFilterbar clearfix'>
		" . ((count( $supportedApps ) > 1) ? ("
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__14e75211f4fdef80cb15293a0b79d7af($member,$currentApp,$type,$supportedApps,$processedResults,$pagination)."			</ul>
		") : ("")) . "
...
function __f__14e75211f4fdef80cb15293a0b79d7af($member, $currentApp='', $type='', $supportedApps=array(), $processedResults='', $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $supportedApps as $_app )
...
{
$count_a3f84d87da15cb4121fab096847724d7 = is_array($this->functionData['tabReputation_calendar']) ? count($this->functionData['tabReputation_calendar']) : 0;
$this->functionData['tabReputation_calendar'][$count_a3f84d87da15cb4121fab096847724d7]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__b6a86c572f8b51213a52d1684faddfb6($results)."</div>";
return $IPBHTML;
}


function __f__b6a86c572f8b51213a52d1684faddfb6($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_33ebd862dfeda33f344a63918a3ae209 = is_array($this->functionData['tabReputation_posts']) ? count($this->functionData['tabReputation_posts']) : 0;
$this->functionData['tabReputation_posts'][$count_33ebd862dfeda33f344a63918a3ae209]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__ac4d3456321f00c2b407f8097a759fd4($results)."</div>";
return $IPBHTML;
}


function __f__ed9d01108c6cfbb76ab85d367b1dd7d6($results,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ac4d3456321f00c2b407f8097a759fd4($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $data )
			...
			<div class='post_wrap'>
				...
				<div class='post_body'>
					<p class='posted_info desc lighter ipsType_small'>
						...
						" . (($data['_forum_trail']) ? ("
							in
							".$this->__f__ed9d01108c6cfbb76ab85d367b1dd7d6($results,$data)."						") : ("")) . "
					</p>
					<div class='post entry-content clearfix'>
						{$data['post']}
						<br />
...
{
$count_5093ba959b7724c5d8c223d63c55d201 = is_array($this->functionData['tabSingleColumn']) ? count($this->functionData['tabSingleColumn']) : 0;
$this->functionData['tabSingleColumn'][$count_5093ba959b7724c5d8c223d63c55d201]['row'] = $row;
$this->functionData['tabSingleColumn'][$count_5093ba959b7724c5d8c223d63c55d201]['read_more_link'] = $read_more_link;
$this->functionData['tabSingleColumn'][$count_5093ba959b7724c5d8c223d63c55d201]['url'] = $url;
$this->functionData['tabSingleColumn'][$count_5093ba959b7724c5d8c223d63c55d201]['title'] = $title;
}
...
{
$count_2bb7dba1b7603ecb703a50d5661163ac = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_2bb7dba1b7603ecb703a50d5661163ac]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_2bb7dba1b7603ecb703a50d5661163ac]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_2bb7dba1b7603ecb703a50d5661163ac]['member'] = $member;
}
