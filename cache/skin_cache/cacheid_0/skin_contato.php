...
class skin_contato_0 extends skinMaster{
...
{
$count_aa80e772c0b0166247a05fcf71f1f6c0 = is_array($this->functionData['fields']) ? count($this->functionData['fields']) : 0;
$this->functionData['fields'][$count_aa80e772c0b0166247a05fcf71f1f6c0]['dep'] = $dep;
$this->functionData['fields'][$count_aa80e772c0b0166247a05fcf71f1f6c0]['regra'] = $regra;
$this->functionData['fields'][$count_aa80e772c0b0166247a05fcf71f1f6c0]['pergunta'] = $pergunta;
$this->functionData['fields'][$count_aa80e772c0b0166247a05fcf71f1f6c0]['customfields'] = $customfields;
$this->functionData['fields'][$count_aa80e772c0b0166247a05fcf71f1f6c0]['captchaHTML'] = $captchaHTML;
$this->functionData['fields'][$count_aa80e772c0b0166247a05fcf71f1f6c0]['firstid'] = $firstid;
}
...
<ul class=\"ipsPad\">
				...
				" . ((is_array($customfields) and count($customfields)) ? ("".$this->__f__2066f12155b10be2830c620e2da0a05d($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."				") : ("")) . "" . (($pergunta[question] != '') ? ("
					<li class='ipsField'>
...
function __f__2066f12155b10be2830c620e2da0a05d($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_73aa40f37ebfa99940509307c7efc76e = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_73aa40f37ebfa99940509307c7efc76e]['dep'] = $dep;
$this->functionData['form'][$count_73aa40f37ebfa99940509307c7efc76e]['regra'] = $regra;
$this->functionData['form'][$count_73aa40f37ebfa99940509307c7efc76e]['pergunta'] = $pergunta;
$this->functionData['form'][$count_73aa40f37ebfa99940509307c7efc76e]['customfields'] = $customfields;
$this->functionData['form'][$count_73aa40f37ebfa99940509307c7efc76e]['captchaHTML'] = $captchaHTML;
$this->functionData['form'][$count_73aa40f37ebfa99940509307c7efc76e]['firstid'] = $firstid;
}
$IPBHTML .= "{$regra}
...
<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>		
			...
			<ul>
				".$this->__f__8f0c3cf08501b08964b7f94d98204707($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."						
			</ul>
		</div>
...
function __f__8f0c3cf08501b08964b7f94d98204707($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $dep as $r )
