...
class skin_stats_0 extends skinMaster{
...
{
$count_a33aac50455c6f479f0531a8318f2660 = is_array($this->functionData['group_strip']) ? count($this->functionData['group_strip']) : 0;
$this->functionData['group_strip'][$count_a33aac50455c6f479f0531a8318f2660]['group'] = $group;
$this->functionData['group_strip'][$count_a33aac50455c6f479f0531a8318f2660]['members'] = $members;
$this->functionData['group_strip'][$count_a33aac50455c6f479f0531a8318f2660]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__2d8b1a92a6bebcf9c3252dee47fdbecc($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__6d1199a418e824f5cee201c580cd6ff0($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c05c0fd13c85e41b31eadcc4efa0e750($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__2d8b1a92a6bebcf9c3252dee47fdbecc($group="", $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((empty( $info['forums'] )) ? ("
							--
						") : ("" . ((count( $info['forums'] ) == 1) ? ("
								".$this->__f__6d1199a418e824f5cee201c580cd6ff0($group,$members,$pagination,$info)."							") : ("
								...
								".$this->__f__c05c0fd13c85e41b31eadcc4efa0e750($group,$members,$pagination,$info)."								</ul>
...
{
$count_df90021cd878fd84b5261e039cc38f4a = is_array($this->functionData['top_posters']) ? count($this->functionData['top_posters']) : 0;
$this->functionData['top_posters'][$count_df90021cd878fd84b5261e039cc38f4a]['rows'] = $rows;
}
...
<table class='ipb_table ipsMemberList'>
	...
	") : ("
				".$this->__f__13adaa66c47596cb0a3ed030ed59aab8($rows)."	")) . "
</table>";
return $IPBHTML;
}


function __f__13adaa66c47596cb0a3ed030ed59aab8($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7468f4e958a2ccc2bc111edb0a5b52f6 = is_array($this->functionData['whoPosted']) ? count($this->functionData['whoPosted']) : 0;
$this->functionData['whoPosted'][$count_7468f4e958a2ccc2bc111edb0a5b52f6]['tid'] = $tid;
$this->functionData['whoPosted'][$count_7468f4e958a2ccc2bc111edb0a5b52f6]['title'] = $title;
$this->functionData['whoPosted'][$count_7468f4e958a2ccc2bc111edb0a5b52f6]['rows'] = $rows;
}
...
<div class='fixed_inner'>
	<table class='ipb_table'>
		...
		" . ((count($rows) AND is_array($rows)) ? ("
						".$this->__f__d8427fda590bcaee013784b8d9834983($tid,$title,$rows)."		") : ("")) . "
	</table>
</div>";
return $IPBHTML;
}
...
function __f__d8427fda590bcaee013784b8d9834983($tid=0, $title="", $rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
