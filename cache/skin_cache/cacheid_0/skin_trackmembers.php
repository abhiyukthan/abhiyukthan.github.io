...
class skin_trackmembers_0 extends skinMaster{
...
{
$count_f992e5d4a9d636d2fe8e976bfeee7d5e = is_array($this->functionData['showSetupPopup']) ? count($this->functionData['showSetupPopup']) : 0;
$this->functionData['showSetupPopup'][$count_f992e5d4a9d636d2fe8e976bfeee7d5e]['memberData'] = $memberData;
$this->functionData['showSetupPopup'][$count_f992e5d4a9d636d2fe8e976bfeee7d5e]['formElements'] = $formElements;
$this->functionData['showSetupPopup'][$count_f992e5d4a9d636d2fe8e976bfeee7d5e]['formData'] = $formData;
}
...
<div class='fixed_inner ipsBox'>
	...
	") : ("")) . "
		...
		<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=trackmembers&module=ajax&section=setup&mid={$memberData['member_id']}&do=save", "public",'' ), "", "" ) . "\" method='post' id='trackMembersSetupForm'>
			".$this->__f__5d058780856fbb009a34df6460b59296($memberData,$formElements,$formData)."			<fieldset class='submit clear'>
...
function __f__4262d938bf9d8cb10d9ef69fb10dbdd8($memberData, $formElements, $formData,$title='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5d058780856fbb009a34df6460b59296($memberData, $formElements, $formData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $formElements as $title => $data )
	{
		...
		$_ips___x_retval .= "
				<fieldset class=\"row1\">
					...
					<ul class='ipsPad'>
						".$this->__f__4262d938bf9d8cb10d9ef69fb10dbdd8($memberData,$formElements,$formData,$title,$data)."					</ul>
				</fieldset>
...
{
$count_6bef3e1a4de45a911934300fd5ee3c5a = is_array($this->functionData['trackMemberLogs']) ? count($this->functionData['trackMemberLogs']) : 0;
$this->functionData['trackMemberLogs'][$count_6bef3e1a4de45a911934300fd5ee3c5a]['logs'] = $logs;
$this->functionData['trackMemberLogs'][$count_6bef3e1a4de45a911934300fd5ee3c5a]['member'] = $member;
$this->functionData['trackMemberLogs'][$count_6bef3e1a4de45a911934300fd5ee3c5a]['status'] = $status;
$this->functionData['trackMemberLogs'][$count_6bef3e1a4de45a911934300fd5ee3c5a]['pages'] = $pages;
$this->functionData['trackMemberLogs'][$count_6bef3e1a4de45a911934300fd5ee3c5a]['footer_filter'] = $footer_filter;
}
			...
			<div class='ipsPad'>
				<div id='profile_content_main'>
					...
					<div id='user_info_cell' style='padding-left: 10px;'>
						...
						" . ((!empty( $warns )) ? ("
							".$this->__f__990de99373578e7f2a8e36f0de077831($logs,$member,$status,$pages,$footer_filter)."						") : ("")) . "
						" . (($member['_online']) ? ("
			...
			<div class='ipsPad'>
				...
				<table class='ipb_table'>
					...
					" . ((is_array( $logs ) AND count( $logs )) ? ("
												".$this->__f__3aed7830e7cfc16bb47c11104e02c8d9($logs,$member,$status,$pages,$footer_filter)."					") : ("
						<tr>
...
function __f__990de99373578e7f2a8e36f0de077831($logs, $member, $status, $pages, $footer_filter)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3aed7830e7cfc16bb47c11104e02c8d9($logs, $member, $status, $pages, $footer_filter)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
