...
class skin_shoutbox_0 extends skinMaster{
...
{
$count_187db7fb6174ee13cb17749e56e42b85 = is_array($this->functionData['archive']) ? count($this->functionData['archive']) : 0;
$this->functionData['archive'][$count_187db7fb6174ee13cb17749e56e42b85]['d'] = $d;
}
...
$IPBHTML .= "" . ((substr( $action, 0, 4 ) != 'edit') ? ("" . (($action == 'delete') ? ("
	...
	<div class=\"short\">
		...
		<table class=\"ipb_table\">
			...
			".$this->__f__7b5c9643fd389f522c0cfcc404921382($action,$data)."		</table>
		<br />
...
function __f__7b5c9643fd389f522c0cfcc404921382($action='',$data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_289426b5cd8560d28bbc344f208876ed = is_array($this->functionData['popupWrapper']) ? count($this->functionData['popupWrapper']) : 0;
$this->functionData['popupWrapper'][$count_289426b5cd8560d28bbc344f208876ed]['output'] = $output;
}
...
{
$count_43e00fa13a1d6b7de0a4841da9ae9047 = is_array($this->functionData['shout_row']) ? count($this->functionData['shout_row']) : 0;
$this->functionData['shout_row'][$count_43e00fa13a1d6b7de0a4841da9ae9047]['d'] = $d;
$this->functionData['shout_row'][$count_43e00fa13a1d6b7de0a4841da9ae9047]['can_edit'] = $can_edit;
$this->functionData['shout_row'][$count_43e00fa13a1d6b7de0a4841da9ae9047]['ajax'] = $ajax;
}
...
{
$count_40fbf3fedec76804893ba4ff1210eec9 = is_array($this->functionData['shout_row_sidebar']) ? count($this->functionData['shout_row_sidebar']) : 0;
$this->functionData['shout_row_sidebar'][$count_40fbf3fedec76804893ba4ff1210eec9]['d'] = $d;
$this->functionData['shout_row_sidebar'][$count_40fbf3fedec76804893ba4ff1210eec9]['can_edit'] = $can_edit;
$this->functionData['shout_row_sidebar'][$count_40fbf3fedec76804893ba4ff1210eec9]['ajax'] = $ajax;
}
...
{
$count_2233f672f0276bd93eb9db138d552f26 = is_array($this->functionData['shoutbox']) ? count($this->functionData['shoutbox']) : 0;
$this->functionData['shoutbox'][$count_2233f672f0276bd93eb9db138d552f26]['data'] = $data;
$this->functionData['shoutbox'][$count_2233f672f0276bd93eb9db138d552f26]['stats'] = $stats;
}
