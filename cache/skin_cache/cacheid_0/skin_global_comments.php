...
class skin_global_comments_0 extends skinMaster{
...
{
$count_120046d11ddabd65e3144e489a2ab8b8 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_120046d11ddabd65e3144e489a2ab8b8]['r'] = $r;
$this->functionData['comment'][$count_120046d11ddabd65e3144e489a2ab8b8]['parent'] = $parent;
$this->functionData['comment'][$count_120046d11ddabd65e3144e489a2ab8b8]['settings'] = $settings;
}
...
{
$count_048c145b7314b19bd70855006beb4e9a = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_048c145b7314b19bd70855006beb4e9a]['r'] = $r;
$this->functionData['commentHidden'][$count_048c145b7314b19bd70855006beb4e9a]['parent'] = $parent;
$this->functionData['commentHidden'][$count_048c145b7314b19bd70855006beb4e9a]['settings'] = $settings;
}
...
{
$count_1fbf9719904a0c827231d5a197a2749b = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_1fbf9719904a0c827231d5a197a2749b]['comments'] = $comments;
$this->functionData['commentsList'][$count_1fbf9719904a0c827231d5a197a2749b]['settings'] = $settings;
$this->functionData['commentsList'][$count_1fbf9719904a0c827231d5a197a2749b]['pages'] = $pages;
$this->functionData['commentsList'][$count_1fbf9719904a0c827231d5a197a2749b]['parent'] = $parent;
$this->functionData['commentsList'][$count_1fbf9719904a0c827231d5a197a2749b]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__ba8c01cd2463e8616d504e6dae79531d($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__ba8c01cd2463e8616d504e6dae79531d($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f76ec5562ec3f66cd1e502a200c26793 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_f76ec5562ec3f66cd1e502a200c26793]['comment'] = $comment;
$this->functionData['form'][$count_f76ec5562ec3f66cd1e502a200c26793]['parent'] = $parent;
$this->functionData['form'][$count_f76ec5562ec3f66cd1e502a200c26793]['editor'] = $editor;
$this->functionData['form'][$count_f76ec5562ec3f66cd1e502a200c26793]['settings'] = $settings;
$this->functionData['form'][$count_f76ec5562ec3f66cd1e502a200c26793]['errors'] = $errors;
$this->functionData['form'][$count_f76ec5562ec3f66cd1e502a200c26793]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
