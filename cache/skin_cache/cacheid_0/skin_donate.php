...
class skin_donate_0 extends skinMaster{
...
{
$count_470e55e425f08bcbdf2877302258d03d = is_array($this->functionData['donateSetup']) ? count($this->functionData['donateSetup']) : 0;
$this->functionData['donateSetup'][$count_470e55e425f08bcbdf2877302258d03d]['donation'] = $donation;
$this->functionData['donateSetup'][$count_470e55e425f08bcbdf2877302258d03d]['goals'] = $goals;
$this->functionData['donateSetup'][$count_470e55e425f08bcbdf2877302258d03d]['currencies'] = $currencies;
$this->functionData['donateSetup'][$count_470e55e425f08bcbdf2877302258d03d]['gateways'] = $gateways;
}
...
<li class='field'>
	...
	".$this->__f__97af31389bf2e39e727e4821faa6d3e7($donation,$goals,$currencies,$gateways)."        </select>
</li>
...
<li class='field'>
	...
	".$this->__f__09ebc267655e52fa6935b4ad08eb7e73($donation,$goals,$currencies,$gateways)."        </select>
...
<li class='field'>
	...
	".$this->__f__4377b118a420c6d1b2655af847dd414f($donation,$goals,$currencies,$gateways)."        </select>
...
function __f__97af31389bf2e39e727e4821faa6d3e7($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__09ebc267655e52fa6935b4ad08eb7e73($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4377b118a420c6d1b2655af847dd414f($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5b0531ec51bee7ce1fefbc9535d7fc35 = is_array($this->functionData['donateSetupSend']) ? count($this->functionData['donateSetupSend']) : 0;
$this->functionData['donateSetupSend'][$count_5b0531ec51bee7ce1fefbc9535d7fc35]['donation'] = $donation;
$this->functionData['donateSetupSend'][$count_5b0531ec51bee7ce1fefbc9535d7fc35]['gateway'] = $gateway;
}
$IPBHTML .= "<div class='ipsSteps clearfix'>
<ul>		
	<li>
...
{
$count_67c43c3dcb86fb1d45047b81dc787762 = is_array($this->functionData['splashPage']) ? count($this->functionData['splashPage']) : 0;
$this->functionData['splashPage'][$count_67c43c3dcb86fb1d45047b81dc787762]['goals'] = $goals;
$this->functionData['splashPage'][$count_67c43c3dcb86fb1d45047b81dc787762]['donations'] = $donations;
}
...
</tr>".$this->__f__cdf366156ba2910d217950948ec48e6f($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
</tr>".$this->__f__afcaa5891b7f80e49e3789904ca67bc3($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
function __f__cdf366156ba2910d217950948ec48e6f($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__afcaa5891b7f80e49e3789904ca67bc3($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_614ed5ffabb71e7a52ed02aac7d16c78 = is_array($this->functionData['statsBox']) ? count($this->functionData['statsBox']) : 0;
$this->functionData['statsBox'][$count_614ed5ffabb71e7a52ed02aac7d16c78]['topDonors'] = $topDonors;
$this->functionData['statsBox'][$count_614ed5ffabb71e7a52ed02aac7d16c78]['stats'] = $stats;
$this->functionData['statsBox'][$count_614ed5ffabb71e7a52ed02aac7d16c78]['active'] = $active;
}
...
{
$count_05b45934d96149dc54005c3e28e01bf7 = is_array($this->functionData['topMenu']) ? count($this->functionData['topMenu']) : 0;
}
...
") : ("" . (($this->settings['dt_amounts']) ? ("
    ...
    ".$this->__f__6e2e7e7e6b1e63c1b6cff6fc153f72d3()."    </select>
    ") : ("
...
function __f__6e2e7e7e6b1e63c1b6cff6fc153f72d3()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7f067f779c6cc0dfcf8fb28265d9ae2b = is_array($this->functionData['viewAllDonations']) ? count($this->functionData['viewAllDonations']) : 0;
$this->functionData['viewAllDonations'][$count_7f067f779c6cc0dfcf8fb28265d9ae2b]['donations'] = $donations;
$this->functionData['viewAllDonations'][$count_7f067f779c6cc0dfcf8fb28265d9ae2b]['pages'] = $pages;
}
...
<th scope='col' >{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__583a643b5be778bc160b859840a87921($donations,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__b59ad0dac426b018e7f8cdf4ffaa29ad($donations,$pages)."</select>
...
function __f__583a643b5be778bc160b859840a87921($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
...
function __f__b59ad0dac426b018e7f8cdf4ffaa29ad($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0f64a6325838abd004e829cc50cf6df2 = is_array($this->functionData['viewAllGoals']) ? count($this->functionData['viewAllGoals']) : 0;
$this->functionData['viewAllGoals'][$count_0f64a6325838abd004e829cc50cf6df2]['goals'] = $goals;
$this->functionData['viewAllGoals'][$count_0f64a6325838abd004e829cc50cf6df2]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col' class='col_c_stats stats'>{$this->lang->words['status']}</th>
<th scope='col' class='col_c_stats stats'>{$this->lang->words['stats']}</th>
</tr>".$this->__f__15b46747ebf663907c4e1366313a3f03($goals,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__26b8ae2212dcf6e6fef2f97bb2b1bf13($goals,$pages)."</select>
...
function __f__15b46747ebf663907c4e1366313a3f03($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__26b8ae2212dcf6e6fef2f97bb2b1bf13($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode(",", "5,10,25,50" ) as $value )
...
{
$count_9dd1b24e950a06639e4ee8a5534dedc5 = is_array($this->functionData['viewAllTopDonors']) ? count($this->functionData['viewAllTopDonors']) : 0;
$this->functionData['viewAllTopDonors'][$count_9dd1b24e950a06639e4ee8a5534dedc5]['donors'] = $donors;
$this->functionData['viewAllTopDonors'][$count_9dd1b24e950a06639e4ee8a5534dedc5]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
</tr>".$this->__f__cad65fe4e7ca174d5d30df65ae71a97f($donors,$pages)."</tr>
</table>
</div>
</div>
</div>
...
function __f__cad65fe4e7ca174d5d30df65ae71a97f($donors=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donors as $r )
...
{
$count_087bd24ec19b8556a6b016512a546e00 = is_array($this->functionData['viewGoal']) ? count($this->functionData['viewGoal']) : 0;
$this->functionData['viewGoal'][$count_087bd24ec19b8556a6b016512a546e00]['goal'] = $goal;
$this->functionData['viewGoal'][$count_087bd24ec19b8556a6b016512a546e00]['donations'] = $donations;
$this->functionData['viewGoal'][$count_087bd24ec19b8556a6b016512a546e00]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col'>{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__a7ecc7dfb13671d1bc6fb691ead92428($goal,$donations,$pages)."</tr>
</table>
</div>
</div>
...
function __f__a7ecc7dfb13671d1bc6fb691ead92428($goal=array(), $donations=array(), $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
