...
class skin_editors_0 extends skinMaster{
...
{
$count_3437a06174b063913802e46adc9ce094 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_3437a06174b063913802e46adc9ce094]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_3437a06174b063913802e46adc9ce094]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_3437a06174b063913802e46adc9ce094]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_3437a06174b063913802e46adc9ce094]['extraData'] = $extraData;
}
...
{
$count_fd027052d0f8de2d88ae8b28512306c9 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['formField'] = $formField;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['content'] = $content;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['options'] = $options;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_fd027052d0f8de2d88ae8b28512306c9]['showEditor'] = $showEditor;
}
...
{
$count_21c7fda6092410a4d2f013f52a5aed85 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_21c7fda6092410a4d2f013f52a5aed85]['options'] = $options;
$this->functionData['editorLoadJs'][$count_21c7fda6092410a4d2f013f52a5aed85]['inlineLoad'] = $inlineLoad;
}
...
{
$count_9aca276e5c1692a04d8dea01c8802ab6 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_9aca276e5c1692a04d8dea01c8802ab6]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_9aca276e5c1692a04d8dea01c8802ab6]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_9aca276e5c1692a04d8dea01c8802ab6]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_9aca276e5c1692a04d8dea01c8802ab6]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__4e6374e3b7bd508a47c6f9595caf5052($rows,$pages,$app,$plugin)."		") : ("
...
function __f__4e6374e3b7bd508a47c6f9595caf5052($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_4cff8c15c5d1b015599ce879a2bba565 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_4cff8c15c5d1b015599ce879a2bba565]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__8fe86fec2d2d12305d3475fcb2231da1($tabs)."			</ul>
		</div>
...
function __f__8fe86fec2d2d12305d3475fcb2231da1($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
