...
class skin_shoutbox_hooks_1 extends skinMaster{
...
{
$count_31cad711d097e23fffa724e87914614b = is_array($this->functionData['hookActiveUsers']) ? count($this->functionData['hookActiveUsers']) : 0;
$this->functionData['hookActiveUsers'][$count_31cad711d097e23fffa724e87914614b]['stats'] = $stats;
}
...
{
$count_08eac1c8c15c262f39c657103510ee04 = is_array($this->functionData['hookActiveUsersSidebar']) ? count($this->functionData['hookActiveUsersSidebar']) : 0;
$this->functionData['hookActiveUsersSidebar'][$count_08eac1c8c15c262f39c657103510ee04]['stats'] = $stats;
}
...
{
$count_fefb112e4b260cd5c0997ebdd60a72ac = is_array($this->functionData['hookGlobalShoutbox']) ? count($this->functionData['hookGlobalShoutbox']) : 0;
$this->functionData['hookGlobalShoutbox'][$count_fefb112e4b260cd5c0997ebdd60a72ac]['d'] = $d;
}
...
{
$count_6abeb2679b37352e943c3dd15b517085 = is_array($this->functionData['hookGlobalShoutboxEmoticons']) ? count($this->functionData['hookGlobalShoutboxEmoticons']) : 0;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_6abeb2679b37352e943c3dd15b517085]['emoticons'] = $emoticons;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_6abeb2679b37352e943c3dd15b517085]['total'] = $total;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_6abeb2679b37352e943c3dd15b517085]['prev'] = $prev;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_6abeb2679b37352e943c3dd15b517085]['next'] = $next;
}
...
<table class=\"ipb_table\">
			".$this->__f__a53a459338285eb292cfd44b69b3c70f($emoticons,$total,$prev,$next)."	" . ((count($emoticons)%$this->settings['shoutbox_emos_perrow']>0) ? ("
				{$extra}
		</tr>
	") : ("")) . "
</table>";
...
function __f__a53a459338285eb292cfd44b69b3c70f($emoticons=array(), $total=0, $prev=0, $next=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ddd4c3c06e8d2d6453f44dec9b44d10a = is_array($this->functionData['hookGlobalShoutboxSidebar']) ? count($this->functionData['hookGlobalShoutboxSidebar']) : 0;
$this->functionData['hookGlobalShoutboxSidebar'][$count_ddd4c3c06e8d2d6453f44dec9b44d10a]['d'] = $d;
}
$IPBHTML .= "<!--- ShoutBoxJsLoader --->
<script type='text/javascript'>
/* Setup some value */
...
{
$count_59bb6a509a0db5cab01263a4a72016b7 = is_array($this->functionData['hookOnlineTab']) ? count($this->functionData['hookOnlineTab']) : 0;
$this->functionData['hookOnlineTab'][$count_59bb6a509a0db5cab01263a4a72016b7]['count'] = $count;
}
$IPBHTML .= "" . (($count > 0) ? ("
...
{
$count_1e2b2043bfe2c644d5195a39ab855d68 = is_array($this->functionData['hookVCard']) ? count($this->functionData['hookVCard']) : 0;
$this->functionData['hookVCard'][$count_1e2b2043bfe2c644d5195a39ab855d68]['member'] = $member;
}
...
{
$count_4d620eb54e742fc9f84b3bd55ca3e56f = is_array($this->functionData['shoutboxJavascript']) ? count($this->functionData['shoutboxJavascript']) : 0;
}
