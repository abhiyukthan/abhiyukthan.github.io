...
{
$count_c6a3bca0e9bc1119e875920434b81508 = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_c6a3bca0e9bc1119e875920434b81508]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_c6a3bca0e9bc1119e875920434b81508]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_c6a3bca0e9bc1119e875920434b81508]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_c6a3bca0e9bc1119e875920434b81508]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_c6a3bca0e9bc1119e875920434b81508]['side_blocks'] = $side_blocks;
}
...
<div id='board_index' class='ipsLayout " . (($this->templateVars['sidebar_enabled']) ? ("ipsLayout_withright") : ("")) . " ipsLayout_largeright clearfix " . ((IPSCookie::get('hide_sidebar') == '1') ? ("no_sidebar") : ("")) . "'>	
	...
	<!-- CATS AND FORUMS -->
		" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
			".$this->__f__59ba43d28e10fb93fca0ef9008033ba7($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		") : ("")) . "
	</div>
	" . (($this->templateVars['sidebar_enabled']) ? ("<div id='index_stats' class='ipsLayout_right clearfix' " . ((IPSCookie::get('hide_sidebar') == '1') ? ("style='display: none'") : ("")) . ">
			".$this->__f__0f5dd81813e7b24742d34927d31f7c69($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</div>
...
//<![CDATA[
	...
	" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		".$this->__f__db14b0016f9df3317ad1262ca9b5040c($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."	") : ("")) . "
//]]>
</script>
...
function __f__4fa5064d9bd086aae61b9e4e10bf9857($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__76b6ae099b6cb12d8123747a279a9920($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
												...
												<td class='col_c_forum'>
													...
													" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
														...
														<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
															".$this->__f__4fa5064d9bd086aae61b9e4e10bf9857($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."														</ol>
													") : ("")) . "
...
function __f__59ba43d28e10fb93fca0ef9008033ba7($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
						...
						<div class='ipsBox table_wrap'>
							<div class='ipsBox_container'>
								<table class='ipb_table' summary=\"{$this->lang->words['forums_in_cat']} '{$_data['cat_data']['name']}'\">
									...
									<!-- / CAT HEADER -->
									".$this->__f__76b6ae099b6cb12d8123747a279a9920($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."								</table>
							</div>
						</div>
						<br />
					</div>") : ("")) . "
...
function __f__0f5dd81813e7b24742d34927d31f7c69($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
...
function __f__d94012c6f68f0d83948fecd909ae372c($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
...
function __f__db14b0016f9df3317ad1262ca9b5040c($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__d94012c6f68f0d83948fecd909ae372c($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."			") : ("")) . "
...
{
$count_947557964354a4c5a9e8fbc567f3aebb = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
...
{
$count_cafe74aa9d47c7ee723373f9f55f001d = is_array($this->functionData['hookFacebookLikeBox']) ? count($this->functionData['hookFacebookLikeBox']) : 0;
$this->functionData['hookFacebookLikeBox'][$count_cafe74aa9d47c7ee723373f9f55f001d]['extra'] = $extra;
}
...
{
$count_95901e8500ac33f4c505bf665f2bf992 = is_array($this->functionData['hookGroupNameIndicator']) ? count($this->functionData['hookGroupNameIndicator']) : 0;
$this->functionData['hookGroupNameIndicator'][$count_95901e8500ac33f4c505bf665f2bf992]['groups'] = $groups;
}
...
{
$count_fa80821ecdf49b604ee2b79c58dd6d58 = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_fa80821ecdf49b604ee2b79c58dd6d58]['topics'] = $topics;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		...
		".$this->__f__0b34833849ee337e5bfbe9a92a02a765($topics)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__0b34833849ee337e5bfbe9a92a02a765($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_475de05efe9eaf6880550b0ac2d07045 = is_array($this->functionData['hooksos_topicosrecentes_parseTopic']) ? count($this->functionData['hooksos_topicosrecentes_parseTopic']) : 0;
$this->functionData['hooksos_topicosrecentes_parseTopic'][$count_475de05efe9eaf6880550b0ac2d07045]['r'] = $r;
}
			...
			<td class='col_f_content " . (($this->memberData['is_mod'] == 1 || $r['forum_data']['permissions']['TopicSoftDelete']) ? (" with_mod_links") : ("")) . "'>
			   " . (($r['topic_data']['_answeredPid'] !== false) ? ("
				...
				<span class='desc lighter blend_links'>
					...
					".$this->__f__b0eff1be6b2027231d9d59d29b58658c($r)."					" . ((isset($r['topic_data']['tags']) AND $r['topic_data']['tags']) ? ("
				...
				" . ((isset( $r['topic_data']['pages'] ) AND is_array( $r['topic_data']['pages'] ) AND count( $r['topic_data']['pages'] )) ? ("
					...
					".$this->__f__2c3328e53e4fc7118368cd486953531e($r)."					</ul>
				") : ("")) . "
			</td>
...
function __f__b0eff1be6b2027231d9d59d29b58658c($r=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2c3328e53e4fc7118368cd486953531e($r=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_406b0ef551fe551ebe1115e8050ca484 = is_array($this->functionData['hooksos_topicosrecentes_tema1']) ? count($this->functionData['hooksos_topicosrecentes_tema1']) : 0;
$this->functionData['hooksos_topicosrecentes_tema1'][$count_406b0ef551fe551ebe1115e8050ca484]['topics'] = $topics;
}
	...
	<div class='ipsBox table_wrap'>
		<div class='ipsBox_container'>
			...
			<ul id='recentTopics_table'>
				".$this->__f__61dde0ea4771edf6120a0fcd55984c61($topics)."			</ul>
		</div>
	</div>
</div>
<br />";
...
function __f__61dde0ea4771edf6120a0fcd55984c61($topics=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_c5f2f004dac43217d8838786d7b10cdf = is_array($this->functionData['hooksos_topicosrecentesAjax_tema1']) ? count($this->functionData['hooksos_topicosrecentesAjax_tema1']) : 0;
$this->functionData['hooksos_topicosrecentesAjax_tema1'][$count_c5f2f004dac43217d8838786d7b10cdf]['topics'] = $topics;
}
$IPBHTML .= "".$this->__f__656146262e53660db88317b5f96391f9($topics)."";
return $IPBHTML;
}


function __f__656146262e53660db88317b5f96391f9($topics=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_f4846e641e56b6ee2b41b73fae9a8c7f = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_f4846e641e56b6ee2b41b73fae9a8c7f]['tags'] = $tags;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	<h3>{$this->lang->words['popular_tags']}</h3>
	<div class='_sbcollapsable'>
		<ul class='ipsList_inline'>
		".$this->__f__1dc23fe89d9f3dc53f209492f67eefb7($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__1dc23fe89d9f3dc53f209492f67eefb7($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3eb03678f11da39bc0c24a47ec4b5057 = is_array($this->functionData['membersSidebarStats_insert']) ? count($this->functionData['membersSidebarStats_insert']) : 0;
$this->functionData['membersSidebarStats_insert'][$count_3eb03678f11da39bc0c24a47ec4b5057]['title'] = $title;
$this->functionData['membersSidebarStats_insert'][$count_3eb03678f11da39bc0c24a47ec4b5057]['users'] = $users;
$this->functionData['membersSidebarStats_insert'][$count_3eb03678f11da39bc0c24a47ec4b5057]['type'] = $type;
$this->functionData['membersSidebarStats_insert'][$count_3eb03678f11da39bc0c24a47ec4b5057]['text'] = $text;
$this->functionData['membersSidebarStats_insert'][$count_3eb03678f11da39bc0c24a47ec4b5057]['column'] = $column;
$this->functionData['membersSidebarStats_insert'][$count_3eb03678f11da39bc0c24a47ec4b5057]['default'] = $default;
$this->functionData['membersSidebarStats_insert'][$count_3eb03678f11da39bc0c24a47ec4b5057]['defaultName'] = $defaultName;
}
...
$IPBHTML .= "<div id='membersajaxcontent'>
		<ul class='ipsList_withminiphoto'>
		" . ((is_array( $users ) and count( $users )) ? ("".$this->__f__c2476c772bdc1e7f7acefbb0b42f299b($title,$users,$type,$text,$column,$default,$defaultName)."		") : ("
...
function __f__c2476c772bdc1e7f7acefbb0b42f299b($title, $users, $type, $text, $column, $default, $defaultName)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $users as $r )
...
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		<ul class='ipsList_withminiphoto'>
			".$this->__f__b356f9dbd530eff3e6fb9c84299260a6($staff)."		</ul>
		</div>
	</div>";
return $IPBHTML;
}
...
function __f__b356f9dbd530eff3e6fb9c84299260a6($staff)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $staff as $r )
...
{
$count_8802a5c0bd174332df1aba1a61cadf4f = is_array($this->functionData['recentPosts']) ? count($this->functionData['recentPosts']) : 0;
$this->functionData['recentPosts'][$count_8802a5c0bd174332df1aba1a61cadf4f]['recentPosts'] = $recentPosts;
}
$IPBHTML .= "" . ((is_array($recentPosts) && count($recentPosts)) ? ("
  <div class='ipsSideBlock'>
	<h3>{$this->lang->words['recentposts_title']}</h3>
    <ul class='ipsList'> 
      ".$this->__f__555d77b1ed4a3f04ece0b8790e5e41ac($recentPosts)."    </ul>
  </div>
  <br />
") : ("")) . "";
return $IPBHTML;
...
function __f__555d77b1ed4a3f04ece0b8790e5e41ac($recentPosts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_289fa1763a75862388043380aa74da28 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_289fa1763a75862388043380aa74da28]['replies'] = $replies;
}
$IPBHTML .= "".$this->__f__7f1b54412717ad4cb877382236b01bcc($replies)."";
return $IPBHTML;
}


function __f__7f1b54412717ad4cb877382236b01bcc($replies=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1270fa0f48d57ebcb0247f0c2e1374e9 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_1270fa0f48d57ebcb0247f0c2e1374e9]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_1270fa0f48d57ebcb0247f0c2e1374e9]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_1270fa0f48d57ebcb0247f0c2e1374e9]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<script type=\"text/javascript\">
...
</script>".$this->__f__5baa19c72241baf470a98b0bdd1b28ad($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__5baa19c72241baf470a98b0bdd1b28ad($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
