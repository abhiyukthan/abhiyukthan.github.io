...
{
$count_65223a5636e611f18107def3ee9ea0db = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_65223a5636e611f18107def3ee9ea0db]['data'] = $data;
}
...
{
$count_ea27ffa5a4a046907c9a5eda03287269 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_ea27ffa5a4a046907c9a5eda03287269]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_ea27ffa5a4a046907c9a5eda03287269]['form'] = $form;
}
...
{
$count_9b4459bfcd8c19c06dd6c3abff79aa52 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_9b4459bfcd8c19c06dd6c3abff79aa52]['data'] = $data;
}
...
{
$count_e72321cec6fb86946bd521b4265fe2ee = is_array($this->functionData['tbHiddenContent']) ? count($this->functionData['tbHiddenContent']) : 0;
}
...
{
$count_385c7d3cac4fdd4cda7ceec560c81095 = is_array($this->functionData['tbUnhiddenContent']) ? count($this->functionData['tbUnhiddenContent']) : 0;
$this->functionData['tbUnhiddenContent'][$count_385c7d3cac4fdd4cda7ceec560c81095]['content'] = $content;
}
...
{
$count_baffd14c36cf75ae42b1a8ef3e448aaf = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_baffd14c36cf75ae42b1a8ef3e448aaf]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__7579c22dea7e456aa94c6004ac612a4a($posts)."") : ("")) . "
<p class='submit'>
...
function __f__7579c22dea7e456aa94c6004ac612a4a($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3e16340cb1bd817b67f9a1870c72e12d = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_3e16340cb1bd817b67f9a1870c72e12d]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_3e16340cb1bd817b67f9a1870c72e12d]['type'] = $type;
$this->functionData['uploadForm'][$count_3e16340cb1bd817b67f9a1870c72e12d]['stats'] = $stats;
$this->functionData['uploadForm'][$count_3e16340cb1bd817b67f9a1870c72e12d]['id'] = $id;
$this->functionData['uploadForm'][$count_3e16340cb1bd817b67f9a1870c72e12d]['forum_id'] = $forum_id;
}
