...
{
$count_e41ff17cc9743e2d9aa4624e59d8b6fb = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_e41ff17cc9743e2d9aa4624e59d8b6fb]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_e41ff17cc9743e2d9aa4624e59d8b6fb]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_e41ff17cc9743e2d9aa4624e59d8b6fb]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_e41ff17cc9743e2d9aa4624e59d8b6fb]['sharelinks'] = $sharelinks;
}
...
{
$count_9970545016af900afa161fedb9b92c03 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_9970545016af900afa161fedb9b92c03]['announce'] = $announce;
$this->functionData['announcement_show'][$count_9970545016af900afa161fedb9b92c03]['author'] = $author;
}
...
{
$count_9db1021ede02c838102e53ba7a1ed263 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_9db1021ede02c838102e53ba7a1ed263]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_9db1021ede02c838102e53ba7a1ed263]['forum'] = $forum;
}
...
" . ((is_array( $mem ) && count( $mem )) ? ("".$this->__f__a62ca6bb02d08d4956fd354757b9be12($mem,$count)."") : ("")) . "
</if><br />";
return $IPBHTML;
}


function __f__a62ca6bb02d08d4956fd354757b9be12($mem, $count)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mem as $p => $r )
...
{
$count_01cba527eef5a42dccd46c3d6ed8044c = is_array($this->functionData['hook_who_read_topic_new']) ? count($this->functionData['hook_who_read_topic_new']) : 0;
$this->functionData['hook_who_read_topic_new'][$count_01cba527eef5a42dccd46c3d6ed8044c]['mem'] = $mem;
$this->functionData['hook_who_read_topic_new'][$count_01cba527eef5a42dccd46c3d6ed8044c]['count'] = $count;
}
$IPBHTML .= "<div>
...
<div class='general_box clearfix'>
	...
	<ul class='ipsList_withminiphoto'>
		...
		".$this->__f__c97b867054ee9fc58fe07ff251df29de($mem,$count)."</ul>
...
function __f__c97b867054ee9fc58fe07ff251df29de($mem,$count)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mem as $tts )
...
{
$count_eb044ffb0b88dda5d8d59a454d9f285f = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_e0ed8b1056111daeec33038780727f08 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_e0ed8b1056111daeec33038780727f08]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_e0ed8b1056111daeec33038780727f08]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_e0ed8b1056111daeec33038780727f08]['opts'] = $opts;
}
...
{
$count_ba2ecc454db5d55d8d74942f78a1b771 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_ba2ecc454db5d55d8d74942f78a1b771]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_ba2ecc454db5d55d8d74942f78a1b771]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_ba2ecc454db5d55d8d74942f78a1b771]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_ba2ecc454db5d55d8d74942f78a1b771]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_ba2ecc454db5d55d8d74942f78a1b771]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_ba2ecc454db5d55d8d74942f78a1b771]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__e21deac2edb5098e127879dbec8eff42($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__4a43e62d194df3610be19df9370f7d5c($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__11d248aae6b5ac548e78aa0c79d7498f($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__4a43e62d194df3610be19df9370f7d5c($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__e21deac2edb5098e127879dbec8eff42($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__11d248aae6b5ac548e78aa0c79d7498f($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_bfc94fa4a9fcb792e95b27316ba299fb = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_bfc94fa4a9fcb792e95b27316ba299fb]['post'] = $post;
$this->functionData['post'][$count_bfc94fa4a9fcb792e95b27316ba299fb]['displayData'] = $displayData;
$this->functionData['post'][$count_bfc94fa4a9fcb792e95b27316ba299fb]['topic'] = $topic;
$this->functionData['post'][$count_bfc94fa4a9fcb792e95b27316ba299fb]['forum'] = $forum;
}
...
{
$count_5a606925e57945dab3be5c69c6f2c178 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_5a606925e57945dab3be5c69c6f2c178]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_9237ac369670381e32633a76c2020591 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_9237ac369670381e32633a76c2020591]['title'] = $title;
$this->functionData['show_attachment_title'][$count_9237ac369670381e32633a76c2020591]['data'] = $data;
$this->functionData['show_attachment_title'][$count_9237ac369670381e32633a76c2020591]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__0e87e3648b60a80e8c3addc2170cf9c9($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__0e87e3648b60a80e8c3addc2170cf9c9($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_23c90768dc821bf347f5a25e8db266e3 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_23c90768dc821bf347f5a25e8db266e3]['data'] = $data;
}
...
{
$count_7c444904b7cb0f45fee0038aa52fea1c = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_7c444904b7cb0f45fee0038aa52fea1c]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_7c444904b7cb0f45fee0038aa52fea1c]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_7c444904b7cb0f45fee0038aa52fea1c]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__34c260a2d051920e9335cae95c252c83($topic,$posts)."<br class='clear' />
...
function __f__34c260a2d051920e9335cae95c252c83($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_99766da03b5292aafa05939a0f95c357 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_99766da03b5292aafa05939a0f95c357]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_99766da03b5292aafa05939a0f95c357]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_99766da03b5292aafa05939a0f95c357]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_99766da03b5292aafa05939a0f95c357]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__0a0217b0f048bfc7b8a20bb71a5911fe($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__27ff0124a99c2dd367433f7da614be48($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
	document.observe(\"dom:loaded\", function()
	{
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__6bb42865261ded4665a06d3178585816($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__a9c4728bc837e9f31bddec831434465b($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__7ace22d3a1aed9355352acf22a152244($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__0a0217b0f048bfc7b8a20bb71a5911fe($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__27ff0124a99c2dd367433f7da614be48($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6bb42865261ded4665a06d3178585816($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a9c4728bc837e9f31bddec831434465b($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7ace22d3a1aed9355352acf22a152244($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
