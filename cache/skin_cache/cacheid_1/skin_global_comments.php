...
{
$count_0951ba18b7929f5d85b6a18138944395 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_0951ba18b7929f5d85b6a18138944395]['r'] = $r;
$this->functionData['comment'][$count_0951ba18b7929f5d85b6a18138944395]['parent'] = $parent;
$this->functionData['comment'][$count_0951ba18b7929f5d85b6a18138944395]['settings'] = $settings;
}
...
{
$count_1b5aec1ee5e31371d1cd1e2b51575954 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_1b5aec1ee5e31371d1cd1e2b51575954]['r'] = $r;
$this->functionData['commentHidden'][$count_1b5aec1ee5e31371d1cd1e2b51575954]['parent'] = $parent;
$this->functionData['commentHidden'][$count_1b5aec1ee5e31371d1cd1e2b51575954]['settings'] = $settings;
}
...
{
$count_80ecbbff883a16aa2252366edab2b639 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_80ecbbff883a16aa2252366edab2b639]['comments'] = $comments;
$this->functionData['commentsList'][$count_80ecbbff883a16aa2252366edab2b639]['settings'] = $settings;
$this->functionData['commentsList'][$count_80ecbbff883a16aa2252366edab2b639]['pages'] = $pages;
$this->functionData['commentsList'][$count_80ecbbff883a16aa2252366edab2b639]['parent'] = $parent;
$this->functionData['commentsList'][$count_80ecbbff883a16aa2252366edab2b639]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__08fe79e031608bbcda0582bb6011fdef($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__08fe79e031608bbcda0582bb6011fdef($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f0dafd54f9d8303c7c153af3ff88ba0c = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_f0dafd54f9d8303c7c153af3ff88ba0c]['comment'] = $comment;
$this->functionData['form'][$count_f0dafd54f9d8303c7c153af3ff88ba0c]['parent'] = $parent;
$this->functionData['form'][$count_f0dafd54f9d8303c7c153af3ff88ba0c]['editor'] = $editor;
$this->functionData['form'][$count_f0dafd54f9d8303c7c153af3ff88ba0c]['settings'] = $settings;
$this->functionData['form'][$count_f0dafd54f9d8303c7c153af3ff88ba0c]['errors'] = $errors;
$this->functionData['form'][$count_f0dafd54f9d8303c7c153af3ff88ba0c]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
