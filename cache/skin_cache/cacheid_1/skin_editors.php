...
{
$count_760c6f5794338f98d76ff216e20a404b = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_760c6f5794338f98d76ff216e20a404b]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_760c6f5794338f98d76ff216e20a404b]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_760c6f5794338f98d76ff216e20a404b]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_760c6f5794338f98d76ff216e20a404b]['extraData'] = $extraData;
}
...
{
$count_11783915056299dcc6b5e873e4104f48 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['formField'] = $formField;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['content'] = $content;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['options'] = $options;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_11783915056299dcc6b5e873e4104f48]['showEditor'] = $showEditor;
}
...
{
$count_52974317e47b757b0ca34ccf85de961d = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_52974317e47b757b0ca34ccf85de961d]['options'] = $options;
$this->functionData['editorLoadJs'][$count_52974317e47b757b0ca34ccf85de961d]['inlineLoad'] = $inlineLoad;
}
...
{
$count_d4af3f9afbded6eb591f2412a78ba3a2 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_d4af3f9afbded6eb591f2412a78ba3a2]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_d4af3f9afbded6eb591f2412a78ba3a2]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_d4af3f9afbded6eb591f2412a78ba3a2]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_d4af3f9afbded6eb591f2412a78ba3a2]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__1850ed8824f7bfc536cc7509f049a135($rows,$pages,$app,$plugin)."		") : ("
...
function __f__1850ed8824f7bfc536cc7509f049a135($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_9f01461eca0220df8d4294f48b5220cf = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_9f01461eca0220df8d4294f48b5220cf]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__d47f399695699341cdf9ed827e005266($tabs)."			</ul>
		</div>
...
function __f__d47f399695699341cdf9ed827e005266($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
