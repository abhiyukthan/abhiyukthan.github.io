...
class skin_subscriptions_1 extends skinMaster{
...
$IPBHTML = "";
$IPBHTML .= "<select name=\"currency\">".$this->__f__f041e6ffa433885f884d1f0375d03ef1($options)."</select>";
return $IPBHTML;
}


function __f__f041e6ffa433885f884d1f0375d03ef1($options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b7dfdc6872d6fff4f44f158e141ace85 = is_array($this->functionData['indexScreen']) ? count($this->functionData['indexScreen']) : 0;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['deadRows'] = $deadRows;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['currRows'] = $currRows;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['upgradeRows'] = $upgradeRows;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['newRows'] = $newRows;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['cur_id'] = $cur_id;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['currency'] = $currency;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['currencyOptions'] = $currencyOptions;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['currencyUrl'] = $currencyUrl;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['hasRecurringPayments'] = $hasRecurringPayments;
$this->functionData['indexScreen'][$count_b7dfdc6872d6fff4f44f158e141ace85]['canRenew'] = $canRenew;
}
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $currRows ) && count( $currRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__4c1c206f5219355e65c2a492106e7b3a($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
		") : ("
		...
		<div class=\"ipsBox\">
			<div class=\"ipsBox_container\">
				<table class=\"ipb_table\">
					...
					".$this->__f__7b3d28e0ce6a12ae5b56b24738f636dc($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."				</table>
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $newRows ) && count( $newRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__1fa51f9e4069dd0203fa5640957c68cb($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
			<fieldset class=\"submit\">
				<input type=\"submit\" class=\"input_submit\" value=\"{$this->lang->words['s_continue_button']}\" />
			</fieldset>
		") : ("
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $deadRows ) && count( $deadRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__69b4a1ecadb4d66d689fd3777a1ad0b1($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
		") : ("
...
function __f__4c1c206f5219355e65c2a492106e7b3a($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7b3d28e0ce6a12ae5b56b24738f636dc($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1fa51f9e4069dd0203fa5640957c68cb($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__69b4a1ecadb4d66d689fd3777a1ad0b1($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<table class='ipb_table'>
		...
		<tr class='header'>
			...
			<th scope='col'>{$this->lang->words['sc_method']}</th>
				...
				".$this->__f__2980fc60016f99d42915ce0a409e3f1c($sub_chosen,$upgrade,$curid,$currency,$rows)."	</table>
	<div class='moderation_bar rounded  clear'>
...
function __f__2980fc60016f99d42915ce0a409e3f1c($sub_chosen, $upgrade, $curid, $currency, $rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
<li class=\"ipsField clear\">
	...
	<p class=\"ipsField_content\">
		...
		") : ("")) . "".$this->__f__468e15d4697ad2470e68782523435316($currency,$packages)."	</p>
</li>";
return $IPBHTML;
}


function __f__468e15d4697ad2470e68782523435316($currency, $packages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<ul class=\"ipsForm ipsForm_horizontal\">
		<li class=\"ipsField\">
			...
			<p class=\"ipsField_content\">
				...
				") : ("")) . "".$this->__f__da19770569ff78f4a1a2126d6f834844($currency,$packages)."			</p>
		</li>
	</ul>
</fieldset>";
return $IPBHTML;
...
function __f__da19770569ff78f4a1a2126d6f834844($currency, $packages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $packages as $package )
...
<br />
<form action=\"{$this->request['responderurl']}\" method=\"POST\">".$this->__f__92591c2235641e4cb5f0c814bff56dac($accept)."<table class='ipb_table'>
	<caption class='maintitle'>Data passed</caption>
	".$this->__f__a4161f479da038f32afd597948d0983a($accept)."</table>
<div class='moderation_bar rounded  clear'>
...
function __f__92591c2235641e4cb5f0c814bff56dac($accept)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a4161f479da038f32afd597948d0983a($accept)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $accept as $field )
