...
class skin_donate_1 extends skinMaster{
...
{
$count_495fc05f72257b65e65439336ef6e79a = is_array($this->functionData['donateSetup']) ? count($this->functionData['donateSetup']) : 0;
$this->functionData['donateSetup'][$count_495fc05f72257b65e65439336ef6e79a]['donation'] = $donation;
$this->functionData['donateSetup'][$count_495fc05f72257b65e65439336ef6e79a]['goals'] = $goals;
$this->functionData['donateSetup'][$count_495fc05f72257b65e65439336ef6e79a]['currencies'] = $currencies;
$this->functionData['donateSetup'][$count_495fc05f72257b65e65439336ef6e79a]['gateways'] = $gateways;
}
...
<li class='field'>
	...
	".$this->__f__e90981d746eda86f40c9a51477efd1b5($donation,$goals,$currencies,$gateways)."        </select>
</li>
...
<li class='field'>
	...
	".$this->__f__25eebcbe34a609017e38025ce2852be6($donation,$goals,$currencies,$gateways)."        </select>
...
<li class='field'>
	...
	".$this->__f__01fc60c0caa67ace65e9f15efdf5282b($donation,$goals,$currencies,$gateways)."        </select>
...
function __f__e90981d746eda86f40c9a51477efd1b5($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__25eebcbe34a609017e38025ce2852be6($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__01fc60c0caa67ace65e9f15efdf5282b($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d86a9b26edc31b8bc180a3a687444289 = is_array($this->functionData['donateSetupSend']) ? count($this->functionData['donateSetupSend']) : 0;
$this->functionData['donateSetupSend'][$count_d86a9b26edc31b8bc180a3a687444289]['donation'] = $donation;
$this->functionData['donateSetupSend'][$count_d86a9b26edc31b8bc180a3a687444289]['gateway'] = $gateway;
}
$IPBHTML .= "<div class='ipsSteps clearfix'>
<ul>		
	<li>
...
{
$count_4f34c9ad22611a5bd22bfa1e9bef0111 = is_array($this->functionData['splashPage']) ? count($this->functionData['splashPage']) : 0;
$this->functionData['splashPage'][$count_4f34c9ad22611a5bd22bfa1e9bef0111]['goals'] = $goals;
$this->functionData['splashPage'][$count_4f34c9ad22611a5bd22bfa1e9bef0111]['donations'] = $donations;
}
...
</tr>".$this->__f__ce86b1bac94acac5260c405df4e3979c($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
</tr>".$this->__f__dc1001ca7ca72b9d6e3a85ad77715042($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
function __f__ce86b1bac94acac5260c405df4e3979c($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__dc1001ca7ca72b9d6e3a85ad77715042($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_42bc8c494ff9bf0a411e4ddb1d925e36 = is_array($this->functionData['statsBox']) ? count($this->functionData['statsBox']) : 0;
$this->functionData['statsBox'][$count_42bc8c494ff9bf0a411e4ddb1d925e36]['topDonors'] = $topDonors;
$this->functionData['statsBox'][$count_42bc8c494ff9bf0a411e4ddb1d925e36]['stats'] = $stats;
$this->functionData['statsBox'][$count_42bc8c494ff9bf0a411e4ddb1d925e36]['active'] = $active;
}
...
{
$count_bd3e7cd8b088e9ed058a0d732fe11285 = is_array($this->functionData['topMenu']) ? count($this->functionData['topMenu']) : 0;
}
...
") : ("" . (($this->settings['dt_amounts']) ? ("
    ...
    ".$this->__f__1fb8c2d3097f8b8bf8852ccaac439242()."    </select>
    ") : ("
...
function __f__1fb8c2d3097f8b8bf8852ccaac439242()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e378d16f67e4a891cbd7f4044b55187d = is_array($this->functionData['viewAllDonations']) ? count($this->functionData['viewAllDonations']) : 0;
$this->functionData['viewAllDonations'][$count_e378d16f67e4a891cbd7f4044b55187d]['donations'] = $donations;
$this->functionData['viewAllDonations'][$count_e378d16f67e4a891cbd7f4044b55187d]['pages'] = $pages;
}
...
<th scope='col' >{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__6edecc4419b0bba0f4f6a5cb7664d4b1($donations,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__c1eaa73732a778a039991dca28da4d61($donations,$pages)."</select>
...
function __f__6edecc4419b0bba0f4f6a5cb7664d4b1($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
...
function __f__c1eaa73732a778a039991dca28da4d61($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4d122c5def8739433cc6a3c1394b30b1 = is_array($this->functionData['viewAllGoals']) ? count($this->functionData['viewAllGoals']) : 0;
$this->functionData['viewAllGoals'][$count_4d122c5def8739433cc6a3c1394b30b1]['goals'] = $goals;
$this->functionData['viewAllGoals'][$count_4d122c5def8739433cc6a3c1394b30b1]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col' class='col_c_stats stats'>{$this->lang->words['status']}</th>
<th scope='col' class='col_c_stats stats'>{$this->lang->words['stats']}</th>
</tr>".$this->__f__a20c71fb3e9c65c7cef56d223bb32836($goals,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__10ac0cacad350e5f2fd414dd8f3eb588($goals,$pages)."</select>
...
function __f__a20c71fb3e9c65c7cef56d223bb32836($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__10ac0cacad350e5f2fd414dd8f3eb588($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode(",", "5,10,25,50" ) as $value )
...
{
$count_cbf3764e27b05ab429df2ef87d4e62f9 = is_array($this->functionData['viewAllTopDonors']) ? count($this->functionData['viewAllTopDonors']) : 0;
$this->functionData['viewAllTopDonors'][$count_cbf3764e27b05ab429df2ef87d4e62f9]['donors'] = $donors;
$this->functionData['viewAllTopDonors'][$count_cbf3764e27b05ab429df2ef87d4e62f9]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
</tr>".$this->__f__94715109c6317d54d0a5ebbe530d13ef($donors,$pages)."</tr>
</table>
</div>
</div>
</div>
...
function __f__94715109c6317d54d0a5ebbe530d13ef($donors=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donors as $r )
...
{
$count_7c53df1a311f610e6c8dcbb9ef4d05a6 = is_array($this->functionData['viewGoal']) ? count($this->functionData['viewGoal']) : 0;
$this->functionData['viewGoal'][$count_7c53df1a311f610e6c8dcbb9ef4d05a6]['goal'] = $goal;
$this->functionData['viewGoal'][$count_7c53df1a311f610e6c8dcbb9ef4d05a6]['donations'] = $donations;
$this->functionData['viewGoal'][$count_7c53df1a311f610e6c8dcbb9ef4d05a6]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col'>{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__666586b4626432a82556115f418cfd69($goal,$donations,$pages)."</tr>
</table>
</div>
</div>
...
function __f__666586b4626432a82556115f418cfd69($goal=array(), $donations=array(), $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
