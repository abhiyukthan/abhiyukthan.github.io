...
{
$count_4ce3912c49007fa44202826fd9514a4c = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_4ce3912c49007fa44202826fd9514a4c]['title'] = $title;
$this->functionData['forumAttachments'][$count_4ce3912c49007fa44202826fd9514a4c]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_4ce3912c49007fa44202826fd9514a4c]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__dcbc3c54b75c91aeb7b1a2acd52a859a($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__dcbc3c54b75c91aeb7b1a2acd52a859a($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_eaf932c4e59603fc6758b7e9a5cac5bb = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_eaf932c4e59603fc6758b7e9a5cac5bb]['inforum'] = $inforum;
}
...
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
	<div class='master_list' id='board_index'>
		".$this->__f__513e3d5481361705b98f8e36016e5cb3($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</div>
") : ("")) . "
<div class='master_list'>
	" . (($forum_data['sub_can_post']) ? ("<!--<h2>{$forum_data['name']}</h2>-->
		...
		" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
			".$this->__f__1083162450a7b3f43223df80a49f2e89($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		") : ("")) . "
		
		" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
			<h3>{$this->lang->words['forum_topic_list']}</h3>
			".$this->__f__f01215825858ebc729f4a6ad8e807711($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		") : ("
...
function __f__6a492fa91268c623bf65555a0e82d9db($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__513e3d5481361705b98f8e36016e5cb3($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__6a492fa91268c623bf65555a0e82d9db($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."			") : ("")) . "
...
function __f__1083162450a7b3f43223df80a49f2e89($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f01215825858ebc729f4a6ad8e807711($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_795ca9abba6a55bee9610dd5cde95a10 = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_795ca9abba6a55bee9610dd5cde95a10]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__46be24c6b2854edc4808071e06a3ad9e($rating_id)."</span>";
return $IPBHTML;
}


function __f__46be24c6b2854edc4808071e06a3ad9e($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b793e5d998c7607fe1d015e51870d4c0 = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_b793e5d998c7607fe1d015e51870d4c0]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
