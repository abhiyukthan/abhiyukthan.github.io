...
{
$count_a0935b212786e26af2f718aef5b39aa8 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_48109e97cafce61d63345a2f1bae3e1d = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_48109e97cafce61d63345a2f1bae3e1d]['html'] = $html;
$this->functionData['messengerTemplate'][$count_48109e97cafce61d63345a2f1bae3e1d]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_48109e97cafce61d63345a2f1bae3e1d]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_48109e97cafce61d63345a2f1bae3e1d]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_48109e97cafce61d63345a2f1bae3e1d]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_48109e97cafce61d63345a2f1bae3e1d]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_48109e97cafce61d63345a2f1bae3e1d]['deletedTopic'] = $deletedTopic;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("
		...
		".$this->__f__8651daeb6e68d1b66d898a0bc3d43f27($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."	") : ("")) . "				
	...
	" . (($this->settings['_hideFolders'] != 1) ? ("<h3>{$this->lang->words['folders']} " . (($this->memberData['g_max_messages'] > 0) ? ("<span class='subtext'>{$totalData['full_percent']}% {$this->lang->words['full']}</span>") : ("")) . "</h3>
		...
		" . ((count($dirData)) ? ("
			".$this->__f__439228f108f7679a5b048f7ef4784e54($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."		") : ("")) . "") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__8651daeb6e68d1b66d898a0bc3d43f27($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__439228f108f7679a5b048f7ef4784e54($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_926809f1b72f4e7dda01132930e9c949 = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_926809f1b72f4e7dda01132930e9c949]['displayData'] = $displayData;
}
...
<form id='msgForm' class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=messaging&amp;section=send&amp;do=send", "publicWithApp",'' ), "", "" ) . "\" method=\"post\" enctype='multipart/form-data'>
	" . (($displayData['errors']) ? ("
		<div class='message error'>
			...
			".$this->__f__dbc0a7a649df10c7efa05b6a523a9c3f($displayData)."			{$this->lang->words['pme_none_sent']}
		</div>
	") : ("")) . "
...
function __f__dbc0a7a649df10c7efa05b6a523a9c3f($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8cb411da7ece13cb26d48acaba450ec6 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_8cb411da7ece13cb26d48acaba450ec6]['displayData'] = $displayData;
}
$IPBHTML .= "" . (($this->settings['_hideFolders'] = 1) ? ("") : ("")) . "
...
" . (($displayData['errors']) ? ("
	<div class='message error'>
		<strong>{$this->lang->words['err_errors']}</strong><br />
		".$this->__f__2af020d0d5b9e13a4c735ab0c8e443a6($displayData)."		{$this->lang->words['pme_none_sent']}
	</div>
") : ("")) . "
" . (($displayData['type'] == 'reply') ? ("
...
function __f__2af020d0d5b9e13a4c735ab0c8e443a6($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_1dc650eaaaacb28e4d44eac5e3473a03 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_1dc650eaaaacb28e4d44eac5e3473a03]['topic'] = $topic;
$this->functionData['showConversation'][$count_1dc650eaaaacb28e4d44eac5e3473a03]['replies'] = $replies;
$this->functionData['showConversation'][$count_1dc650eaaaacb28e4d44eac5e3473a03]['members'] = $members;
$this->functionData['showConversation'][$count_1dc650eaaaacb28e4d44eac5e3473a03]['jump'] = $jump;
}
$IPBHTML .= "<div class='controls'>
	...
	{$topic['_pages']}
</div>".$this->__f__f3fe7446baaf33bac610333c00e97791($topic,$replies,$members,$jump)."<div class='controls'>
	<div class='buttons'>
...
function __f__f3fe7446baaf33bac610333c00e97791($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bdd8129c4e742beb1a34806aa0b4f025 = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_bdd8129c4e742beb1a34806aa0b4f025]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_bdd8129c4e742beb1a34806aa0b4f025]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_bdd8129c4e742beb1a34806aa0b4f025]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__5afbcf16de44361b172e6a8aebc3d023($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__5afbcf16de44361b172e6a8aebc3d023($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_53ed52e0e5f9b6412fab3bdbf642e371 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_53ed52e0e5f9b6412fab3bdbf642e371]['messages'] = $messages;
$this->functionData['showFolder'][$count_53ed52e0e5f9b6412fab3bdbf642e371]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_53ed52e0e5f9b6412fab3bdbf642e371]['pages'] = $pages;
$this->functionData['showFolder'][$count_53ed52e0e5f9b6412fab3bdbf642e371]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_53ed52e0e5f9b6412fab3bdbf642e371]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
" . ((count( $messages )) ? ("
		".$this->__f__addaa572df37af482c281d502b197add($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."") : ("
...
function __f__addaa572df37af482c281d502b197add($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5980851ad8da07a67b2af8476cfd05d4 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_5980851ad8da07a67b2af8476cfd05d4]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_5980851ad8da07a67b2af8476cfd05d4]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_5980851ad8da07a67b2af8476cfd05d4]['error'] = $error;
}
...
<div id='message_list'>
		<table class='ipb_table' id='message_table'>
			...
			" . ((count( $messages )) ? ("
								".$this->__f__b01eac0d8c0a4defd05da09fe16919ac($messages,$pages,$error)."			") : ("
				<tr>
...
function __f__b01eac0d8c0a4defd05da09fe16919ac($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
