...
{
$count_42d25186826031f2a2dd9b9b9fd1c8b3 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_42d25186826031f2a2dd9b9b9fd1c8b3]['data'] = $data;
}
...
{
$count_b6ea99253cfec99a49bcc018ac46d6ac = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_b6ea99253cfec99a49bcc018ac46d6ac]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_b6ea99253cfec99a49bcc018ac46d6ac]['form'] = $form;
}
...
{
$count_731170e9abe885bc6d2a60d9139176d8 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_731170e9abe885bc6d2a60d9139176d8]['data'] = $data;
}
...
{
$count_b4ee3d78000a780b10b5d48b67689325 = is_array($this->functionData['tbHiddenContent']) ? count($this->functionData['tbHiddenContent']) : 0;
}
...
{
$count_3c3fc8f5d6e14fe8229b279b761a0f4a = is_array($this->functionData['tbUnhiddenContent']) ? count($this->functionData['tbUnhiddenContent']) : 0;
$this->functionData['tbUnhiddenContent'][$count_3c3fc8f5d6e14fe8229b279b761a0f4a]['content'] = $content;
}
...
{
$count_57fab4b94bd339ab9ef93740c0e66331 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_57fab4b94bd339ab9ef93740c0e66331]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__1adc8d438c5ae5edab9ed41ec2239811($posts)."") : ("")) . "
<p class='submit'>
...
function __f__1adc8d438c5ae5edab9ed41ec2239811($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9b1c9ada548a1e798ab6bf9958ce8c00 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_9b1c9ada548a1e798ab6bf9958ce8c00]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_9b1c9ada548a1e798ab6bf9958ce8c00]['type'] = $type;
$this->functionData['uploadForm'][$count_9b1c9ada548a1e798ab6bf9958ce8c00]['stats'] = $stats;
$this->functionData['uploadForm'][$count_9b1c9ada548a1e798ab6bf9958ce8c00]['id'] = $id;
$this->functionData['uploadForm'][$count_9b1c9ada548a1e798ab6bf9958ce8c00]['forum_id'] = $forum_id;
}
