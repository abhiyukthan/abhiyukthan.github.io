...
{
$count_2968e2e8f1cabf999d70efe0bf0ef6e1 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_2968e2e8f1cabf999d70efe0bf0ef6e1]['members'] = $members;
$this->functionData['member_list_show'][$count_2968e2e8f1cabf999d70efe0bf0ef6e1]['pages'] = $pages;
$this->functionData['member_list_show'][$count_2968e2e8f1cabf999d70efe0bf0ef6e1]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_2968e2e8f1cabf999d70efe0bf0ef6e1]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_2968e2e8f1cabf999d70efe0bf0ef6e1]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_2968e2e8f1cabf999d70efe0bf0ef6e1]['url'] = $url;
}
...
<div id=\"filter-letters\">
		".$this->__f__0d5335255c24b968b2c0008a03366498($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."</div>
</div>
	" . ((is_array( $members ) and count( $members )) ? ("
				".$this->__f__3b891adcdf08f317caf98a7c27089741($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."	") : ("
...
function __f__0d5335255c24b968b2c0008a03366498($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3b891adcdf08f317caf98a7c27089741($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
