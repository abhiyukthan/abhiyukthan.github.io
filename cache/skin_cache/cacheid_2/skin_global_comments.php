...
{
$count_a7caa854934c56e3fac266050fffcf78 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_a7caa854934c56e3fac266050fffcf78]['comments'] = $comments;
$this->functionData['commentsList'][$count_a7caa854934c56e3fac266050fffcf78]['settings'] = $settings;
$this->functionData['commentsList'][$count_a7caa854934c56e3fac266050fffcf78]['pages'] = $pages;
$this->functionData['commentsList'][$count_a7caa854934c56e3fac266050fffcf78]['parent'] = $parent;
$this->functionData['commentsList'][$count_a7caa854934c56e3fac266050fffcf78]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__eab20e18500d9173d30eb1e21281654f($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__eab20e18500d9173d30eb1e21281654f($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d9c5ff028fbd101d686443baa50cd547 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_d9c5ff028fbd101d686443baa50cd547]['comment'] = $comment;
$this->functionData['form'][$count_d9c5ff028fbd101d686443baa50cd547]['parent'] = $parent;
$this->functionData['form'][$count_d9c5ff028fbd101d686443baa50cd547]['editor'] = $editor;
$this->functionData['form'][$count_d9c5ff028fbd101d686443baa50cd547]['settings'] = $settings;
$this->functionData['form'][$count_d9c5ff028fbd101d686443baa50cd547]['errors'] = $errors;
$this->functionData['form'][$count_d9c5ff028fbd101d686443baa50cd547]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
