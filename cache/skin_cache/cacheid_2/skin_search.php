...
{
$count_126802f8915965d5eea4c8027c3bdc9d = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_126802f8915965d5eea4c8027c3bdc9d]['data'] = $data;
}
$IPBHTML .= "<div class='row'>
	...
	{$this->lang->words['in']}
	".$this->__f__55d4a05e1d87da34232fc12071286c6e($data)."	
	" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
		<span class='mini_pagination'>
			".$this->__f__19009a4113710f743fdff6bba3aedf77($data)."		</span>
	") : ("")) . "
	<br />
...
function __f__55d4a05e1d87da34232fc12071286c6e($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__19009a4113710f743fdff6bba3aedf77($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2c84e96ed61c544c58c8fcbf4cbee25f = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_2c84e96ed61c544c58c8fcbf4cbee25f]['data'] = $data;
}
$IPBHTML .= "<div class='row touch-row " . ((!empty( $data['_unreadUrl'] )) ? ("unread") : ("")) . "' id=\"sr-{$data['type_id_2']}\">
	...
	<div class='rowContent'>
		...
		") : ("")) . "
		<div>
			" . ucfirst($this->lang->words['in']) . "".$this->__f__b9885b6ab326b0f36a3ab621185f209f($data)."		</div>
...
function __f__b9885b6ab326b0f36a3ab621185f209f($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
{
$count_58017283442a9316a315dd44780ed879 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_58017283442a9316a315dd44780ed879]['followData'] = $followData;
}
...
{
$count_50132038c0978f95d14560aaa6136ef1 = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_50132038c0978f95d14560aaa6136ef1]['results'] = $results;
}
$IPBHTML .= "" . ((count($results)) ? ("".$this->__f__037d1578fe607f24a26d27c0aa15f0db($results)."") : ("")) . "";
return $IPBHTML;
}


function __f__037d1578fe607f24a26d27c0aa15f0db($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1a6c88800456711602c2a6ce0dac2d9a = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_1a6c88800456711602c2a6ce0dac2d9a]['results'] = $results;
}
...
<div class='master_list'>
	".$this->__f__fbd10cff0405287d154420c9646ca82a($results)."</div>";
return $IPBHTML;
}


function __f__fbd10cff0405287d154420c9646ca82a($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0adc15f5c6004ec8058a47cfe4654be1 = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_0adc15f5c6004ec8058a47cfe4654be1]['results'] = $results;
$this->functionData['followedContentView'][$count_0adc15f5c6004ec8058a47cfe4654be1]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_0adc15f5c6004ec8058a47cfe4654be1]['total'] = $total;
$this->functionData['followedContentView'][$count_0adc15f5c6004ec8058a47cfe4654be1]['error'] = $error;
$this->functionData['followedContentView'][$count_0adc15f5c6004ec8058a47cfe4654be1]['contentTypes'] = $contentTypes;
}
$IPBHTML .= "" . (($pagination) ? ("
<div class='controls'>
...
<div class='master_list'>
	...
	<div class='ipsPad'>
		...
		".$this->__f__da820f12a0190b25101093d806ec504f($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>
<div class='master_list'>
	...
	<div class='ipsPad'>
		<ul>
			".$this->__f__8dcd7de0d4c8cd726d509d6e225f29dd($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__da820f12a0190b25101093d806ec504f($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8dcd7de0d4c8cd726d509d6e225f29dd($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bf83f73c9c60e58b4aac2b56980c9c45 = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_bf83f73c9c60e58b4aac2b56980c9c45]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_bf83f73c9c60e58b4aac2b56980c9c45]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_bf83f73c9c60e58b4aac2b56980c9c45]['topic'] = $topic;
}
...
{
$count_a8680c2f039c35ea05cbfa8eb460fc86 = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_a8680c2f039c35ea05cbfa8eb460fc86]['r'] = $r;
$this->functionData['helpSearchResult'][$count_a8680c2f039c35ea05cbfa8eb460fc86]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_d123957888545cef244d629974208c3c = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_d123957888545cef244d629974208c3c]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_d123957888545cef244d629974208c3c]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_2bb9d179e1ec08da381096568a7b197b = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_2bb9d179e1ec08da381096568a7b197b]['results'] = $results;
$this->functionData['newContentView'][$count_2bb9d179e1ec08da381096568a7b197b]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_2bb9d179e1ec08da381096568a7b197b]['total'] = $total;
$this->functionData['newContentView'][$count_2bb9d179e1ec08da381096568a7b197b]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_2bb9d179e1ec08da381096568a7b197b]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_2bb9d179e1ec08da381096568a7b197b]['dateCutSet'] = $dateCutSet;
}
...
" . ((is_array($sortIn) AND count( $sortIn )) ? ("
	<div class='ipsFilterPane' id='filter_section_pane' style='display: none'>
		...
		<div>
			...
			<ul>
				".$this->__f__be63b6a84fa1c8e361663cc172d4b6c6($results,$pagination,$total,$sortDropDown,$sortIn,$dateCutSet)."			</ul>
		</div>
	</div>
") : ("")) . "
...
function __f__6e8a416585422398d631ea843f0a8fdc($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__be63b6a84fa1c8e361663cc172d4b6c6($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6c7cfbb104a8ca172ea8d5177b07344d = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_6c7cfbb104a8ca172ea8d5177b07344d]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_6c7cfbb104a8ca172ea8d5177b07344d]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_6c7cfbb104a8ca172ea8d5177b07344d]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_6c7cfbb104a8ca172ea8d5177b07344d]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_6c7cfbb104a8ca172ea8d5177b07344d]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_6c7cfbb104a8ca172ea8d5177b07344d]['canTag'] = $canTag;
}
...
<div class='master_list ipsForm_vertical'>
	...
	" . ((count($filters)) ? ("".$this->__f__9d2a86eb767e1defb8a07da19ce67bd4($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "
	<div class='submit'>
...
function __f__079d8d2df7b3130ba5f416edaa87a8b3($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__59d0b0853f7c163cb1692e7b15df5925($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
							<ul>
								<li>
									...
									".$this->__f__079d8d2df7b3130ba5f416edaa87a8b3($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."									</select>
...
function __f__5009c8cb159d5a3354d3b7f70f5ca39b($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9d2a86eb767e1defb8a07da19ce67bd4($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . (($app == 'forums') ? ("<div id='app_filter_{$app}'>
				...
				" . ((count($data['sortDropDown'])) ? ("" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
						".$this->__f__59d0b0853f7c163cb1692e7b15df5925($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."					") : ("<div class='ipsField'>
							...
							<select name='search_app_filters[$app][sortKey]' id='search_sort_by_{$app}' class='input_select' style='width:auto'>
								".$this->__f__5009c8cb159d5a3354d3b7f70f5ca39b($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							</select>
...
{
$count_1456eca6e74ba16d44277d310566028e = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_1456eca6e74ba16d44277d310566028e]['results'] = $results;
$this->functionData['searchResults'][$count_1456eca6e74ba16d44277d310566028e]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__403b44e8d56e2863a740fe7233b38bbb($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__403b44e8d56e2863a740fe7233b38bbb($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_c470918fa89cde70303bbd47e847d356 = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_c470918fa89cde70303bbd47e847d356]['search_tags'] = $search_tags;
}
...
{
$count_638b10d6384d15ef40337333527a7279 = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_638b10d6384d15ef40337333527a7279]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_638b10d6384d15ef40337333527a7279]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_31125831ba1cb46b2ef0a0d26f7c2580 = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_31125831ba1cb46b2ef0a0d26f7c2580]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_31125831ba1cb46b2ef0a0d26f7c2580]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_da0ea430540aa192f7ef28c1517e31be = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['results'] = $results;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['total'] = $total;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['member'] = $member;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['limited'] = $limited;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_da0ea430540aa192f7ef28c1517e31be]['sortDropDown'] = $sortDropDown;
}
