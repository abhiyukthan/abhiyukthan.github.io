...
{
$count_84364fc6c5d56e25a1aea90b11bbada7 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_84364fc6c5d56e25a1aea90b11bbada7]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_84364fc6c5d56e25a1aea90b11bbada7]['forum'] = $forum;
}
...
{
$count_3c86ebe61c0338717468e23a74eff1dc = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_3c86ebe61c0338717468e23a74eff1dc]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_3c86ebe61c0338717468e23a74eff1dc]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_3c86ebe61c0338717468e23a74eff1dc]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_3c86ebe61c0338717468e23a74eff1dc]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_3c86ebe61c0338717468e23a74eff1dc]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_3c86ebe61c0338717468e23a74eff1dc]['editPoll'] = $editPoll;
}
$IPBHTML .= "<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__990927fa38d044aaf8a865cf08f2af42($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__15e2ba20941f34bf456f42ccdf223467($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__990927fa38d044aaf8a865cf08f2af42($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__15e2ba20941f34bf456f42ccdf223467($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_c6f9133cf2f8bb8be6f349bbe298f861 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_c6f9133cf2f8bb8be6f349bbe298f861]['post'] = $post;
$this->functionData['post'][$count_c6f9133cf2f8bb8be6f349bbe298f861]['displayData'] = $displayData;
$this->functionData['post'][$count_c6f9133cf2f8bb8be6f349bbe298f861]['topic'] = $topic;
$this->functionData['post'][$count_c6f9133cf2f8bb8be6f349bbe298f861]['forum'] = $forum;
}
...
{
$count_0e80ecef8d449b6a9acfa833c5d82add = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_0e80ecef8d449b6a9acfa833c5d82add]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_dd81009628ad214806fc57a53797daa6 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_dd81009628ad214806fc57a53797daa6]['title'] = $title;
$this->functionData['show_attachment_title'][$count_dd81009628ad214806fc57a53797daa6]['data'] = $data;
$this->functionData['show_attachment_title'][$count_dd81009628ad214806fc57a53797daa6]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__e8f0eb916d2065d838eb2d3c53d8cf1e($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__e8f0eb916d2065d838eb2d3c53d8cf1e($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_626b1ebf081faff5d954d91be01f65dc = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_626b1ebf081faff5d954d91be01f65dc]['data'] = $data;
}
...
{
$count_46f60850dad96329b2170388fb2c5213 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_46f60850dad96329b2170388fb2c5213]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_46f60850dad96329b2170388fb2c5213]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_46f60850dad96329b2170388fb2c5213]['topic'] = $topic;
}
...
{
$count_a8c3a2be5b185e83869ca82ad6f2f885 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_a8c3a2be5b185e83869ca82ad6f2f885]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_a8c3a2be5b185e83869ca82ad6f2f885]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_a8c3a2be5b185e83869ca82ad6f2f885]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_a8c3a2be5b185e83869ca82ad6f2f885]['displayData'] = $displayData;
}
...
<div class='master_list'>
	...
	<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
		".$this->__f__583c5046b24613c317a8a1c7169231e2($forum,$topic,$post_data,$displayData)."	") : ("")) . "
	...
	") : ("")) . "
		...
		<div style='text-align:center'>
			...
			<div id='mobileModOptions' style='display:none'>
				".$this->__f__ea920339331f0cb8a8789b70707fe04b($forum,$topic,$post_data,$displayData)."			</div>
		</div>
	") : ("")) . "
	<div class='controls'>
		<div class='buttons'>
...
function __f__583c5046b24613c317a8a1c7169231e2($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ea920339331f0cb8a8789b70707fe04b($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
