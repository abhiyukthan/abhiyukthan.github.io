...
{
$count_f36443588b4b721bf9fbd7553f764651 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['html'] = $html;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['css'] = $css;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['items'] = $items;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_f36443588b4b721bf9fbd7553f764651]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__80096b7c17227b984e2daf3239ddb722($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__80096b7c17227b984e2daf3239ddb722($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML = "";
$IPBHTML .= "<div class='master_list' id='guest_message'>
     <h2>{$this->settings['gm_title']}</h2>
...
{
$count_9e8a15304016d6fd28f09d2b82e46a93 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_9e8a15304016d6fd28f09d2b82e46a93]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__6ea4a98fce85d6a9d5549c44a7279faa($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__71d09a9f5e6d06bd54a609304a54a95b($css)."") : ("")) . "";
return $IPBHTML;
}


function __f__6ea4a98fce85d6a9d5549c44a7279faa($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__71d09a9f5e6d06bd54a609304a54a95b($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5434d26eb31711593298f5d9467d3238 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_5434d26eb31711593298f5d9467d3238]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__6b67daae8c486ef34011a0f3b48d155e($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__a739ffbc6e01d32996d343bd1e288b06($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6b67daae8c486ef34011a0f3b48d155e($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__a739ffbc6e01d32996d343bd1e288b06($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_38d34d5260fb34ac9ae2473f4528e62b = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_38d34d5260fb34ac9ae2473f4528e62b]['jsModules'] = $jsModules;
}
...
{
$count_7286fc1a442f8fd0ca796667bd0cfc58 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_7286fc1a442f8fd0ca796667bd0cfc58]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__1c829ed41104793c6ebfd20fc1e9f0de($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__ec9b02b162834aff646aeddb2d98915c($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1c829ed41104793c6ebfd20fc1e9f0de($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__ec9b02b162834aff646aeddb2d98915c($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_2fe629f4cade946425b037a49aa15e9e = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__d0697d56d5d0e415ce2828cdc3307f35()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__d0697d56d5d0e415ce2828cdc3307f35()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_405f0ae940f644cb443256130d4fa357 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_405f0ae940f644cb443256130d4fa357]['data'] = $data;
}
...
{
$count_475e6cd7a576b827e1df8f9db1381979 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_475e6cd7a576b827e1df8f9db1381979]['work'] = $work;
$this->functionData['paginationTemplate'][$count_475e6cd7a576b827e1df8f9db1381979]['data'] = $data;
}
...
{
$count_336fe4ad51617c82309d3b103452a224 = is_array($this->functionData['tbSruiHook']) ? count($this->functionData['tbSruiHook']) : 0;
$this->functionData['tbSruiHook'][$count_336fe4ad51617c82309d3b103452a224]['author'] = $author;
}
...
{
$count_63a86a08efbdcb46e749ed1619dc6326 = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_63a86a08efbdcb46e749ed1619dc6326]['member'] = $member;
}
...
{
$count_2f6becc80dcf80db7f32d9421e786254 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_2f6becc80dcf80db7f32d9421e786254]['author'] = $author;
$this->functionData['userInfoPane'][$count_2f6becc80dcf80db7f32d9421e786254]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_2f6becc80dcf80db7f32d9421e786254]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("
			".$this->__f__3cecf4b813e3b99101e34441f0b78743($author,$contentid,$options)."		") : ("")) . "<!--hook.if.skin_global.userInfoPane.authorcfields.post.endif-->
	</ul>
...
function __f__e172e5bc758bdc0ad06ec22d0e0a20e4($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3cecf4b813e3b99101e34441f0b78743($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__e172e5bc758bdc0ad06ec22d0e0a20e4($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_f1d8ab42c75013d29668ae71002215be = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_f1d8ab42c75013d29668ae71002215be]['member'] = $member;
}
...
{
$count_94d58a4a0d8264db8fc439e76dbbe333 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_94d58a4a0d8264db8fc439e76dbbe333]['warning'] = $warning;
$this->functionData['warnDetails'][$count_94d58a4a0d8264db8fc439e76dbbe333]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__90ca6fb80bdb07a4f12a8ffcd0e7f8b9($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__90ca6fb80bdb07a4f12a8ffcd0e7f8b9($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
