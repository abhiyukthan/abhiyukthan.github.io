...
class skin_donate_2 extends skinMaster{
...
{
$count_20769a8f8a34c93cc3e8f212d95fea72 = is_array($this->functionData['donateSetup']) ? count($this->functionData['donateSetup']) : 0;
$this->functionData['donateSetup'][$count_20769a8f8a34c93cc3e8f212d95fea72]['donation'] = $donation;
$this->functionData['donateSetup'][$count_20769a8f8a34c93cc3e8f212d95fea72]['goals'] = $goals;
$this->functionData['donateSetup'][$count_20769a8f8a34c93cc3e8f212d95fea72]['currencies'] = $currencies;
$this->functionData['donateSetup'][$count_20769a8f8a34c93cc3e8f212d95fea72]['gateways'] = $gateways;
}
...
<li class='field'>
	...
	".$this->__f__8c3f1a24fd86ea709271e002ef79bed6($donation,$goals,$currencies,$gateways)."        </select>
</li>
...
<li class='field'>
	...
	".$this->__f__47c5ec2fc4f5732954e47022731788d3($donation,$goals,$currencies,$gateways)."        </select>
...
<li class='field'>
	...
	".$this->__f__eb8027c13d2c491b04d247ec09f6b467($donation,$goals,$currencies,$gateways)."        </select>
...
function __f__8c3f1a24fd86ea709271e002ef79bed6($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__47c5ec2fc4f5732954e47022731788d3($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__eb8027c13d2c491b04d247ec09f6b467($donation=array(), $goals=array(), $currencies=array(), $gateways=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_467fb15fd4d04929f67ac5e0a4cb8c5c = is_array($this->functionData['donateSetupSend']) ? count($this->functionData['donateSetupSend']) : 0;
$this->functionData['donateSetupSend'][$count_467fb15fd4d04929f67ac5e0a4cb8c5c]['donation'] = $donation;
$this->functionData['donateSetupSend'][$count_467fb15fd4d04929f67ac5e0a4cb8c5c]['gateway'] = $gateway;
}
$IPBHTML .= "<div class='ipsSteps clearfix'>
<ul>		
	<li>
...
{
$count_1ac554d4c8b425f0fc1c9a9cd3332178 = is_array($this->functionData['splashPage']) ? count($this->functionData['splashPage']) : 0;
$this->functionData['splashPage'][$count_1ac554d4c8b425f0fc1c9a9cd3332178]['goals'] = $goals;
$this->functionData['splashPage'][$count_1ac554d4c8b425f0fc1c9a9cd3332178]['donations'] = $donations;
}
...
</tr>".$this->__f__bb81c1dcbd39e4973747cd8710d406f6($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
</tr>".$this->__f__f2efbfe6dd14c2b3f8cbb54c5933662c($goals,$donations)."</tr>
</table>
</div>
</div>
</div>
...
function __f__bb81c1dcbd39e4973747cd8710d406f6($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__f2efbfe6dd14c2b3f8cbb54c5933662c($goals=array(), $donations=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1df7088f24d730791dcc7d8492908f10 = is_array($this->functionData['statsBox']) ? count($this->functionData['statsBox']) : 0;
$this->functionData['statsBox'][$count_1df7088f24d730791dcc7d8492908f10]['topDonors'] = $topDonors;
$this->functionData['statsBox'][$count_1df7088f24d730791dcc7d8492908f10]['stats'] = $stats;
$this->functionData['statsBox'][$count_1df7088f24d730791dcc7d8492908f10]['active'] = $active;
}
...
{
$count_95103abb87c94ba815adbbe1f50a5aaa = is_array($this->functionData['topMenu']) ? count($this->functionData['topMenu']) : 0;
}
...
") : ("" . (($this->settings['dt_amounts']) ? ("
    ...
    ".$this->__f__15333221e4feb82d7f2f9aa4db8f0d84()."    </select>
    ") : ("
...
function __f__15333221e4feb82d7f2f9aa4db8f0d84()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2e70445a3665ce45b9db3aaca298f1a5 = is_array($this->functionData['viewAllDonations']) ? count($this->functionData['viewAllDonations']) : 0;
$this->functionData['viewAllDonations'][$count_2e70445a3665ce45b9db3aaca298f1a5]['donations'] = $donations;
$this->functionData['viewAllDonations'][$count_2e70445a3665ce45b9db3aaca298f1a5]['pages'] = $pages;
}
...
<th scope='col' >{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__448c2904e7edf4bbc15d0e39253dea8b($donations,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__0c7914be05fb8e09779543ec040107ba($donations,$pages)."</select>
...
function __f__448c2904e7edf4bbc15d0e39253dea8b($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
...
function __f__0c7914be05fb8e09779543ec040107ba($donations=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0b186c8883eaeb1c18ce56df4865c2de = is_array($this->functionData['viewAllGoals']) ? count($this->functionData['viewAllGoals']) : 0;
$this->functionData['viewAllGoals'][$count_0b186c8883eaeb1c18ce56df4865c2de]['goals'] = $goals;
$this->functionData['viewAllGoals'][$count_0b186c8883eaeb1c18ce56df4865c2de]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col' class='col_c_stats stats'>{$this->lang->words['status']}</th>
<th scope='col' class='col_c_stats stats'>{$this->lang->words['stats']}</th>
</tr>".$this->__f__0971d0e31af3ab2e161e9524c3083637($goals,$pages)."</tr>
</table>
</div>
</div>
</div>
...
<label for='per_page'>{$this->lang->words['results_per_page']} </label>&nbsp; <select name=\"per_page\" id='per_page' class='input_select'>".$this->__f__e0994b72e470f9c79ae941a05ee01fe2($goals,$pages)."</select>
...
function __f__0971d0e31af3ab2e161e9524c3083637($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $goals as $r )
...
function __f__e0994b72e470f9c79ae941a05ee01fe2($goals=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode(",", "5,10,25,50" ) as $value )
...
{
$count_9faf38b9b4b8d7dadaa1ffe633526820 = is_array($this->functionData['viewAllTopDonors']) ? count($this->functionData['viewAllTopDonors']) : 0;
$this->functionData['viewAllTopDonors'][$count_9faf38b9b4b8d7dadaa1ffe633526820]['donors'] = $donors;
$this->functionData['viewAllTopDonors'][$count_9faf38b9b4b8d7dadaa1ffe633526820]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
</tr>".$this->__f__6b58da963812b6afd764a04a1f4a3703($donors,$pages)."</tr>
</table>
</div>
</div>
</div>
...
function __f__6b58da963812b6afd764a04a1f4a3703($donors=array(), $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donors as $r )
...
{
$count_d63a63b5544765306b8353fc4c432f56 = is_array($this->functionData['viewGoal']) ? count($this->functionData['viewGoal']) : 0;
$this->functionData['viewGoal'][$count_d63a63b5544765306b8353fc4c432f56]['goal'] = $goal;
$this->functionData['viewGoal'][$count_d63a63b5544765306b8353fc4c432f56]['donations'] = $donations;
$this->functionData['viewGoal'][$count_d63a63b5544765306b8353fc4c432f56]['pages'] = $pages;
}
$IPBHTML .= "<div class='category_block block_wrap'>
...
<th scope='col'>{$this->lang->words['donation_note']}</th>
<th scope='col' class='short'>{$this->lang->words['amount']}</th>
</tr>".$this->__f__9b245cc64361349ad26168f88b274abc($goal,$donations,$pages)."</tr>
</table>
</div>
</div>
...
function __f__9b245cc64361349ad26168f88b274abc($goal=array(), $donations=array(), $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $donations as $r )
