...
{
$count_dcab1b31f2984014e8afaae23fa50f33 = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['member'] = $member;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['friends'] = $friends;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['status'] = $status;
$this->functionData['profileModern'][$count_dcab1b31f2984014e8afaae23fa50f33]['warns'] = $warns;
}
...
<profileTabs>
	".$this->__f__736f1e929fc12f914664b4a2b38d90f6($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns)."</profileTabs>") : ("
	{$default_tab_content}
")) . "";
return $IPBHTML;
}
...
function __f__736f1e929fc12f914664b4a2b38d90f6($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
...
{
$count_61e83ba64ed7d6e6b9e944e8fab88cdb = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_61e83ba64ed7d6e6b9e944e8fab88cdb]['replies'] = $replies;
$this->functionData['statusReplies'][$count_61e83ba64ed7d6e6b9e944e8fab88cdb]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "<commentReplies>
	".$this->__f__a15c533ea3e65ccee290d438e3e49dd1($replies,$no_wrapper)."</commentReplies>";
return $IPBHTML;
}


function __f__a15c533ea3e65ccee290d438e3e49dd1($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2207546ea264dc20ec2ceb7d2880d889 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_2207546ea264dc20ec2ceb7d2880d889]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_2207546ea264dc20ec2ceb7d2880d889]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_2207546ea264dc20ec2ceb7d2880d889]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "<profileComments>".$this->__f__e6c9c23a8f1e4c7b93292a8020d16c89($updates,$smallSpace,$latestOnly)."</profileComments>";
return $IPBHTML;
}


function __f__e6c9c23a8f1e4c7b93292a8020d16c89($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_63c4f831646e2b2fb39554d5b597ca21 = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_63c4f831646e2b2fb39554d5b597ca21]['friends'] = $friends;
$this->functionData['tabFriends'][$count_63c4f831646e2b2fb39554d5b597ca21]['member'] = $member;
$this->functionData['tabFriends'][$count_63c4f831646e2b2fb39554d5b597ca21]['pagination'] = $pagination;
}
$IPBHTML .= "<pagination>{$pagination}</pagination>
<friends>
	".$this->__f__ae90cd6ca36395c1db6d9da70e4d5c07($friends,$member,$pagination)."</friends>";
return $IPBHTML;
}


function __f__ae90cd6ca36395c1db6d9da70e4d5c07($friends=array(), $member=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e44b0677f9088efd570fd2e4969bd1d8 = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_e44b0677f9088efd570fd2e4969bd1d8]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_e44b0677f9088efd570fd2e4969bd1d8]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_e44b0677f9088efd570fd2e4969bd1d8]['member'] = $member;
}
