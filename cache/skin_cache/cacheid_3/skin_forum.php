...
{
$count_edb188bc46d157bf7e648efee24e2c23 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_edb188bc46d157bf7e648efee24e2c23]['inforum'] = $inforum;
}
...
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
		<subforums>			
	".$this->__f__7a7d469a62f15f89ef7bd4ffab42c644($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		</subforums>
") : ("")) . "
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
		<announcements>			
	".$this->__f__c9a304f1d1029f3ce2e3237007999712($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		</announcements>
") : ("")) . "
		<topics>
" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("".$this->__f__343efad4a8cd0bdad96a8660dd3672a2($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
		</topics>
...
function __f__d9514c4d04320ce5a5a697108a907ef7($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7a7d469a62f15f89ef7bd4ffab42c644($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("					
			".$this->__f__d9514c4d04320ce5a5a697108a907ef7($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."		") : ("")) . "
...
function __f__c9a304f1d1029f3ce2e3237007999712($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e5f70d45cc3071f2735e1da254d9c1ca($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__343efad4a8cd0bdad96a8660dd3672a2($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topic_data as $tid => $data )
	{
		...
		" . ((is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			<pagination>
			".$this->__f__e5f70d45cc3071f2735e1da254d9c1ca($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$tid,$data)."		</pagination>
		") : ("")) . "		
			</topic>
