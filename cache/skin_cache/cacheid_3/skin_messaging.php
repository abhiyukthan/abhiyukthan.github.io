...
{
$count_b3cd269cc1ee89dac8a70f78201ab742 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_b3cd269cc1ee89dac8a70f78201ab742]['displayData'] = $displayData;
}
$IPBHTML .= "<postingForm>
...
{
$count_88641b300dd6af14cde7c6d4856fe7b2 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_88641b300dd6af14cde7c6d4856fe7b2]['topic'] = $topic;
$this->functionData['showConversation'][$count_88641b300dd6af14cde7c6d4856fe7b2]['replies'] = $replies;
$this->functionData['showConversation'][$count_88641b300dd6af14cde7c6d4856fe7b2]['members'] = $members;
$this->functionData['showConversation'][$count_88641b300dd6af14cde7c6d4856fe7b2]['jump'] = $jump;
}
...
<message>
	...
	".$this->__f__188d2fa32a518d4943df3e612dd8d1c1($topic,$replies,$members,$jump)."</message>";
return $IPBHTML;
}


function __f__188d2fa32a518d4943df3e612dd8d1c1($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7cf829cba83baa396583ceae4ca211ec = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_7cf829cba83baa396583ceae4ca211ec]['messages'] = $messages;
$this->functionData['showFolder'][$count_7cf829cba83baa396583ceae4ca211ec]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_7cf829cba83baa396583ceae4ca211ec]['pages'] = $pages;
$this->functionData['showFolder'][$count_7cf829cba83baa396583ceae4ca211ec]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_7cf829cba83baa396583ceae4ca211ec]['jumpFolderHTML'] = $jumpFolderHTML;
}
$IPBHTML .= "<template>popoverMessages</template>
<messages>
	".$this->__f__79e4884ff558e7b581cbda4059d810a4($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."</messages>";
return $IPBHTML;
}


function __f__79e4884ff558e7b581cbda4059d810a4($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
