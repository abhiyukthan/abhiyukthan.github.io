...
{
$count_aef53e670c2ed57cc47bb79ed1cd4c21 = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_aef53e670c2ed57cc47bb79ed1cd4c21]['data'] = $data;
}
$IPBHTML .= "<searchResult>
	...
	".$this->__f__9a2f4eed1aeb73a4ab277776abae0b3f($data)."</searchResult>";
return $IPBHTML;
}


function __f__9a2f4eed1aeb73a4ab277776abae0b3f($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b617695e84b0c2eb7592f43391a31c2a = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_b617695e84b0c2eb7592f43391a31c2a]['results'] = $results;
$this->functionData['searchResults'][$count_b617695e84b0c2eb7592f43391a31c2a]['titlesOnly'] = $titlesOnly;
}
$IPBHTML .= "" . ((is_array( $results )) ? ("".$this->__f__b247c5e3895598afa7f95716c7e44ce1($results,$titlesOnly)."		") : ("")) . "";
return $IPBHTML;
}


function __f__b247c5e3895598afa7f95716c7e44ce1($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
