...
{
$count_31aca110ae215d45c8960d17457ce889 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_31aca110ae215d45c8960d17457ce889]['post'] = $post;
$this->functionData['post'][$count_31aca110ae215d45c8960d17457ce889]['displayData'] = $displayData;
$this->functionData['post'][$count_31aca110ae215d45c8960d17457ce889]['topic'] = $topic;
$this->functionData['post'][$count_31aca110ae215d45c8960d17457ce889]['forum'] = $forum;
}
$IPBHTML .= "<post>
					<id>{$post['post']['pid']}</id>
...
{
$count_75f2294ec5be933e66c9aee85fb1d896 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_75f2294ec5be933e66c9aee85fb1d896]['title'] = $title;
$this->functionData['show_attachment_title'][$count_75f2294ec5be933e66c9aee85fb1d896]['data'] = $data;
$this->functionData['show_attachment_title'][$count_75f2294ec5be933e66c9aee85fb1d896]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__298f22f69924fc9236804ad04685eb10($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__298f22f69924fc9236804ad04685eb10($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0b80f663c91ab0320007d07720e17b39 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_0b80f663c91ab0320007d07720e17b39]['data'] = $data;
}
...
{
$count_4fb0e7dffb6d07f9494ed7669d05f1d0 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_4fb0e7dffb6d07f9494ed7669d05f1d0]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_4fb0e7dffb6d07f9494ed7669d05f1d0]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_4fb0e7dffb6d07f9494ed7669d05f1d0]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_4fb0e7dffb6d07f9494ed7669d05f1d0]['displayData'] = $displayData;
}
...
") : ("")) . "
		...
		<topic>
			...
			<posts>				
" . ((is_array( $post_data ) AND count( $post_data )) ? ("".$this->__f__750b2d68720e989578eac7b3985e5702($forum,$topic,$post_data,$displayData)."") : ("")) . "
			</posts>
		</topic>
	</forum>";
return $IPBHTML;
...
function __f__750b2d68720e989578eac7b3985e5702($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
