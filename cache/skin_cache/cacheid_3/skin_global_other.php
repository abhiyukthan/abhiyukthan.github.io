...
{
$count_bd0d70845dd03f05adefdd7b76afc802 = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_bd0d70845dd03f05adefdd7b76afc802]['notifications'] = $notifications;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__f310268956d8ca9bfd775afd960b6d39($notifications)."</notifications>";
return $IPBHTML;
}


function __f__f310268956d8ca9bfd775afd960b6d39($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_36e561b6f184381eadd52672f0f3a36a = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_36e561b6f184381eadd52672f0f3a36a]['member'] = $member;
$this->functionData['repButtons'][$count_36e561b6f184381eadd52672f0f3a36a]['data'] = $data;
}
