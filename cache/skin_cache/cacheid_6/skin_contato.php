...
{
$count_48b5dc8f9b0aabcd8a0353626474e59f = is_array($this->functionData['fields']) ? count($this->functionData['fields']) : 0;
$this->functionData['fields'][$count_48b5dc8f9b0aabcd8a0353626474e59f]['dep'] = $dep;
$this->functionData['fields'][$count_48b5dc8f9b0aabcd8a0353626474e59f]['regra'] = $regra;
$this->functionData['fields'][$count_48b5dc8f9b0aabcd8a0353626474e59f]['pergunta'] = $pergunta;
$this->functionData['fields'][$count_48b5dc8f9b0aabcd8a0353626474e59f]['customfields'] = $customfields;
$this->functionData['fields'][$count_48b5dc8f9b0aabcd8a0353626474e59f]['captchaHTML'] = $captchaHTML;
$this->functionData['fields'][$count_48b5dc8f9b0aabcd8a0353626474e59f]['firstid'] = $firstid;
}
...
<ul class=\"ipsPad\">
				...
				" . ((is_array($customfields) and count($customfields)) ? ("".$this->__f__ee314dfab64cc7982afd8106532f6e51($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."				") : ("")) . "" . (($pergunta[question] != '') ? ("
					<li class='ipsField'>
...
function __f__ee314dfab64cc7982afd8106532f6e51($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3a5933529fe1859f868bf603ae71d0f5 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_3a5933529fe1859f868bf603ae71d0f5]['dep'] = $dep;
$this->functionData['form'][$count_3a5933529fe1859f868bf603ae71d0f5]['regra'] = $regra;
$this->functionData['form'][$count_3a5933529fe1859f868bf603ae71d0f5]['pergunta'] = $pergunta;
$this->functionData['form'][$count_3a5933529fe1859f868bf603ae71d0f5]['customfields'] = $customfields;
$this->functionData['form'][$count_3a5933529fe1859f868bf603ae71d0f5]['captchaHTML'] = $captchaHTML;
$this->functionData['form'][$count_3a5933529fe1859f868bf603ae71d0f5]['firstid'] = $firstid;
}
$IPBHTML .= "{$regra}
...
<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>		
			...
			<ul>
				".$this->__f__e24a334cd7266fc641e8bb2333fa6ee2($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."						
			</ul>
		</div>
...
function __f__e24a334cd7266fc641e8bb2333fa6ee2($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $dep as $r )
