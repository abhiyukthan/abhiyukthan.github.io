...
{
$count_926f471bc37c366f29b8af496201a830 = is_array($this->functionData['acknowledgeWarning']) ? count($this->functionData['acknowledgeWarning']) : 0;
$this->functionData['acknowledgeWarning'][$count_926f471bc37c366f29b8af496201a830]['warning'] = $warning;
}
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container ipsPad'>
			...
			") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
					...
					")) . "") : ("")) . "
				".$this->__f__e93786c093296a8c127d0d650fa24a1d($warning)."")) . "
		</div>
	</div>
...
function __f__e93786c093296a8c127d0d650fa24a1d($warning)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7deb25a35a5100b57f48c15a070607eb = is_array($this->functionData['addWarning']) ? count($this->functionData['addWarning']) : 0;
$this->functionData['addWarning'][$count_7deb25a35a5100b57f48c15a070607eb]['member'] = $member;
$this->functionData['addWarning'][$count_7deb25a35a5100b57f48c15a070607eb]['reasons'] = $reasons;
$this->functionData['addWarning'][$count_7deb25a35a5100b57f48c15a070607eb]['errors'] = $errors;
$this->functionData['addWarning'][$count_7deb25a35a5100b57f48c15a070607eb]['editor'] = $editor;
$this->functionData['addWarning'][$count_7deb25a35a5100b57f48c15a070607eb]['currentPunishments'] = $currentPunishments;
}
			...
			<ul class='ipsForm ipsForm_vertical'>
				<li class='ipsField ipsField_select'>
					...
					<div class='ipsField_content'>
						<select name='reason' id='reason-select'>
							...
							".$this->__f__840cfa5be44dd7de8fa31146ed42a64b($member,$reasons,$errors,$editor,$currentPunishments)."							" . (($this->settings['warnings_enable_other'] or $this->memberData['g_access_cp']) ? ("
				...
				<li class='ipsField' style='display:none' id='suspend_li'>
					...
					<div class='ipsField_content'>
						...
						".$this->__f__82b73da6eb6062bb3e8cd56c692617c0($member,$reasons,$errors,$editor,$currentPunishments)."						</select>
					</div>
				</li>
...
function __f__840cfa5be44dd7de8fa31146ed42a64b($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__82b73da6eb6062bb3e8cd56c692617c0($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8779a8166427a0f65631ae2d4c43be96 = is_array($this->functionData['customField__gender']) ? count($this->functionData['customField__gender']) : 0;
$this->functionData['customField__gender'][$count_8779a8166427a0f65631ae2d4c43be96]['f'] = $f;
}
...
{
$count_69f24b4f0df97b51e968e2ad2e1ef9c8 = is_array($this->functionData['customField__generic']) ? count($this->functionData['customField__generic']) : 0;
$this->functionData['customField__generic'][$count_69f24b4f0df97b51e968e2ad2e1ef9c8]['f'] = $f;
}
...
{
$count_5df490b6a9247877ecec06169bc67ea6 = is_array($this->functionData['customFieldGroup__contact']) ? count($this->functionData['customFieldGroup__contact']) : 0;
$this->functionData['customFieldGroup__contact'][$count_5df490b6a9247877ecec06169bc67ea6]['f'] = $f;
}
$IPBHTML .= "" . (($f->parsed) ? ("<li>
	...
	<span class='row_data'>
		...
		" . ((is_array( $f->parsed )) ? ("
			".$this->__f__0261107612cd7faa3afb94e4dde61675($f)."		") : ("" . (($f->raw_data['pf_key'] == 'aim') ? ("
...
function __f__0261107612cd7faa3afb94e4dde61675($f)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_81c4ee7d2ddef51c28c5e46bac456199 = is_array($this->functionData['customizeProfile']) ? count($this->functionData['customizeProfile']) : 0;
$this->functionData['customizeProfile'][$count_81c4ee7d2ddef51c28c5e46bac456199]['member'] = $member;
}
$IPBHTML .= "<style type=\"text/css\">
" . (($member['customization']['bg_color'] OR $member['customization']['_bgUrl']) ? ("#customBackground{
...
{
$count_9296e269d2e6be1b4cf242ec56df8931 = is_array($this->functionData['dnameWrapper']) ? count($this->functionData['dnameWrapper']) : 0;
$this->functionData['dnameWrapper'][$count_9296e269d2e6be1b4cf242ec56df8931]['member_name'] = $member_name;
$this->functionData['dnameWrapper'][$count_9296e269d2e6be1b4cf242ec56df8931]['records'] = $records;
}
...
<table class='ipb_table'>
	...
	" . ((is_array($records) AND count($records)) ? ("
		    	".$this->__f__16db0da8d907bf0df40f42f8c98cd60f($member_name,$records)."	") : ("
		<tr>
...
function __f__16db0da8d907bf0df40f42f8c98cd60f($member_name="",$records=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d24557bda248cddb3c27ae34c6a3c88a = is_array($this->functionData['explainPoints']) ? count($this->functionData['explainPoints']) : 0;
$this->functionData['explainPoints'][$count_d24557bda248cddb3c27ae34c6a3c88a]['reasons'] = $reasons;
$this->functionData['explainPoints'][$count_d24557bda248cddb3c27ae34c6a3c88a]['actions'] = $actions;
}
...
<table class='ipb_table'>
	...
	".$this->__f__4e0cce15035d6ff8868927839137b92e($reasons,$actions)."</table>
" . ((!empty( $actions )) ? ("
	<div class='ipsPad'>
	...
	<table class='ipb_table'>
		...
		".$this->__f__a3772d74d613acdd5b84abc3cef589fd($reasons,$actions)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__4e0cce15035d6ff8868927839137b92e($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reasons as $r )
...
function __f__1461fa19e59130367b41ffc29a966860($reasons, $actions,$a='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array( 'mq', 'rpa', 'suspend' ) as $k )
...
function __f__a3772d74d613acdd5b84abc3cef589fd($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $actions as $a )
	{
		...
		$_ips___x_retval .= "
			<tr>
				<td>{$a['wa_points']}</td>
				<td>
					".$this->__f__1461fa19e59130367b41ffc29a966860($reasons,$actions,$a)."				</td>
			</tr>
...
{
$count_102148fb4451dffca9abe70d38061b0c = is_array($this->functionData['friendsList']) ? count($this->functionData['friendsList']) : 0;
$this->functionData['friendsList'][$count_102148fb4451dffca9abe70d38061b0c]['friends'] = $friends;
$this->functionData['friendsList'][$count_102148fb4451dffca9abe70d38061b0c]['pages'] = $pages;
}
...
" . ((is_array($friends) and count($friends) && $this->settings['friends_enabled']) ? ("
		...
		".$this->__f__ddf9312482ecc496c490da176b9aff68($friends,$pages)."	</ul>
") : ("<p class='no_messages'>
		" . (($this->request['tab'] == 'pending') ? ("
...
function __f__ddf9312482ecc496c490da176b9aff68($friends, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fbc4270a583628e62d65eee595d6a96a = is_array($this->functionData['listWarnings']) ? count($this->functionData['listWarnings']) : 0;
$this->functionData['listWarnings'][$count_fbc4270a583628e62d65eee595d6a96a]['member'] = $member;
$this->functionData['listWarnings'][$count_fbc4270a583628e62d65eee595d6a96a]['warnings'] = $warnings;
$this->functionData['listWarnings'][$count_fbc4270a583628e62d65eee595d6a96a]['pagination'] = $pagination;
$this->functionData['listWarnings'][$count_fbc4270a583628e62d65eee595d6a96a]['reasons'] = $reasons;
$this->functionData['listWarnings'][$count_fbc4270a583628e62d65eee595d6a96a]['canWarn'] = $canWarn;
}
	...
	<div class='ipsBox'>
		<div class='ipsBox_container'>
			<table class='ipb_table'>
				...
				<tbody>
					".$this->__f__f7eb81ef4dd448c92200e56b3f377c25($member,$warnings,$pagination,$reasons,$canWarn)."				</tbody>
			</table>
		</div>
	</div>
")) . "
...
function __f__f7eb81ef4dd448c92200e56b3f377c25($member, $warnings, $pagination, $reasons, $canWarn)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3d7ed3bfcbcd42acce3093794d7f3b50 = is_array($this->functionData['photoEditor']) ? count($this->functionData['photoEditor']) : 0;
$this->functionData['photoEditor'][$count_3d7ed3bfcbcd42acce3093794d7f3b50]['data'] = $data;
$this->functionData['photoEditor'][$count_3d7ed3bfcbcd42acce3093794d7f3b50]['member'] = $member;
}
...
{
$count_f12d961dba5772fb0bbd9956734704ee = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_f12d961dba5772fb0bbd9956734704ee]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_f12d961dba5772fb0bbd9956734704ee]['member'] = $member;
$this->functionData['profileModern'][$count_f12d961dba5772fb0bbd9956734704ee]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_f12d961dba5772fb0bbd9956734704ee]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_f12d961dba5772fb0bbd9956734704ee]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_f12d961dba5772fb0bbd9956734704ee]['friends'] = $friends;
$this->functionData['profileModern'][$count_f12d961dba5772fb0bbd9956734704ee]['status'] = $status;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='profile_tabs'>
			...
			<ul class='clear' style='margin-top: 13px;'>
				...
				".$this->__f__06f89e8906c7bed9b316769e0750345f($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status)."			</ul>
		</div>
		<div class='ipsVerticalTabbed_content ipsLayout_content' id='profile_content'>

<div id='profile_content_main' " . ((!(is_array($member['customization']) AND $member['customization']['type'])) ? ("class='ipsPad ipsBox_container' style='margin-bottom: 9px;'") : ("class='ipsPad'")) . ">
					<div id='user_info_cell'>
                        ...
                        " . ((!empty( $warns )) ? ("
                            ".$this->__f__585fac297ddfa1374a044229fa5a89a3($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status)."                        ") : ("")) . "
					...
					<ul class='ipsList_inline' id='user_utility_links'>
						...
						" . ((($this->memberData['member_id'] && $member['member_id'] == $this->memberData['member_id'] )) ? ("" . (($this->memberData['gbw_allow_url_bgimage'] OR $this->memberData['gbw_allow_upload_bgimage']) ? ("
							<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=customize", "public",'' ), "", "" ) . "' class='ipsButton_secondary'><img src=\"{style_images_url}/profile_tab_gallery.png\" alt=\"\" /> Edit Header Image</a></li>
						") : ("")) . "") : ("")) . "" . ((($member['member_id'] == $this->memberData['member_id'] ) AND $member['customization']['type']) ? ("
			<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$member['member_id']}&amp;secure_key={$this->member->form_hash}&amp;removeCustomization=1", "public",'' ), "{$member['members_seo_name']}", "showuser" ) . "' class='ipsButton_secondary'><img src=\"{style_images_url}/delete.png\" alt=\"\" /> {$this->lang->words['cust_remove']}</a></li>
		") : ("")) . "
					</ul>
				</div>
							...
							<div class='general_box clearfix'>
								...
								<ul class='ipsList_data clearfix'>									
									...
									" . (($member['custom_fields']['profile_info'] != "") ? ("
										".$this->__f__15950c8b1891e8b8ddce42088b498575($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status)."									") : ("")) . "
								</ul>
							</div>
							
							" . (($member['custom_fields']) ? ("
								".$this->__f__e39ae6ffdcf947bfe505c682086abcac($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status)."							") : ("")) . "
							...
							" . (($this->memberData['g_access_cp'] == 1 || is_array( $member['custom_fields']['contact'] )) ? ("<div class='general_box clearfix'>
									...
									<ul class='ipsList_data clearfix'>
										...
										" . ((is_array( $member['custom_fields']['contact'])) ? ("
											".$this->__f__1b3537aa11112883ed9d1353ca466778($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status)."										") : ("")) . "
									</ul>
								</div>") : ("")) . "
						</div>
							...
							" . (($member['pp_setting_count_friends'] and $this->settings['friends_enabled']) ? ("<div class='general_box clearfix' id='friends_overview'>
									...
									<div class='ipsPad'>
										" . ((count($friends) AND is_array($friends)) ? ("
											".$this->__f__24fd07981f0fd95bf3b969ae9a16e25f($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status)."										") : ("
											<p class='desc'>
							...
							" . (($member['pp_setting_count_visitors']) ? ("<div class='general_box clearfix'>
									...
									" . ((is_array( $visitors ) && count( $visitors )) ? ("
										<ul class='ipsList_withminiphoto'>
											".$this->__f__06e206dccd946e89ece9007718ef9ef3($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status)."										</ul>
									") : ("
...
function __f__06f89e8906c7bed9b316769e0750345f($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
...
function __f__585fac297ddfa1374a044229fa5a89a3($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__15950c8b1891e8b8ddce42088b498575($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__779d868bc1ae31bf13ee6aadfa3bb328($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(),$group='',$mdata='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e39ae6ffdcf947bfe505c682086abcac($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
									" . (($group != 'profile_info' AND $group != 'contact') ? ("" . ((is_array( $member['custom_fields'][ $group ] ) AND count( $member['custom_fields'][ $group ] )) ? ("
											<div class='general_box clearfix' id='custom_fields_{$group}'>
												...
												<br />
												<ul class='ipsList_data clearfix'>
													".$this->__f__779d868bc1ae31bf13ee6aadfa3bb328($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$group,$mdata)."												</ul>
											</div>
										") : ("")) . "") : ("")) . "
...
function __f__1b3537aa11112883ed9d1353ca466778($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__24fd07981f0fd95bf3b969ae9a16e25f($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
function __f__06e206dccd946e89ece9007718ef9ef3($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_79ebabe298acbeb560c586dd7eb90454 = is_array($this->functionData['reputationPage']) ? count($this->functionData['reputationPage']) : 0;
$this->functionData['reputationPage'][$count_79ebabe298acbeb560c586dd7eb90454]['langBit'] = $langBit;
$this->functionData['reputationPage'][$count_79ebabe298acbeb560c586dd7eb90454]['currentApp'] = $currentApp;
$this->functionData['reputationPage'][$count_79ebabe298acbeb560c586dd7eb90454]['supportedApps'] = $supportedApps;
$this->functionData['reputationPage'][$count_79ebabe298acbeb560c586dd7eb90454]['processedResults'] = $processedResults;
}
	...
	" . ((count( $supportedApps ) > 1) ? ("
		<div class='maintitle ipsFilterbar clearfix'>
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__457cba945dd1677cb37b2da7000fb37f($langBit,$currentApp,$supportedApps,$processedResults)."			</ul>
		</div>
	") : ("")) . "
	" . (($processedResults) ? ("
		{$processedResults}
...
function __f__457cba945dd1677cb37b2da7000fb37f($langBit, $currentApp='', $supportedApps=array(), $processedResults='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f3bcb6505aa22ea868c0f2de22e870cb = is_array($this->functionData['showCard']) ? count($this->functionData['showCard']) : 0;
$this->functionData['showCard'][$count_f3bcb6505aa22ea868c0f2de22e870cb]['member'] = $member;
$this->functionData['showCard'][$count_f3bcb6505aa22ea868c0f2de22e870cb]['download'] = $download;
}
$IPBHTML .= "<div class='vcard userpopup'>
	...
	<div class='ipsPad'>
		...
		<ul class='user_controls clear'>
			...
			") : ("")) . "<!--hook.if.skin_profile.showCard.cardGallery.post.endif-->
		</ul>
	</div>
</div>";
return $IPBHTML;
...
{
$count_7694b43c828a1f37c3cd3a6b40199fc9 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_7694b43c828a1f37c3cd3a6b40199fc9]['replies'] = $replies;
$this->functionData['statusReplies'][$count_7694b43c828a1f37c3cd3a6b40199fc9]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "" . ((!$no_wrapper) ? ("
	<ul class='ipsList_withtinyphoto clear'>
") : ("")) . "".$this->__f__73fb5dd3754a603e92111901fb42f73f($replies,$no_wrapper)."" . ((!$no_wrapper) ? ("
	</ul>
") : ("")) . "";
return $IPBHTML;
}
...
function __f__73fb5dd3754a603e92111901fb42f73f($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ee3ee98f49039e411ae365282f3611e8 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_ee3ee98f49039e411ae365282f3611e8]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_ee3ee98f49039e411ae365282f3611e8]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_ee3ee98f49039e411ae365282f3611e8]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "".$this->__f__163d0df1262c95491a7c98c97e02fd39($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__163d0df1262c95491a7c98c97e02fd39($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fe728a3c15a7d8a468546f71b2845e83 = is_array($this->functionData['statusUpdatesPage']) ? count($this->functionData['statusUpdatesPage']) : 0;
$this->functionData['statusUpdatesPage'][$count_fe728a3c15a7d8a468546f71b2845e83]['updates'] = $updates;
$this->functionData['statusUpdatesPage'][$count_fe728a3c15a7d8a468546f71b2845e83]['pages'] = $pages;
}
...
{
$count_2294be9eae37d6ae2e04ce5b0804cfdc = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_2294be9eae37d6ae2e04ce5b0804cfdc]['friends'] = $friends;
$this->functionData['tabFriends'][$count_2294be9eae37d6ae2e04ce5b0804cfdc]['member'] = $member;
}
$IPBHTML .= "<div class='general_box'>
	" . (($this->settings['friends_enabled'] AND $this->memberData['g_can_add_friends'] AND $member['pp_setting_count_friends']) ? ("<div class='friend_list clear' id='friend_list'>
			...
			" . ((is_array($friends) and count($friends)) ? ("
				<ul class='clearfix'>
				".$this->__f__76b73239289a8f911db0556a56aae441($friends,$member)."				</ul>				
			") : ("
				<p class='ipsPad'>
...
function __f__76b73239289a8f911db0556a56aae441($friends=array(), $member=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
{
$count_2f4396dc6ee82f9ad9ed5b867c58f620 = is_array($this->functionData['tabReputation']) ? count($this->functionData['tabReputation']) : 0;
$this->functionData['tabReputation'][$count_2f4396dc6ee82f9ad9ed5b867c58f620]['member'] = $member;
$this->functionData['tabReputation'][$count_2f4396dc6ee82f9ad9ed5b867c58f620]['currentApp'] = $currentApp;
$this->functionData['tabReputation'][$count_2f4396dc6ee82f9ad9ed5b867c58f620]['type'] = $type;
$this->functionData['tabReputation'][$count_2f4396dc6ee82f9ad9ed5b867c58f620]['supportedApps'] = $supportedApps;
$this->functionData['tabReputation'][$count_2f4396dc6ee82f9ad9ed5b867c58f620]['processedResults'] = $processedResults;
$this->functionData['tabReputation'][$count_2f4396dc6ee82f9ad9ed5b867c58f620]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	<div class='maintitle ipsFilterbar clearfix'>
		" . ((count( $supportedApps ) > 1) ? ("
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__49ee9999b71301070ad8b0b113833b70($member,$currentApp,$type,$supportedApps,$processedResults,$pagination)."			</ul>
		") : ("")) . "
...
function __f__49ee9999b71301070ad8b0b113833b70($member, $currentApp='', $type='', $supportedApps=array(), $processedResults='', $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $supportedApps as $_app )
...
{
$count_51bb905dcc96349cc87f09819daa905c = is_array($this->functionData['tabReputation_calendar']) ? count($this->functionData['tabReputation_calendar']) : 0;
$this->functionData['tabReputation_calendar'][$count_51bb905dcc96349cc87f09819daa905c]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__b3678de6dc500cda60e0ea77ab594ada($results)."</div>";
return $IPBHTML;
}


function __f__b3678de6dc500cda60e0ea77ab594ada($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c0b0dc99b63f127eaf57237e018c68f3 = is_array($this->functionData['tabReputation_posts']) ? count($this->functionData['tabReputation_posts']) : 0;
$this->functionData['tabReputation_posts'][$count_c0b0dc99b63f127eaf57237e018c68f3]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__84f6f7f0faf6b7caaf252b379bf9f6fd($results)."</div>";
return $IPBHTML;
}


function __f__f54d971de3ea445140ce92e1d1d26fa5($results,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__84f6f7f0faf6b7caaf252b379bf9f6fd($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $data )
			...
			<div class='post_wrap'>
				...
				<div class='post_body'>
					<p class='posted_info desc lighter ipsType_small'>
						...
						" . (($data['_forum_trail']) ? ("
							in
							".$this->__f__f54d971de3ea445140ce92e1d1d26fa5($results,$data)."						") : ("")) . "
					</p>
					<div class='post entry-content clearfix'>
						{$data['post']}
						<br />
...
{
$count_9ac67d3bdfb1382fae038065b4163d1f = is_array($this->functionData['tabSingleColumn']) ? count($this->functionData['tabSingleColumn']) : 0;
$this->functionData['tabSingleColumn'][$count_9ac67d3bdfb1382fae038065b4163d1f]['row'] = $row;
$this->functionData['tabSingleColumn'][$count_9ac67d3bdfb1382fae038065b4163d1f]['read_more_link'] = $read_more_link;
$this->functionData['tabSingleColumn'][$count_9ac67d3bdfb1382fae038065b4163d1f]['url'] = $url;
$this->functionData['tabSingleColumn'][$count_9ac67d3bdfb1382fae038065b4163d1f]['title'] = $title;
}
...
{
$count_41072cf417525a1025a8fe00e06dd327 = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_41072cf417525a1025a8fe00e06dd327]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_41072cf417525a1025a8fe00e06dd327]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_41072cf417525a1025a8fe00e06dd327]['member'] = $member;
}
