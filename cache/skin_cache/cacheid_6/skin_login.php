...
{
$count_2d83efb9d98de43380622503e562ea6c = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
") : ("<div id='inline_login_form' class='ipbfs_login'>
...
{
$count_cc87179a1e48612ed400889e1e589486 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_cc87179a1e48612ed400889e1e589486]['message'] = $message;
$this->functionData['showLogInForm'][$count_cc87179a1e48612ed400889e1e589486]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_cc87179a1e48612ed400889e1e589486]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_cc87179a1e48612ed400889e1e589486]['login_methods'] = $login_methods;
$this->functionData['showLogInForm'][$count_cc87179a1e48612ed400889e1e589486]['facebookOpts'] = $facebookOpts;
}
				...
				<div class='right ipsPad_double' id='other_signin'>
					<ul class='ipsList_data clear ipsType_small'>
						...
						" . ((is_array($extra_form) AND count($extra_form)) ? ("
							".$this->__f__73357e73fbf90d3ef336f6102f6d499d($message,$referer,$extra_form,$login_methods,$facebookOpts)."						") : ("")) . "
					</ul>
				</div>
			</div>
			" . ((IPSLib::loginMethod_enabled('live')) ? ("
...
function __f__73357e73fbf90d3ef336f6102f6d499d($message="",$referer="",$extra_form="", $login_methods=array(), $facebookOpts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
