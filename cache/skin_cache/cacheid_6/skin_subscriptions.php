...
class skin_subscriptions_6 extends skinMaster{
...
$IPBHTML = "";
$IPBHTML .= "<select name=\"currency\">".$this->__f__ed7bbd780868c86947345dd0bad09a9f($options)."</select>";
return $IPBHTML;
}


function __f__ed7bbd780868c86947345dd0bad09a9f($options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ef04c48cf68d10e0cd0c104d6dab0a6c = is_array($this->functionData['indexScreen']) ? count($this->functionData['indexScreen']) : 0;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['deadRows'] = $deadRows;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['currRows'] = $currRows;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['upgradeRows'] = $upgradeRows;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['newRows'] = $newRows;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['cur_id'] = $cur_id;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['currency'] = $currency;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['currencyOptions'] = $currencyOptions;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['currencyUrl'] = $currencyUrl;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['hasRecurringPayments'] = $hasRecurringPayments;
$this->functionData['indexScreen'][$count_ef04c48cf68d10e0cd0c104d6dab0a6c]['canRenew'] = $canRenew;
}
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $currRows ) && count( $currRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__a6fc9c083174a1733227667fbe6850b4($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
		") : ("
		...
		<div class=\"ipsBox\">
			<div class=\"ipsBox_container\">
				<table class=\"ipb_table\">
					...
					".$this->__f__84a7ac947bfa07ddb2d5509bb5816f63($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."				</table>
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $newRows ) && count( $newRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__dc64c03c7aeba559e91d0365686a3365($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
			<fieldset class=\"submit\">
				<input type=\"submit\" class=\"input_submit\" value=\"{$this->lang->words['s_continue_button']}\" />
			</fieldset>
		") : ("
	...
	<div class=\"ipsBox_container\">
		" . ((is_array( $deadRows ) && count( $deadRows )) ? ("
			<table class=\"ipb_table\">
				...
				".$this->__f__a4f03c5187e19324a684303a09f78bbe($deadRows,$currRows,$upgradeRows,$newRows,$cur_id,$currency,$currencyOptions,$currencyUrl,$hasRecurringPayments,$canRenew)."			</table>
		") : ("
...
function __f__a6fc9c083174a1733227667fbe6850b4($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__84a7ac947bfa07ddb2d5509bb5816f63($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dc64c03c7aeba559e91d0365686a3365($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a4f03c5187e19324a684303a09f78bbe($deadRows, $currRows, $upgradeRows, $newRows, $cur_id, $currency, $currencyOptions, $currencyUrl, $hasRecurringPayments=false, $canRenew=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<table class='ipb_table'>
		...
		<tr class='header'>
			...
			<th scope='col'>{$this->lang->words['sc_method']}</th>
				...
				".$this->__f__8477f77312b1d82429208c1e67778c13($sub_chosen,$upgrade,$curid,$currency,$rows)."	</table>
	<div class='moderation_bar rounded  clear'>
...
function __f__8477f77312b1d82429208c1e67778c13($sub_chosen, $upgrade, $curid, $currency, $rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
<li class=\"ipsField clear\">
	...
	<p class=\"ipsField_content\">
		...
		") : ("")) . "".$this->__f__d6fd43451797485b4ca39d356b25de07($currency,$packages)."	</p>
</li>";
return $IPBHTML;
}


function __f__d6fd43451797485b4ca39d356b25de07($currency, $packages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<ul class=\"ipsForm ipsForm_horizontal\">
		<li class=\"ipsField\">
			...
			<p class=\"ipsField_content\">
				...
				") : ("")) . "".$this->__f__2d27cafad2d3b0f98d9f9e6633cfdb1e($currency,$packages)."			</p>
		</li>
	</ul>
</fieldset>";
return $IPBHTML;
...
function __f__2d27cafad2d3b0f98d9f9e6633cfdb1e($currency, $packages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $packages as $package )
...
<br />
<form action=\"{$this->request['responderurl']}\" method=\"POST\">".$this->__f__80b71de4fb18d2fe2d428871541198fe($accept)."<table class='ipb_table'>
	<caption class='maintitle'>Data passed</caption>
	".$this->__f__dd11c4e76c3b55689a3c7b2ce4fbf7a0($accept)."</table>
<div class='moderation_bar rounded  clear'>
...
function __f__80b71de4fb18d2fe2d428871541198fe($accept)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dd11c4e76c3b55689a3c7b2ce4fbf7a0($accept)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $accept as $field )
