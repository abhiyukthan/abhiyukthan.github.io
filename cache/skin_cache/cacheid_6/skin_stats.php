...
{
$count_4959389d7cdb094190e8dde563e275e8 = is_array($this->functionData['group_strip']) ? count($this->functionData['group_strip']) : 0;
$this->functionData['group_strip'][$count_4959389d7cdb094190e8dde563e275e8]['group'] = $group;
$this->functionData['group_strip'][$count_4959389d7cdb094190e8dde563e275e8]['members'] = $members;
$this->functionData['group_strip'][$count_4959389d7cdb094190e8dde563e275e8]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__c0a4e543687314db2b6a3c17d2238e47($group,$members,$pagination)."	") : ("")) . "
...
function __f__d78f0b54a5757df05e44a673dd180541($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__61b7e5a20bc01eeb07b4196f58ba126c($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__c0a4e543687314db2b6a3c17d2238e47($group="", $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((empty( $info['forums'] )) ? ("
							--
						") : ("" . ((count( $info['forums'] ) == 1) ? ("
								".$this->__f__d78f0b54a5757df05e44a673dd180541($group,$members,$pagination,$info)."							") : ("
								...
								".$this->__f__61b7e5a20bc01eeb07b4196f58ba126c($group,$members,$pagination,$info)."								</ul>
...
{
$count_d227b057dd48760a810b50dcd6f8e1b3 = is_array($this->functionData['top_posters']) ? count($this->functionData['top_posters']) : 0;
$this->functionData['top_posters'][$count_d227b057dd48760a810b50dcd6f8e1b3]['rows'] = $rows;
}
...
<table class='ipb_table ipsMemberList'>
	...
	") : ("
				".$this->__f__fa4c3956497ffffec77e7b75fc0872b2($rows)."	")) . "
</table>
...
function __f__fa4c3956497ffffec77e7b75fc0872b2($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_892fc3593685edf4ca2c5521729034c4 = is_array($this->functionData['whoPosted']) ? count($this->functionData['whoPosted']) : 0;
$this->functionData['whoPosted'][$count_892fc3593685edf4ca2c5521729034c4]['tid'] = $tid;
$this->functionData['whoPosted'][$count_892fc3593685edf4ca2c5521729034c4]['title'] = $title;
$this->functionData['whoPosted'][$count_892fc3593685edf4ca2c5521729034c4]['rows'] = $rows;
}
...
<div class='fixed_inner'>
	<table class='ipb_table'>
		...
		" . ((count($rows) AND is_array($rows)) ? ("
						".$this->__f__3f1886a3a202d90515629e1d4225f141($tid,$title,$rows)."		") : ("")) . "
	</table>
</div>
...
function __f__3f1886a3a202d90515629e1d4225f141($tid=0, $title="", $rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
