...
{
$count_12aeff750c3981c0b5802da9ba38c7c5 = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_12aeff750c3981c0b5802da9ba38c7c5]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_12aeff750c3981c0b5802da9ba38c7c5]['key'] = $key;
$this->functionData['completePartialLogin'][$count_12aeff750c3981c0b5802da9ba38c7c5]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_12aeff750c3981c0b5802da9ba38c7c5]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_12aeff750c3981c0b5802da9ba38c7c5]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_12aeff750c3981c0b5802da9ba38c7c5]['userFromService'] = $userFromService;
}
				...
				<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register&amp;do=complete_login_do&amp;key=$key&amp;mid=$mid&amp;connectService={$userFromService['service']}", "public",'' ), "", "" ) . "\" method=\"POST\">
					...
					<fieldset class='main'>
						<ul class='ipsForm ipsForm_horizontal ipsPad'>
							...
							") : ("")) . "<!--hook.if.skin_register.completePartialLogin.partialNoEmail.post.endif-->
							" . (($custom_fields != '') ? ("<fieldset class='rcomplete'>
								" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
									".$this->__f__1e1a1c2aa2f8782abe1b90dbfb8faa07($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
	
								" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
									".$this->__f__0cfb71ac6d7c58579a47134280a6ce18($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
								</fieldset>") : ("")) . "
						</ul>
					</fieldset>
...
function __f__1e1a1c2aa2f8782abe1b90dbfb8faa07($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0cfb71ac6d7c58579a47134280a6ce18($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_730eea9e218a217423ccd469eba5545f = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_730eea9e218a217423ccd469eba5545f]['errors'] = $errors;
}
...
#psStrength {
	background-image: url('{$this->settings['public_dir']}style_extra/passwordStrength.jpg');
	height:18px;
	width:0px;
}
#openPwdStrengthPopup:hover {
	text-decoration: underline;
}
</style>
<script type='text/javascript'>
ipb.vars['pwm_oneLcScore']		= parseInt( '{$this->settings['pwm_oneLcScore']}' );
ipb.vars['pwm_oneUcScore']		= parseInt( '{$this->settings['pwm_oneUcScore']}' );
ipb.vars['pwm_oneNumScore']		= parseInt( '{$this->settings['pwm_oneNumScore']}' );
ipb.vars['pwm_threeNumScore']		= parseInt( '{$this->settings['pwm_threeNumScore']}' );
ipb.vars['pwm_oneScScore']		= parseInt( '{$this->settings['pwm_oneScScore']}' );
ipb.vars['pwm_twoScScore']		= parseInt( '{$this->settings['pwm_twoScScore']}' );
ipb.vars['pwm_mixedLettersScore']	= parseInt( '{$this->settings['pwm_mixedLettersScore']}' );
ipb.vars['pwm_mixedNumbersScore']	= parseInt( '{$this->settings['pwm_mixedNumbersScore']}' );
ipb.vars['pwm_bigComboScore']		= parseInt( '{$this->settings['pwm_bigComboScore']}' );
ipb.vars['pwm_onlyNumOrLetterScore']	= parseInt( '{$this->settings['pwm_onlyNumOrLetterScore']}' );
ipb.lang['pwm_tooShortPwd']		= \"{$this->lang->words['pwm_tooShortPwd']}\";
ipb.lang['pwm_badPwd']			= \"{$this->lang->words['pwm_badPwd']}\";
ipb.lang['pwm_goodPwd']			= \"{$this->lang->words['pwm_goodPwd']}\";
ipb.lang['pwm_strongPwd']		= \"{$this->lang->words['pwm_strongPwd']}\";
</script>
<script type='text/javascript' src='{$this->settings['public_dir']}js/ips.passwordStrength.js'></script>
<div id=\"passwordStrengthPopup\" style=\"display:none;\">
	<h3>{$this->lang->words['pwm_title']}</h3>
	...
	<div class=\"fixed_inner ipsBox\" style=\"height: 430px; max-height: 430px; overflow-x: auto; overflow-y: auto; \">
	<div class=\"ipsVerticalTabbed ipsLayout clearfix\">
				<div class=\"ipsVerticalTabbed_content ipsLayout_content ipsBox_container\" style=\"position: relative; padding: 5px; width: 98%;\" id=\"ipsNav_content\">
			<div>
	
<p>{$this->lang->words['pwm_description']}</p>
		<ul class=\"block_list\">
			<li>{$this->lang->words['pwm_lengthMultiplied']}</li>
			<li>" . sprintf( $this->lang->words['pwm_oneLcScore'], $this->settings['pwm_oneLcScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_oneUcScore'], $this->settings['pwm_oneUcScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_oneNumScore'], $this->settings['pwm_oneNumScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_threeNumScore'], $this->settings['pwm_threeNumScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_oneScScore'], $this->settings['pwm_oneScScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_twoScScore'], $this->settings['pwm_twoScScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_mixedLettersScore'], $this->settings['pwm_mixedLettersScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_mixedNumbersScore'], $this->settings['pwm_mixedNumbersScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_bigComboScore'], $this->settings['pwm_bigComboScore']) . "</li>
			<li>" . sprintf( $this->lang->words['pwm_onlyNumOrLetterScore'], $this->settings['pwm_onlyNumOrLetterScore']) . "</li>
			<li>{$this->lang->words['pwm_sameAsCredentials']}</li>
		</ul>	
</div>
		</div>
	</div>
	...
	<div style=\"background: #c9d7df; font-size: 11px; text-align: right; width: 690px; max-width: 690px; margin-top: 7px; padding: 3px; padding-right: 10px;\">
	
	<a href=\"http://forum.sosinvision.com.br/\" title=\"SOS Invision\">(SOS34) Password Strength Meter in Registration Form &copy; 2011 - SOS Invision</a>
...
{
$count_8b0d311d390dec1bd8dad43a1da1e8b4 = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_e6a206f5e3127b2c834f649353949677 = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
		...
		<fieldset class='general_box'>
			...
			<div class='ipsPad ipsForm_center'>
				...
				<select name='month' id='coppa_bday_m'>
					".$this->__f__331b8340a1d47359cc46855597130801()."				</select>
				&nbsp;
				<select name='day' id='coppa_bday_d'>
					".$this->__f__d3b4418b508919703b86143acc3527a0()."				</select>
				&nbsp;
				<select name='year' id='coppa_bday_y'>
					".$this->__f__a69e3e414de73ff73bb62d18a23a2103()."				</select>
			</div>
		</fieldset>
...
function __f__331b8340a1d47359cc46855597130801()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d3b4418b508919703b86143acc3527a0()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a69e3e414de73ff73bb62d18a23a2103()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_238bd6138c09514e3b80629e3b25b700 = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_238bd6138c09514e3b80629e3b25b700]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_238bd6138c09514e3b80629e3b25b700]['data'] = $data;
$this->functionData['registerForm'][$count_238bd6138c09514e3b80629e3b25b700]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_238bd6138c09514e3b80629e3b25b700]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_238bd6138c09514e3b80629e3b25b700]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_238bd6138c09514e3b80629e3b25b700]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_238bd6138c09514e3b80629e3b25b700]['nexusStates'] = $nexusStates;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("register", "0" ) . "
<script type='text/javascript'>
//<![CDATA[
...
<div id='register_form'>
	...
	<!--hook.if.skin_register.registerForm.registerHasErrors.pre.startif-->" . ((is_array( $general_errors ) && count( $general_errors )) ? ("
	<div class='message error'>
		{$this->lang->words['following_errors']}
		<ul>
			".$this->__f__3085c6ba6f74f80ad0ae47bf109130c3($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."		</ul>
	</div>
	<br />
	") : ("")) . "
			...
			<div class='resize_form'>
				...
				" . ((!empty( $nexusFields )) ? ("
					<script type='text/javascript'>
						...
						".$this->__f__d6bdbefe3d33a01ee6580f6168a36e08($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."					</script>
					<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
							".$this->__f__3b1ca23492d3b34f5b5f3089b9db43b1($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						</ul>
					</fieldset>
					<script type='text/javascript'>
						function states()
						{
				...
				") : ("")) . "				
				<!--hook.if.skin_register.registerForm.hasCfields.pre.startif-->" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__1bbc9d44f704238d6231069c80424bd6($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
			
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__a0c25cd010e5fcc5404ab41f0a8b8a28($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
					</fieldset>") : ("")) . "
				<hr />
				{$data['qandaHTML']}
				{$data['captchaHTML']}
...
<div class=\"g-recaptcha\" data-sitekey=\"6Lf4zgMTAAAAABL8KTkWplVV4iEjMPIZjN0NoAgW\"></div>
	</form>
	<script type='text/javascript'>
...
function __f__3085c6ba6f74f80ad0ae47bf109130c3($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d6bdbefe3d33a01ee6580f6168a36e08($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5156443c622a6437758f1dde75fb70bd($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode( "\n", $f['f_extra'] ) as $k => $v )
...
function __f__a863fb92f881ba1e9d906c267c49f095($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='',$country='',$_states='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__243b17940d0e5cf6b0d4db9b0f49804e($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $nexusStates as $country => $_states )
	{
		...
		$_ips___x_retval .= "
												<select name='_cm_state' id='{$country}-states' class='input_select' style='display:none'>
													".$this->__f__a863fb92f881ba1e9d906c267c49f095($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f,$country,$_states)."												</select>
...
function __f__3b1ca23492d3b34f5b5f3089b9db43b1($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
								...
								" . (($f['f_type'] == 'dropdown') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											<select name='{$f['f_column']}' id='{$f['f_column']}' tabindex='5' " . (($f['f_column'] == 'cm_country') ? ("onchange='states()'") : ("")) . ">
												".$this->__f__5156443c622a6437758f1dde75fb70bd($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."											</select>
										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
								...
								" . (($f['f_type'] == 'special') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											...
											".$this->__f__243b17940d0e5cf6b0d4db9b0f49804e($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
									</li>") : ("")) . "
...
function __f__1bbc9d44f704238d6231069c80424bd6($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__a0c25cd010e5fcc5404ab41f0a8b8a28($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
{
$count_9cf90f338ea9b62c5211959fda4fdd4d = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_9cf90f338ea9b62c5211959fda4fdd4d]['error'] = $error;
}
...
{
$count_21b0df9cfb57fc3e1ffb2b7372c42e1e = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_21b0df9cfb57fc3e1ffb2b7372c42e1e]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_21b0df9cfb57fc3e1ffb2b7372c42e1e]['error'] = $error;
}
$IPBHTML .= "<h1 class='ipsType_pagetitle'>{$this->lang->words['rv_title']}</h1>
<br />
" . (($error) ? ("
