...
{
$count_cdad2c84490ed4c05210f3da036d2eea = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_cdad2c84490ed4c05210f3da036d2eea]['r'] = $r;
$this->functionData['comment'][$count_cdad2c84490ed4c05210f3da036d2eea]['parent'] = $parent;
$this->functionData['comment'][$count_cdad2c84490ed4c05210f3da036d2eea]['settings'] = $settings;
}
...
{
$count_339f45256eb9bcf8f1bc62a4b162c4be = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_339f45256eb9bcf8f1bc62a4b162c4be]['r'] = $r;
$this->functionData['commentHidden'][$count_339f45256eb9bcf8f1bc62a4b162c4be]['parent'] = $parent;
$this->functionData['commentHidden'][$count_339f45256eb9bcf8f1bc62a4b162c4be]['settings'] = $settings;
}
...
{
$count_b69ecb81f1c74eadfa0986fe929312a8 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_b69ecb81f1c74eadfa0986fe929312a8]['comments'] = $comments;
$this->functionData['commentsList'][$count_b69ecb81f1c74eadfa0986fe929312a8]['settings'] = $settings;
$this->functionData['commentsList'][$count_b69ecb81f1c74eadfa0986fe929312a8]['pages'] = $pages;
$this->functionData['commentsList'][$count_b69ecb81f1c74eadfa0986fe929312a8]['parent'] = $parent;
$this->functionData['commentsList'][$count_b69ecb81f1c74eadfa0986fe929312a8]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__1d1b43bc1aec07e1d93acf5c31f76ce9($comments,$settings,$pages,$parent,$preReply)."</div>
...
function __f__1d1b43bc1aec07e1d93acf5c31f76ce9($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e439b8b0d0a0cf9e789533f68dfc97ab = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_e439b8b0d0a0cf9e789533f68dfc97ab]['comment'] = $comment;
$this->functionData['form'][$count_e439b8b0d0a0cf9e789533f68dfc97ab]['parent'] = $parent;
$this->functionData['form'][$count_e439b8b0d0a0cf9e789533f68dfc97ab]['editor'] = $editor;
$this->functionData['form'][$count_e439b8b0d0a0cf9e789533f68dfc97ab]['settings'] = $settings;
$this->functionData['form'][$count_e439b8b0d0a0cf9e789533f68dfc97ab]['errors'] = $errors;
$this->functionData['form'][$count_e439b8b0d0a0cf9e789533f68dfc97ab]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
