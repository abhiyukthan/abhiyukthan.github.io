...
$this->_funcHooks['tbHiddenContent'] = array('isPrintPage');
$this->_funcHooks['tbUnhiddenContent'] = array('isPrintPage');
...
{
$count_d5e8b4e452f45c3fd0031b726b31232b = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_d5e8b4e452f45c3fd0031b726b31232b]['data'] = $data;
}
...
{
$count_cde79a4af8e5f3458b8f1596fdfe8fad = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_cde79a4af8e5f3458b8f1596fdfe8fad]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_cde79a4af8e5f3458b8f1596fdfe8fad]['form'] = $form;
}
		...
		<div class='ipsBox_container ipsLayout_content'>
			<ul class='ipsForm ipsForm_vertical ipsPad'>
				...
				" . (($formData['formType'] == 'new' OR ( $formData['formType'] == 'edit')) ? ("" . (($formData['tagBox']) ? ("
					...
					") : ("")) . "") : ("")) . "<!--hook.if.skin_post.postFormTemplate.edit_tags_check.post.endif-->
...
{
$count_e458ff7e566b15157d2ac605f1e3e883 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_e458ff7e566b15157d2ac605f1e3e883]['data'] = $data;
}
...
<div class='post_block no_sidebar'>
	<div class='post_wrap ipsBox' id='post_preview'>
		<div class='ipsBox_container ipsPad'><div class='post_body'>
...
/* -- tbHiddenContent --*/
function tbHiddenContent() {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_post', $this->_funcHooks['tbHiddenContent'] ) )
{
$count_b99b92e76afe556c868128d84ca82e65 = is_array($this->functionData['tbHiddenContent']) ? count($this->functionData['tbHiddenContent']) : 0;
}
$IPBHTML .= "<div class='message error'" . ((!empty($this->request['forcePrint'])) ? (" style='display:block;'") : ("")) . ">
	<strong>{$this->lang->words['tb_hc_bbcode_title']}</strong>
	<br />{$this->lang->words['tb_hc_bbcode_content']}
</div>";
return $IPBHTML;
}

/* -- tbUnhiddenContent --*/
function tbUnhiddenContent($content="") {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_post', $this->_funcHooks['tbUnhiddenContent'] ) )
{
$count_618397b4d5ff17e9a801f417b435b3d1 = is_array($this->functionData['tbUnhiddenContent']) ? count($this->functionData['tbUnhiddenContent']) : 0;
$this->functionData['tbUnhiddenContent'][$count_618397b4d5ff17e9a801f417b435b3d1]['content'] = $content;
}
$IPBHTML .= "<div class='message'" . ((!empty($this->request['forcePrint'])) ? (" style='display:block;'") : ("")) . ">
	<strong>{$this->lang->words['tb_hc_bbcode_title']}</strong>
	<br /><br />{$content}
</div>";
return $IPBHTML;
...
{
$count_9d92178727fd60b730c99e19ba921881 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_9d92178727fd60b730c99e19ba921881]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__bdb1b9bb171ce1ba47c4461e579bedb0($posts)."") : ("")) . "
<p class='submit'>
...
function __f__bdb1b9bb171ce1ba47c4461e579bedb0($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2817c683b978337074cef010a3d61479 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_2817c683b978337074cef010a3d61479]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_2817c683b978337074cef010a3d61479]['type'] = $type;
$this->functionData['uploadForm'][$count_2817c683b978337074cef010a3d61479]['stats'] = $stats;
$this->functionData['uploadForm'][$count_2817c683b978337074cef010a3d61479]['id'] = $id;
$this->functionData['uploadForm'][$count_2817c683b978337074cef010a3d61479]['forum_id'] = $forum_id;
}
