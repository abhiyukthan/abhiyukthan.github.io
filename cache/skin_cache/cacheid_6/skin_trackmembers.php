...
class skin_trackmembers_6 extends skinMaster{
...
{
$count_d9d10219f308447529801f28a2c71b6f = is_array($this->functionData['showSetupPopup']) ? count($this->functionData['showSetupPopup']) : 0;
$this->functionData['showSetupPopup'][$count_d9d10219f308447529801f28a2c71b6f]['memberData'] = $memberData;
$this->functionData['showSetupPopup'][$count_d9d10219f308447529801f28a2c71b6f]['formElements'] = $formElements;
$this->functionData['showSetupPopup'][$count_d9d10219f308447529801f28a2c71b6f]['formData'] = $formData;
}
...
<div class='fixed_inner ipsBox'>
	...
	") : ("")) . "
		...
		<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=trackmembers&module=ajax&section=setup&mid={$memberData['member_id']}&do=save", "public",'' ), "", "" ) . "\" method='post' id='trackMembersSetupForm'>
			".$this->__f__abb2d0c1451921bbc4ee0ab89c3f0c04($memberData,$formElements,$formData)."			<fieldset class='submit clear'>
...
function __f__1f922890ca55f25248be669c3d8fca27($memberData, $formElements, $formData,$title='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__abb2d0c1451921bbc4ee0ab89c3f0c04($memberData, $formElements, $formData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $formElements as $title => $data )
	{
		...
		$_ips___x_retval .= "
				<fieldset class=\"row1\">
					...
					<ul class='ipsPad'>
						".$this->__f__1f922890ca55f25248be669c3d8fca27($memberData,$formElements,$formData,$title,$data)."					</ul>
				</fieldset>
...
{
$count_a32eb2a2c9062cc5c85a931cca65d642 = is_array($this->functionData['trackMemberLogs']) ? count($this->functionData['trackMemberLogs']) : 0;
$this->functionData['trackMemberLogs'][$count_a32eb2a2c9062cc5c85a931cca65d642]['logs'] = $logs;
$this->functionData['trackMemberLogs'][$count_a32eb2a2c9062cc5c85a931cca65d642]['member'] = $member;
$this->functionData['trackMemberLogs'][$count_a32eb2a2c9062cc5c85a931cca65d642]['status'] = $status;
$this->functionData['trackMemberLogs'][$count_a32eb2a2c9062cc5c85a931cca65d642]['pages'] = $pages;
$this->functionData['trackMemberLogs'][$count_a32eb2a2c9062cc5c85a931cca65d642]['footer_filter'] = $footer_filter;
}
			...
			<div class='ipsPad'>
				<div id='profile_content_main'>
					...
					<div id='user_info_cell' style='padding-left: 10px;'>
						...
						" . ((!empty( $warns )) ? ("
							".$this->__f__dcc353d0f4254bdbf4af61ce9d57f79e($logs,$member,$status,$pages,$footer_filter)."						") : ("")) . "
						" . (($member['_online']) ? ("
			...
			<div class='ipsPad'>
				...
				<table class='ipb_table'>
					...
					" . ((is_array( $logs ) AND count( $logs )) ? ("
												".$this->__f__5807bcdb39e77f463264a2e543d780e7($logs,$member,$status,$pages,$footer_filter)."					") : ("
						<tr>
...
function __f__dcc353d0f4254bdbf4af61ce9d57f79e($logs, $member, $status, $pages, $footer_filter)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5807bcdb39e77f463264a2e543d780e7($logs, $member, $status, $pages, $footer_filter)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
