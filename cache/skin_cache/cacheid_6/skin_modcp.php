...
{
$count_c88fecea43a632df9665f7423d9640e4 = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_c88fecea43a632df9665f7423d9640e4]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_c88fecea43a632df9665f7423d9640e4]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_c88fecea43a632df9665f7423d9640e4]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__db9b1d14c799ff77a9933b421d3faf4f($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__db9b1d14c799ff77a9933b421d3faf4f($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5c26e3b8f5e51136758623df20490102 = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_5c26e3b8f5e51136758623df20490102]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_5c26e3b8f5e51136758623df20490102]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_5c26e3b8f5e51136758623df20490102]['pagelinks'] = $pagelinks;
}
...
{
$count_e8167f579e2c121645e169c9d5010a4d = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_e8167f579e2c121645e169c9d5010a4d]['profile'] = $profile;
$this->functionData['editUserForm'][$count_e8167f579e2c121645e169c9d5010a4d]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__cd41c77fecc3670bf7c91ee3f8749f89($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__cd41c77fecc3670bf7c91ee3f8749f89($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_285bdba83b0d02ec8f1adc207023bb6c = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_285bdba83b0d02ec8f1adc207023bb6c]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_285bdba83b0d02ec8f1adc207023bb6c]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__08b264104fe10a565b6e53fc439b3014($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__08b264104fe10a565b6e53fc439b3014($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_58db8b5b363b58db87a9b60754a20e06 = is_array($this->functionData['memberLookup']) ? count($this->functionData['memberLookup']) : 0;
}
...
{
$count_85f61753b1951722e4e3346cc159caa0 = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_85f61753b1951722e4e3346cc159caa0]['type'] = $type;
$this->functionData['membersList'][$count_85f61753b1951722e4e3346cc159caa0]['members'] = $members;
$this->functionData['membersList'][$count_85f61753b1951722e4e3346cc159caa0]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__8f5b79ff9a539c9dc90732da850350bf($type,$members,$pagelinks)."				") : ("
...
function __f__8f5b79ff9a539c9dc90732da850350bf($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_dd4d4b2c9dbb8eb3215c38d8b5b6d138 = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_dd4d4b2c9dbb8eb3215c38d8b5b6d138]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_dd4d4b2c9dbb8eb3215c38d8b5b6d138]['inlineMsg'] = $inlineMsg;
}
...
{
$count_fa954615ac0ba79994555822b566d4b3 = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_fa954615ac0ba79994555822b566d4b3]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_fa954615ac0ba79994555822b566d4b3]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__88a75270ee3f90ae93ed43f1b0503bfb($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__88a75270ee3f90ae93ed43f1b0503bfb($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_043902da975c492ee2524f9489de7aef = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_043902da975c492ee2524f9489de7aef]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_043902da975c492ee2524f9489de7aef]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_043902da975c492ee2524f9489de7aef]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__59f2ffa4d1a385940dbc47d9811e3d97($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__59f2ffa4d1a385940dbc47d9811e3d97($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_223f80a210ca7f62aa9766fd6c3c7914 = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_223f80a210ca7f62aa9766fd6c3c7914]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_223f80a210ca7f62aa9766fd6c3c7914]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_223f80a210ca7f62aa9766fd6c3c7914]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_223f80a210ca7f62aa9766fd6c3c7914]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_223f80a210ca7f62aa9766fd6c3c7914]['msg'] = $msg;
}
...
{
$count_dac7347c607131b1c76f317508b91827 = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_dac7347c607131b1c76f317508b91827]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__bc75ece918a16d907556f28574781283($announcements)."		") : ("
			<tr>
...
function __f__ee30b4dc5f22759d599934f9a7c2aa96($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__bc75ece918a16d907556f28574781283($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__ee30b4dc5f22759d599934f9a7c2aa96($announcements,$announce)."									</ul>
								") : ("
...
{
$count_94c63b2528c234fac411a4b89b2c6c18 = is_array($this->functionData['modControls']) ? count($this->functionData['modControls']) : 0;
$this->functionData['modControls'][$count_94c63b2528c234fac411a4b89b2c6c18]['editmember'] = $editmember;
$this->functionData['modControls'][$count_94c63b2528c234fac411a4b89b2c6c18]['warnpanel'] = $warnpanel;
$this->functionData['modControls'][$count_94c63b2528c234fac411a4b89b2c6c18]['warnlogs'] = $warnlogs;
$this->functionData['modControls'][$count_94c63b2528c234fac411a4b89b2c6c18]['noteForm'] = $noteForm;
$this->functionData['modControls'][$count_94c63b2528c234fac411a4b89b2c6c18]['return'] = $return;
}
...
{
$count_60a36ba0f0b9d60e357ab0d2db13eeec = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_60a36ba0f0b9d60e357ab0d2db13eeec]['message'] = $message;
}
...
{
$count_e155b728a195d9c6da185242bce658f4 = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_e155b728a195d9c6da185242bce658f4]['post'] = $post;
$this->functionData['modCPpost'][$count_e155b728a195d9c6da185242bce658f4]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_e155b728a195d9c6da185242bce658f4]['topic'] = $topic;
$this->functionData['modCPpost'][$count_e155b728a195d9c6da185242bce658f4]['type'] = $type;
}
...
{
$count_37ac71ce271b1b774a1ac1d96741b1b8 = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_37ac71ce271b1b774a1ac1d96741b1b8]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_37ac71ce271b1b774a1ac1d96741b1b8]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_37ac71ce271b1b774a1ac1d96741b1b8]['type'] = $type;
$this->functionData['modCPtopic'][$count_37ac71ce271b1b774a1ac1d96741b1b8]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__30c59ef7c1ab57c353b9a4f215006052($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__01ef832cb0c5827a89a7ba9f556abc3e($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__30c59ef7c1ab57c353b9a4f215006052($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__01ef832cb0c5827a89a7ba9f556abc3e($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_a1a3cc365e8c5d4d13e3c7d523669a29 = is_array($this->functionData['overview']) ? count($this->functionData['overview']) : 0;
}
$IPBHTML .= "<div class='clearfix '>
	<div class='ipsBox_container ipsPad'>
		<p>{$this->lang->words['intro_blurb']}</p>
...
{
$count_a7d350e7d3c66292ffdb95b0e70b559d = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_a7d350e7d3c66292ffdb95b0e70b559d]['output'] = $output;
$this->functionData['portalPage'][$count_a7d350e7d3c66292ffdb95b0e70b559d]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_a7d350e7d3c66292ffdb95b0e70b559d]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__ab2396f739f4ca268ef260b5ecc60572($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__ab2396f739f4ca268ef260b5ecc60572($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ac26a99d0cfd2b846d833a35c4603cae = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__b948aa5f4f68711ad9e4c71daecf72ec()."";
return $IPBHTML;
}


function __f__74383ede718922540e8485faa4df6750($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b948aa5f4f68711ad9e4c71daecf72ec()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__74383ede718922540e8485faa4df6750($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_9cbe1988231d6fd0c87d68ad7b6a370a = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_9cbe1988231d6fd0c87d68ad7b6a370a]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_9cbe1988231d6fd0c87d68ad7b6a370a]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__eae63a6c1d79870d6c7ac6eb8419dd78($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__eae63a6c1d79870d6c7ac6eb8419dd78($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_f462ae6e98c82c2b24e79663f7546f81 = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_f462ae6e98c82c2b24e79663f7546f81]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_f462ae6e98c82c2b24e79663f7546f81]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
...
{
$count_370928bcaa66853f034190842fd0ee9a = is_array($this->functionData['warn_view_log']) ? count($this->functionData['warn_view_log']) : 0;
$this->functionData['warn_view_log'][$count_370928bcaa66853f034190842fd0ee9a]['member'] = $member;
$this->functionData['warn_view_log'][$count_370928bcaa66853f034190842fd0ee9a]['rows'] = $rows;
$this->functionData['warn_view_log'][$count_370928bcaa66853f034190842fd0ee9a]['links'] = $links;
}
...
$IPBHTML .= "" . (($this->request['module']=='ajax') ? ("
	...
	") : ("")) . "
		<table class='ipb_table'>
			...
			") : ("
								".$this->__f__9412d08542185dcc2bafdb105de50813($member,$rows,$links)."			")) . "
		</table>
...
function __f__9412d08542185dcc2bafdb105de50813($member, $rows, $links='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_f9bf1a58da2c3126538b277541b42155 = is_array($this->functionData['warnForm']) ? count($this->functionData['warnForm']) : 0;
$this->functionData['warnForm'][$count_f9bf1a58da2c3126538b277541b42155]['member'] = $member;
$this->functionData['warnForm'][$count_f9bf1a58da2c3126538b277541b42155]['errors'] = $errors;
$this->functionData['warnForm'][$count_f9bf1a58da2c3126538b277541b42155]['modque'] = $modque;
$this->functionData['warnForm'][$count_f9bf1a58da2c3126538b277541b42155]['postque'] = $postque;
$this->functionData['warnForm'][$count_f9bf1a58da2c3126538b277541b42155]['ban'] = $ban;
$this->functionData['warnForm'][$count_f9bf1a58da2c3126538b277541b42155]['editor_html'] = $editor_html;
}
