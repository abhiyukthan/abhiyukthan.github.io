...
class skin_shoutbox_hooks_6 extends skinMaster{
...
{
$count_c3fd56b3fd058dae11f0d540046f0e3d = is_array($this->functionData['hookActiveUsers']) ? count($this->functionData['hookActiveUsers']) : 0;
$this->functionData['hookActiveUsers'][$count_c3fd56b3fd058dae11f0d540046f0e3d]['stats'] = $stats;
}
...
{
$count_2b3e177c6ee9caf9d3bdb9873d4a614e = is_array($this->functionData['hookActiveUsersSidebar']) ? count($this->functionData['hookActiveUsersSidebar']) : 0;
$this->functionData['hookActiveUsersSidebar'][$count_2b3e177c6ee9caf9d3bdb9873d4a614e]['stats'] = $stats;
}
...
{
$count_b7c6effbb951b134b2308603a7886a03 = is_array($this->functionData['hookGlobalShoutbox']) ? count($this->functionData['hookGlobalShoutbox']) : 0;
$this->functionData['hookGlobalShoutbox'][$count_b7c6effbb951b134b2308603a7886a03]['d'] = $d;
}
...
{
$count_1e45873fd532b8e427b5ccc2e6f95bce = is_array($this->functionData['hookGlobalShoutboxEmoticons']) ? count($this->functionData['hookGlobalShoutboxEmoticons']) : 0;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_1e45873fd532b8e427b5ccc2e6f95bce]['emoticons'] = $emoticons;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_1e45873fd532b8e427b5ccc2e6f95bce]['total'] = $total;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_1e45873fd532b8e427b5ccc2e6f95bce]['prev'] = $prev;
$this->functionData['hookGlobalShoutboxEmoticons'][$count_1e45873fd532b8e427b5ccc2e6f95bce]['next'] = $next;
}
...
<table class=\"ipb_table\">
			".$this->__f__d9c5b59e45640ff6d24174124fdd01dd($emoticons,$total,$prev,$next)."	" . ((count($emoticons)%$this->settings['shoutbox_emos_perrow']>0) ? ("
				{$extra}
		</tr>
	") : ("")) . "
</table>";
...
function __f__d9c5b59e45640ff6d24174124fdd01dd($emoticons=array(), $total=0, $prev=0, $next=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b46c4c6f24a1ba440a73f5b78948e07c = is_array($this->functionData['hookGlobalShoutboxSidebar']) ? count($this->functionData['hookGlobalShoutboxSidebar']) : 0;
$this->functionData['hookGlobalShoutboxSidebar'][$count_b46c4c6f24a1ba440a73f5b78948e07c]['d'] = $d;
}
$IPBHTML .= "<!--- ShoutBoxJsLoader --->
<script type='text/javascript'>
/* Setup some value */
...
{
$count_61cf10202a5cce0c1e12b5753ed18120 = is_array($this->functionData['hookOnlineTab']) ? count($this->functionData['hookOnlineTab']) : 0;
$this->functionData['hookOnlineTab'][$count_61cf10202a5cce0c1e12b5753ed18120]['count'] = $count;
}
$IPBHTML .= "" . (($count > 0) ? ("
...
{
$count_79fe68b22273c05c6434fc52a3921c68 = is_array($this->functionData['hookVCard']) ? count($this->functionData['hookVCard']) : 0;
$this->functionData['hookVCard'][$count_79fe68b22273c05c6434fc52a3921c68]['member'] = $member;
}
...
{
$count_75639419c868ce55f5ac54a48f012a5c = is_array($this->functionData['shoutboxJavascript']) ? count($this->functionData['shoutboxJavascript']) : 0;
}
