...
class skin_shoutbox_6 extends skinMaster{
...
{
$count_877d2ee2bb0df3bdd64354dec2b3d1a0 = is_array($this->functionData['archive']) ? count($this->functionData['archive']) : 0;
$this->functionData['archive'][$count_877d2ee2bb0df3bdd64354dec2b3d1a0]['d'] = $d;
}
...
$IPBHTML .= "" . ((substr( $action, 0, 4 ) != 'edit') ? ("" . (($action == 'delete') ? ("
	...
	<div class=\"short\">
		...
		<table class=\"ipb_table\">
			...
			".$this->__f__efc8aa79a0bc76d5b623507e29c17fb0($action,$data)."		</table>
		<br />
...
function __f__efc8aa79a0bc76d5b623507e29c17fb0($action='',$data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6b1b4f60a8ff3a52cd67ff2524072d91 = is_array($this->functionData['popupWrapper']) ? count($this->functionData['popupWrapper']) : 0;
$this->functionData['popupWrapper'][$count_6b1b4f60a8ff3a52cd67ff2524072d91]['output'] = $output;
}
...
{
$count_4f5a29a52a08b62a71c4b00cfcbe6731 = is_array($this->functionData['shout_row']) ? count($this->functionData['shout_row']) : 0;
$this->functionData['shout_row'][$count_4f5a29a52a08b62a71c4b00cfcbe6731]['d'] = $d;
$this->functionData['shout_row'][$count_4f5a29a52a08b62a71c4b00cfcbe6731]['can_edit'] = $can_edit;
$this->functionData['shout_row'][$count_4f5a29a52a08b62a71c4b00cfcbe6731]['ajax'] = $ajax;
}
...
{
$count_4fa327a30f6d7d55d5ddf5b99079f436 = is_array($this->functionData['shout_row_sidebar']) ? count($this->functionData['shout_row_sidebar']) : 0;
$this->functionData['shout_row_sidebar'][$count_4fa327a30f6d7d55d5ddf5b99079f436]['d'] = $d;
$this->functionData['shout_row_sidebar'][$count_4fa327a30f6d7d55d5ddf5b99079f436]['can_edit'] = $can_edit;
$this->functionData['shout_row_sidebar'][$count_4fa327a30f6d7d55d5ddf5b99079f436]['ajax'] = $ajax;
}
...
{
$count_b42ca4521faeb141de7b59c74d1ab861 = is_array($this->functionData['shoutbox']) ? count($this->functionData['shoutbox']) : 0;
$this->functionData['shoutbox'][$count_b42ca4521faeb141de7b59c74d1ab861]['data'] = $data;
$this->functionData['shoutbox'][$count_b42ca4521faeb141de7b59c74d1ab861]['stats'] = $stats;
}
