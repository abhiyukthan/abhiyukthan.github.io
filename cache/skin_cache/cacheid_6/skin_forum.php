...
{
$count_7d06645ad867aaca098767faed55f7c5 = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_7d06645ad867aaca098767faed55f7c5]['title'] = $title;
$this->functionData['forumAttachments'][$count_7d06645ad867aaca098767faed55f7c5]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_7d06645ad867aaca098767faed55f7c5]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__5d24955b72a52e2f5a4081c8b24d3a39($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__5d24955b72a52e2f5a4081c8b24d3a39($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6317f82adbd73a983523607dcea574fe = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_6317f82adbd73a983523607dcea574fe]['inforum'] = $inforum;
}
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<div class='content_border'><table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__ae3e1b0eecd2ef4f995e75422b0a8ed4($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table></div>
	<br />	
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
		...
		<div class='ipsBox table_wrap removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__ba874e03c3cd56f8370858e165d7bc0a($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
...
" . (($forum_data['sub_can_post']) ? ("<div class='topic_controls clearfix'>
		...
		<ul class='topic_buttons'>
			...
			") : ("")) . "
			" . (($this->memberData['member_id'] || $this->settings['topic_marking_guests']) ? ("<li class='non_button'>
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__42f77607fce9f9373293dbe03d3646f5($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr> 
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__abfac84ff5aa1ae6d536874da1588e10($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
    ".$this->__f__c3d96197ae3b687b7f85fad2c9de039a($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>";
return $IPBHTML;
}


function __f__ae3e1b0eecd2ef4f995e75422b0a8ed4($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c6e7e1a291aca015a9703c4c50f6773a($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__be1f1cbb8fed87d91aa0ea7d76983321($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
										...
										<td class='desc'>
											<ul class='last_post ipsType_small'>
                                                <li class='desc lighter'><em>" . $this->registry->getClass('class_localization')->formatNumber( $forum_data['redirect_hits'] ) . " {$this->lang->words['rd_hits']}</em></li></ul>
																				...
																				<td class='col_c_icon'>
											" . (($forum_data['_has_unread']) ? ("<a id='forum_img_{$forum_data['id']}' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&module=forums&section=markasread&marktype=forum&forumid={$forum_data['id']}&returntoforumid={$this->request['f']}&i=1", "public",'' ), "", "" ) . "\" data-tooltip=\"{$this->lang->words['bi_markread']}\" class='forum_marker'>" . (($forum_data['icon'] != '' AND $forum_data['icon'] !='0') ? ("{$forum_data['icon']}") : ("<img src='{$this->settings['img_url']}/f_icon.png' />")) . "</a>
												<script type='text/javascript'>
													" . (($this->settings['dp3_fi_mode'] == 'replace') ? ("var unreadIcon = \"{$forum_data['icon_read']}\";") : ("")) . "
													ipb.global.registerMarker( \"forum_img_{$forum_data['id']}\", \"{$forum_data['img_new_post']}\", markerURL + \"&forumid={$forum_data['id']}\" );
												</script>") : ("" . (($forum_data['icon'] != '' AND $forum_data['icon'] !='0') ? ("{$forum_data['icon']}") : ("<img src='{$this->settings['img_url']}/f_icon_read.png' />")) . "")) . "
										</td>
										<td class='col_c_forum'>									
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
													".$this->__f__c6e7e1a291aca015a9703c4c50f6773a($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
...
function __f__ba874e03c3cd56f8370858e165d7bc0a($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__be1f1cbb8fed87d91aa0ea7d76983321($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__42f77607fce9f9373293dbe03d3646f5($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__abfac84ff5aa1ae6d536874da1588e10($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c3d96197ae3b687b7f85fad2c9de039a($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_39c78e3d71fc4dc8891208367bb9f311 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_39c78e3d71fc4dc8891208367bb9f311]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_39c78e3d71fc4dc8891208367bb9f311]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_39c78e3d71fc4dc8891208367bb9f311]['opts'] = $opts;
}
...
{
$count_29a59328f8d1d6f67ba14e6294431460 = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_29a59328f8d1d6f67ba14e6294431460]['data'] = $data;
$this->functionData['topic'][$count_29a59328f8d1d6f67ba14e6294431460]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_29a59328f8d1d6f67ba14e6294431460]['other_data'] = $other_data;
$this->functionData['topic'][$count_29a59328f8d1d6f67ba14e6294431460]['inforum'] = $inforum;
}
...
" . (($data['_answeredPid'] !== false) ? ("
		...
		") : ("" . ((($this->memberData['is_mod'] AND $data['_hasqueued'])) ? ("
			...
			") : ("")) . "")) . "
		<!--hook.if.skin_forum.topic.hasPrefix.pre.startif-->" . ((!empty($data['tags']['formatted']['prefix'])) ? ("
			{$data['tags']['formatted']['prefix']}
		") : ("")) . "
		" . ((! $inforum && $data['nav']) ? ("
            ".$this->__f__3d2afa4f4cd6caf4bc1e877448464b1c($data,$forum_data,$other_data,$inforum)."        ") : ("")) . "
        <h4>
            {$data['prefix']}
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__bbdb2852743c7eaa2174fbf6a933bef6($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "<!--hook.if.skin_forum.topic.multipages.post.endif-->
	</td>
...
function __f__3d2afa4f4cd6caf4bc1e877448464b1c($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__bbdb2852743c7eaa2174fbf6a933bef6($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_75b5b61e8df626426e695320d5bd69e5 = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_75b5b61e8df626426e695320d5bd69e5]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__72264b6627020450c804787a407a29db($rating_id)."</span>";
return $IPBHTML;
}


function __f__72264b6627020450c804787a407a29db($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_98be04e529a0ba71db749e93e8f36d2a = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_98be04e529a0ba71db749e93e8f36d2a]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
