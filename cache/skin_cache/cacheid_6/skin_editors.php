...
{
$count_380bda1ca19899439310d9c21bd7c799 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_380bda1ca19899439310d9c21bd7c799]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_380bda1ca19899439310d9c21bd7c799]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_380bda1ca19899439310d9c21bd7c799]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_380bda1ca19899439310d9c21bd7c799]['extraData'] = $extraData;
}
...
{
$count_431b04132d54557e24bec89704afe4b0 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['formField'] = $formField;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['content'] = $content;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['options'] = $options;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_431b04132d54557e24bec89704afe4b0]['showEditor'] = $showEditor;
}
...
{
$count_c70f4e1d034d87e753b055e7db933ded = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_c70f4e1d034d87e753b055e7db933ded]['options'] = $options;
$this->functionData['editorLoadJs'][$count_c70f4e1d034d87e753b055e7db933ded]['inlineLoad'] = $inlineLoad;
}
...
{
$count_65edfbb2ea3b12d578b7b6e6ecb2a7f4 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_65edfbb2ea3b12d578b7b6e6ecb2a7f4]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_65edfbb2ea3b12d578b7b6e6ecb2a7f4]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_65edfbb2ea3b12d578b7b6e6ecb2a7f4]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_65edfbb2ea3b12d578b7b6e6ecb2a7f4]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__2ee9e5f7cbc7437e5fced40f1d77aedb($rows,$pages,$app,$plugin)."		") : ("
...
function __f__2ee9e5f7cbc7437e5fced40f1d77aedb($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_ca6c8ad8a94de930673a89949190ffcc = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_ca6c8ad8a94de930673a89949190ffcc]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__998e87c0cb2eb35d3a081471710b67c6($tabs)."			</ul>
		</div>
...
function __f__998e87c0cb2eb35d3a081471710b67c6($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
