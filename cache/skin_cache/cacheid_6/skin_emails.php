...
{
$count_674d7113134435ea8be19c050fa8822e = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_674d7113134435ea8be19c050fa8822e]['title'] = $title;
$this->functionData['forward_form'][$count_674d7113134435ea8be19c050fa8822e]['text'] = $text;
$this->functionData['forward_form'][$count_674d7113134435ea8be19c050fa8822e]['lang'] = $lang;
$this->functionData['forward_form'][$count_674d7113134435ea8be19c050fa8822e]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_674d7113134435ea8be19c050fa8822e]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__cd6911938ef499fdb7b35b8ce245b264($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__cd6911938ef499fdb7b35b8ce245b264($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
