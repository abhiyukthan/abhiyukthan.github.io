----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 LEFT JOIN core_tags_cache xxx ON ( xxx.tag_cache_key=MD5(CONCAT('forums',';','topics',';',t.tid)) )   WHERE t.tid IN( 122168,122524,78180,122631,121200,78556)
 .--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
