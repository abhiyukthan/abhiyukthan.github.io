----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 Date: Thu, 24 Nov 2016 00:18:43 +0000
 Error: 144 - Table './crackingportal/content_cache_posts' is marked as crashed and last (automatic?) repair failed
 IP Address: 217.73.208.154 - /index.php?andor_type=&app=core&do=search&module=search&search_app=forums&search_app_filters%5Bforums%5D%5BsearchInKey%5D=&search_app_filters%5Bforums%5D%5BsortDir%5D=0&search_app_filters%5Bforums%5D%5BsortKey%5D=date&search_app_filters%5Bforums%5D%5BsortKey%5D=date&search_tags=EA&search_term=
 ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 LEFT JOIN core_tags_cache xxx ON ( xxx.tag_cache_key=MD5(CONCAT('forums',';','topics',';',t.tid)) )   WHERE t.tid IN( 80282,80467,6880)
 .--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
