...
'notify__reputation_negative' => "Notify me when someone rated negatively my posts",
'notify__reputation_positive' => "Notify me when someone rated positively my posts",
...
'recenttopics_saved' => "As configurações para os Tópicos Recentes foram salvas!",
...
'topicosrecentes_on' => "Deseja visualizar a relação de tópicos na index do fórum?",
'topicosrecentes_ondesc' => "Se habilitado, será mostrado na index do fórum o bloco com os tópicos/postagens recentes",
'topicosrecentes_qtd' => "Número de tópicos que será mostrado na index",
'topicosrecentes_qtdstd' => "Usar o padrão",
'topicosrecentes_qtdstd_desc' => "Se você quiser listar um número específico de tópicos, <strong>desmarque a configuração anterior e escolha o número de tópicos na listagem abaixo</strong>",
'topicosrecentes_showdqtd' => "Mostrar o número padrão de tópicos escolhido pelo Administrador",
'topicosrecentes_showdqtddesc' => "Se você selecionar esta opção, <strong>a próxima configuração não terá qualquer efeito</strong>",
'topicosrecentes_title' => "Configurações do usuário para os Tópicos Recentes",
'topicosrecentes_usercpexcludeforums' => "Excluir Fóruns",
'topicosrecentes_usercpforums' => "Os fóruns que você escolher aqui <strong>NÃO APARECERÃO</strong> na listegem dos tópicos.<br />Você pode selecionar mais de um.",
